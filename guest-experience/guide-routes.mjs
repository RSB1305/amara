...
const TOPIC_SEGMENTS = Object.freeze({
  ...
  'ceramic-panels': { es: 'azulejos', en: 'ceramic-panels', de: 'keramiktafeln', nl: 'keramiekpanelen', sv: 'keramikpaneler' },
...
export const GUEST_GUIDE_PAGES = Object.freeze({
  ...
  'frigiliana-guest-ceramic-panels': { kind: 'topic', destination: 'frigiliana', topic: 'ceramic-panels' },
  ...
  'nerja-guest-recommendations': { kind: 'topic', destination: 'nerja', topic: 'experience' },
