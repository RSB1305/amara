...
export const frigilianaRestaurantRecommendations = defineKnowledgeRecommendations([
  {
    ...
    topic: 'restaurants',
    place: { name: 'El Jardín', kind: 'restaurant', address: 'Calle del Santo Cristo, Barribarto', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Restaurante+El+Jardin+Frigiliana', website: 'https://thegardenfrigiliana.com/inicio/' },
  ...
  },
  {
    ...
    destination: 'frigiliana',
    topic: 'restaurants',
    place: { name: 'Gloria Bendita', kind: 'restaurant', address: 'Plaza de las Tres Culturas 14', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Gloria+Bendita+Frigiliana', website: 'https://frigiliana.es/places/gloria-bendita/' },
  ...
  },
  {
    ...
    destination: 'frigiliana',
    topic: 'restaurants',
    place: { name: 'La Tapería', kind: 'restaurant', address: 'Avenida Carlos Cano 4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=La+Taperia+Frigiliana', whatsapp: '+34711027581', website: 'https://www.lataperiafrigiliana.com/indexesp.html' },
  ...
  },
  {
    ...
    destination: 'frigiliana',
    topic: 'restaurants',
    place: { name: 'El Acebuchal', kind: 'restaurant', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Bar+El+Acebuchal', website: 'https://www.elacebuchal.com/' },
