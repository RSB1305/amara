...
export const nerjaSupermarketsKnowledge = defineKnowledgePageManifest({
  ...
  driveFolder: { id: '1cI9UbuNAjm-HaxEDhr1euBmLUF3LVc8X', url: 'https://drive.google.com/drive/folders/1cI9UbuNAjm-HaxEDhr1euBmLUF3LVc8X', path: 'AMARA – Research Vault/10_LOCATIONS/nerja/nerja-supermarkets-everyday-shopping' },
  publicContentPath: 'src/content/nerjaSupermarketsContent.ts',
