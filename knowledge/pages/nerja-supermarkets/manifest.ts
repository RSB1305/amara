...
export const nerjaSupermarketsKnowledge = defineKnowledgePageManifest({
  ...
  coverage: [
    { authoringArea: 'shopping-reality', purpose: 'Explain Nerja shopping areas without an uncurated store directory.', factIds: ['nerja.supermarkets.structure', 'nerja.supermarkets.chains-volatile'], status: 'partial', notes: 'Reconciled from the Aug+Sep 2026 runs: structure is solid; specific chains are volatile/disputed and kept as live-check, not a frozen list.' },
    { authoringArea: 'car-and-car-free', purpose: 'Separate centre, Torrecilla and other practical shopping contexts.', factIds: ['nerja.supermarkets.structure'], status: 'partial' },
    { authoringArea: 'arrival-and-opening-logic', purpose: 'Support first-supply and Sunday or holiday planning without freezing hours.', factIds: ['nerja.supermarkets.lidl-anchor', 'nerja.supermarkets.tourist-zone-opening'], status: 'partial', notes: 'Lidl anchor + ZGAT Sunday-opening freedom (season); actual per-store opening remains a live check.' },
