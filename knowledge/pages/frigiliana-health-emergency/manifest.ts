...
export const frigilianaHealthEmergencyKnowledge = defineKnowledgePageManifest({
  ...
  coverage: [
    { authoringArea: 'care-system', purpose: 'Explain stable care levels and official pathways without medical advice.', factIds: ['nerja.health.centro-address-and-contact', 'nerja.health.salud-responde'], status: 'partial', notes: 'Centro de Salud Nerja is covered for AMARA guests; the Frigiliana consultorio pathway remains to be normalized.' },
