...
export const tarifaPracticalLocalRulesKnowledge = defineKnowledgePageManifest({
  ...
  driveFolder: { id: '1ttS4fTPKTlTgeQha5b2eEYWWKhe9WF0T', url: 'https://drive.google.com/drive/folders/1ttS4fTPKTlTgeQha5b2eEYWWKhe9WF0T', path: 'AMARA – Research Vault/40_SHARED/tarifa-practical-local-rules' },
