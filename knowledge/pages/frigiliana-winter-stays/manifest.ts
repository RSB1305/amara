...
export const frigilianaWinterStaysKnowledge = defineKnowledgePageManifest({
  ...
  coverage: [
    ...
    { authoringArea: 'weather-boundary', purpose: 'Keep climate detail with Climate & Seasons.', factIds: [], status: 'gap', notes: 'Await the normalized climate run; do not reuse Gemini temperature claims.' },
