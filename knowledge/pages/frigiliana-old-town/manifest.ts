...
export const frigilianaOldTownKnowledge = defineKnowledgePageManifest({
  ...
  updatedAt: '2026-09-12T10:30:00+02:00',
  status: 'needs-review',
  driveFolder: {
  ...
  researchRunIds: [
    ...
    '2026-09-12__103000__frigiliana-old-town-monuments-provenance__research-001',
  ],
  coverage: [
    {
