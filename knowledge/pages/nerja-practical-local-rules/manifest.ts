...
export const nerjaPracticalLocalRulesKnowledge = defineKnowledgePageManifest({
  ...
  driveFolder: { id: '1U22asuz_LRoYesQBTNLRtB8EJNu4H9_p', url: 'https://drive.google.com/drive/folders/1U22asuz_LRoYesQBTNLRtB8EJNu4H9_p', path: 'AMARA – Research Vault/40_SHARED/nerja-practical-local-rules' },
