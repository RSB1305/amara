---
subject: frigiliana
topic: supermarkets-local-food-cooking
research_run_id: 2026-08-28__092359__frigiliana-shopping-local-food-cooking__research-001
record_type: normalized-research-dossier
status: needs-review
created: 2026-08-28T14:30:00+02:00
public: false
---

# Frigiliana shopping, local food and cooking — normalized dossier
...
| Topic | Verified now | Boundary or missing evidence |
| --- | --- | --- |
| EROSKI/city | Retailer-confirmed identity and address | Hours, stock, holidays, parking, delivery and AMARA route are volatile |
...
| Candidate transition | Factual premise now available | Required target content before a public connection | State |
| --- | --- | --- | --- |
| Supermarket → private cooking | A bounded local shop network exists | Property-by-property equipment and a preparation that was actually tested | Human input required |
| Shop → regional ingredient | El Lagar lists examples; agriculture records establish broader crop context | Product-specific provenance and current stock | Gap |
| Ingredient → recipe | Traditional dish associations exist | Competent recipe source, realistic shopping list and kitchen suitability | Gap |
| Thursday market → food experience | Thursday is partially supported | Current location, schedule, vendor mix and Experience owner | Gap |
| Cooking → restaurant alternative | The choice architecture is valid | Restaurant evidence for the same need, time and area | Separate owner required |
| Private terrace evening → AMARA | Terrace amenities already have a property fact owner | Unit applicability, preparation evidence and honest host experience | Human input required |

The supermarket page may introduce why private cooking matters, but it must not become a recipe catalogue or apartment inventory. Recipes, if later justified as a spoke, remain outside primary navigation and need their own page job and evidence review.

## Existing owners reused

- Historic agriculture, avocado/olive statistics and operator landscape observation remain in `agriculture-food.ts`.
- El Ingenio access and production uncertainty remains in `frigiliana.food.question-ingenio-current-production-and-access`.
- Terrace, outdoor shower, hammock and lounger evidence remains property-owned; it must not be generalized to Farah.

## Publication boundaries

- Do not freeze opening hours or imply that a product will be in stock.
- Do not call the Thursday market a farmers’ market.
- Do not infer Frigiliana origin from a product being sold in Frigiliana.
- Do not turn an external recipe or reviewer experience into an AMARA first-hand claim.
- Do not claim identical kitchen capability across Farah, Lounis, Zaid and Maha.
...
| --- | ---: | --- |
| Source authority | 4 | The core uses retailer and municipal sources; several shop records still need direct confirmation. |
...
**Total: 34/40.** The shopping owner can begin coverage planning, but connected authoring should wait for the field and property inputs.

## Lessons for the next run

1. Collect direct operator records for every current business before asking for narrative synthesis.
2. Research provenance, seasonal availability and current stock as three distinct questions.
3. Supply the property capability matrix as a fixed input to any future recipe research.
