...
export const amaraPlayaPropertySources = defineKnowledgeSources([
  {
    ...
    language: 'de',
    scope: 'Direct operator statements about the Nerja apartment AMARA Playa: a private west-facing balcony with a side sea view and an awning, air conditioning, and the nearby Torrecilla beach (flat, southwest-facing, long winter sun).',
    limitations:
