...
export const amaraFamilySurfPropertySources = defineKnowledgeSources([
  {
    ...
    language: 'de',
    scope: 'Direct operator statements about the Tarifa apartment AMARA Family & Surf: a private west-facing balcony (not a terrace) with a fixed wooden canopy, air conditioning, and the temperature of the Atlantic off Tarifa.',
    limitations:
