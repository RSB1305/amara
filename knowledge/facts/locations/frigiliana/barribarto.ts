...
const facts = [
  ...
  },
  {
    ...
    notes: 'The wiktionary warns that the popular "dead-end lane" sense of adarve is a loose use; the decree’s definition is the one to quote.',
  },
  {
  ...
  },
  {
    ...
    subject: 'frigiliana',
    topic: 'barribarto',
    statement: 'A new panoramic mirador and pedestrian path were built "en la zona alta del Santo Cristo" with a 2021 grant from the Consejería de Turismo, as reported by the regional press in September 2022.',
    status: 'partially-verified',
    sourceIds: ['axarquiaplus-mirador-santo-cristo-2022'],
    checkedAt: '2026-09-13',
    reviewAfter: '2028-09-13',
    volatility: 'medium',
    claimBoundary: 'Press report read through a proxy; whether the mirador is on Calle Santo Cristo or above the Ermita is not stated. Open question.',
  },
  {
