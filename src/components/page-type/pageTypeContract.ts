...
export const AMARA_PAGE_FAMILY_PROFILES = {
  ...
  'experience-frigiliana-calle-real': { type: 'explore', tier: 'approved' },
  'experience-frigiliana-fuente-vieja': { type: 'explore', tier: 'approved' },
  'experience-frigiliana-castillo-lizar': { type: 'explore', tier: 'approved' },
