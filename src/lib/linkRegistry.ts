...
export const linkRegistry = {
  ...
  links: {
    ...
    frigiliana_stays: buildOwnedLinks('stays.frigiliana'),
    ...
    tarifa_kitesurf_rescue: buildOwnedLinks('tarifa.kitesurfing.rescue'),
    ...
    tarifa_whale_watching: buildOwnedLinks('tarifa.experience.whale-watching'),
    tarifa_family: buildOwnedLinks('tarifa.experience.family'),
