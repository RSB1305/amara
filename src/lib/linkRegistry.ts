...
export const linkRegistry = {
  ...
  links: {
    ...
    frigiliana_health_emergency: buildOwnedLinks('frigiliana-health-emergency'),
    ...
    nerja_health_emergency: buildOwnedLinks('nerja-health-emergency'),
    ...
    tarifa_health_emergency: buildOwnedLinks('tarifa-health-emergency'),
    ...
    tarifa_kitesurf_spots: buildOwnedLinks('tarifa-kitesurf-spots'),
    tarifa_kitesurf_forecast: buildOwnedLinks('tarifa-kitesurf-forecast'),
    ...
    amara_tarifa_surf_club: buildOwnedLinks('amara-tarifa-surf-club'),
    tarifa_bildungsurlaub: buildOwnedLinks('tarifa-bildungsurlaub'),
