...
const nerjaArrivalUi = {
  en: {
    ...
    heroText: 'From Málaga airport you reach Nerja by Alsa bus, usually via Málaga city centre; it ends at the bus station, from where you continue by taxi or on foot. Transfer and rental car bring you to Calle Castilla Pérez 60, around 200 metres from Torrecilla beach. You park a few streets away, and before the lift there are ten steps: five outside the house, five inside.',
    optionsEyebrow: 'From Málaga Airport', optionsTitle: 'The coach goes direct, the car goes further',
    carEyebrow: 'Transfer or rental car', carTitle: 'To the door — and then a parking space', carText: 'With luggage the transfer is most comfortable. A rental car is worth it for Maro, Frigiliana and the Axarquía; for one or two day trips a car hired for those days is enough. The A-7 coastal motorway from Málaga to Nerja is completely toll-free. Electric car: the map shows the nearest charging points.',
    busEyebrow: 'Alsa bus', busTitle: 'Via Málaga centre or direct', busText: 'The direct bus from Málaga airport to Nerja runs only a few times a day. You travel more flexibly by taking the C1 Cercanías train from the airport, reaching Málaga María Zambrano main station in about twelve minutes and changing there to the regular Alsa bus to Nerja. In Nerja it ends at the bus station; from there a quarter of an hour downhill on foot or five minutes by taxi.',
  ...
  de: {
    ...
    heroText: 'Vom Flughafen Málaga fahrt ihr mit dem Alsa-Bus nach Nerja, meist über Málaga-Zentrum; er endet am Busbahnhof, von dort geht es mit dem Taxi oder zu Fuß weiter. Transfer und Mietwagen bringen euch bis zur Calle Castilla Pérez 60, rund 200 Meter vom Strand Torrecilla. Geparkt wird ein paar Straßen weiter, und vor dem Aufzug liegen zehn Stufen: fünf vor dem Haus, fünf drinnen.',
    optionsEyebrow: 'Ab Flughafen Málaga', optionsTitle: 'Der Bus fährt direkt, das Auto fährt weiter',
    carEyebrow: 'Transfer oder Mietwagen', carTitle: 'Bis vor die Tür — und dann ein Stellplatz', carText: 'Mit Gepäck ist der Transfer am bequemsten. Ein Mietwagen lohnt sich für Maro, Frigiliana und die Axarquía; für ein oder zwei Ausflugstage reicht ein Mietwagen auf Zeit. Die Küstenautobahn A-7 von Málaga nach Nerja ist komplett mautfrei. Mit Elektroauto: Die Karte zeigt die nächsten Ladepunkte.',
    busEyebrow: 'Alsa-Bus', busTitle: 'Über Málaga-Zentrum oder direkt', busText: 'Der direkte Bus vom Flughafen Málaga nach Nerja fährt nur wenige Male am Tag. Flexibler reist ihr, wenn ihr am Flughafen in die S-Bahn (C1) steigt, in rund zwölf Minuten zum Hauptbahnhof Málaga (María Zambrano) fahrt und dort in den regulären Alsa-Bus nach Nerja umsteigt. In Nerja endet er am Busbahnhof; von dort eine Viertelstunde bergab zu Fuß oder fünf Minuten mit dem Taxi.',
  ...
  es: {
    ...
    heroText: 'Desde el aeropuerto de Málaga llegáis a Nerja en autobús de Alsa, normalmente vía el centro de Málaga; termina en la estación, desde donde se sigue en taxi o a pie. El traslado y el coche de alquiler os llevan hasta la calle Castilla Pérez 60, a unos 200 metros de la playa de Torrecilla. Se aparca unas calles más allá, y antes del ascensor hay diez escalones: cinco fuera de la casa, cinco dentro.',
    optionsEyebrow: 'Desde el aeropuerto de Málaga', optionsTitle: 'El autobús va directo; el coche llega más lejos',
    carEyebrow: 'Traslado o coche de alquiler', carTitle: 'Hasta la puerta y luego una plaza', carText: 'Con equipaje el traslado es lo más cómodo. El coche de alquiler merece la pena para Maro, Frigiliana y la Axarquía; para una o dos excursiones basta con alquilarlo esos días. La autovía del litoral A-7 de Málaga a Nerja es totalmente gratuita. Con coche eléctrico: el mapa muestra los puntos de recarga más cercanos.',
    busEyebrow: 'Autobús de Alsa', busTitle: 'Vía el centro de Málaga o directo', busText: 'El autobús directo del aeropuerto de Málaga a Nerja pasa solo unas pocas veces al día. Viajáis con más flexibilidad si tomáis el tren de Cercanías (C1) en el aeropuerto, llegáis en unos doce minutos a la estación de Málaga María Zambrano y allí cambiáis al autobús regular de Alsa a Nerja. En Nerja termina en la estación de autobuses; desde allí un cuarto de hora cuesta abajo a pie o cinco minutos en taxi.',
  ...
  nl: {
    ...
    heroText: 'Vanaf de luchthaven Málaga reis je met de Alsa-bus naar Nerja, meestal via het centrum van Málaga; hij eindigt bij het busstation, van daar ga je verder met de taxi of te voet. Transfer en huurauto brengen jullie tot Calle Castilla Pérez 60, ongeveer 200 meter van het strand Torrecilla. Geparkeerd wordt een paar straten verder, en voor de lift zijn er tien treden: vijf buiten, vijf binnen.',
    optionsEyebrow: 'Vanaf Málaga Airport', optionsTitle: 'De bus rijdt direct, de auto rijdt verder',
    carEyebrow: 'Transfer of huurauto', carTitle: 'Tot de deur — en dan een plek', carText: 'Met bagage is de transfer het comfortabelst. Een huurauto loont voor Maro, Frigiliana en de Axarquía; voor een of twee uitjes volstaat een huurauto voor die dagen. De kustsnelweg A-7 van Málaga naar Nerja is volledig tolvrij. Met een elektrische auto: de kaart toont de dichtstbijzijnde laadpunten.',
    busEyebrow: 'Alsa-bus', busTitle: 'Via het centrum van Málaga of direct', busText: 'De directe bus vanaf de luchthaven Málaga naar Nerja rijdt maar een paar keer per dag. Flexibeler reis je door op de luchthaven de Cercanías-trein (C1) te nemen, in ongeveer twaalf minuten naar het centraal station Málaga María Zambrano te rijden en daar over te stappen op de reguliere Alsa-bus naar Nerja. In Nerja eindigt hij bij het busstation; van daar een kwartier naar beneden te voet of vijf minuten met de taxi.',
  ...
  sv: {
    ...
    heroText: 'Från Málagas flygplats tar ni er till Nerja med Alsa-buss, oftast via Málagas centrum; den slutar vid busstationen, därifrån fortsätter ni med taxi eller till fots. Transfer och hyrbil tar er till Calle Castilla Pérez 60, cirka 200 meter från stranden Torrecilla. Ni parkerar några gator bort, och före hissen är det tio trappsteg: fem utanför huset, fem inne.',
    optionsEyebrow: 'Från Málaga flygplats', optionsTitle: 'Bussen går direkt, bilen går längre',
    carEyebrow: 'Transfer eller hyrbil', carTitle: 'Ända fram till dörren — sedan en plats', carText: 'Med bagage är transfern bekvämast. En hyrbil lönar sig för Maro, Frigiliana och Axarquía; för en eller två utflyktsdagar räcker en hyrbil för de dagarna. Kustmotorvägen A-7 från Málaga till Nerja är helt avgiftsfri. Med elbil: kartan visar närmaste laddpunkter.',
    busEyebrow: 'Alsa-buss', busTitle: 'Via Málagas centrum eller direkt', busText: 'Direktbussen från Málagas flygplats till Nerja går bara några gånger om dagen. Ni reser smidigare om ni tar Cercanías-tåget (C1) på flygplatsen, kommer till Málagas centralstation María Zambrano på ungefär tolv minuter och där byter till den ordinarie Alsa-bussen till Nerja. I Nerja slutar den vid busstationen; därifrån en kvart nedför till fots eller fem minuter med taxi.',
