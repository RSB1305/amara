...
export const nerjaWinterStaysContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        l(
          "The apartment has heating, a full kitchen and a washing machine — the things that matter once a stay runs past a week. The bed measures 200 × 200 cm, the largest at AMARA, and the balcony has a side view of the sea. On top of that: fast fibre Wi-Fi and a place to work with power sockets within reach. Evenings stay warm indoors; mornings, the first coffee comes with the side sea view from the balcony.",
          "Die Wohnung hat Heizung, eine voll ausgestattete Küche und eine Waschmaschine — genau das, was ab der zweiten Woche zählt. Das Bett misst 200 × 200 cm, das größte bei AMARA, und der Balkon hat seitlichen Meerblick. Dazu kommen schnelles Glasfaser-WLAN und ein Platz zum Arbeiten mit Steckdosen in Reichweite. Abends bleibt es drinnen warm, morgens der erste Kaffee mit seitlichem Meerblick vom Balkon.",
          "El apartamento tiene calefacción, cocina completa y lavadora: lo que importa cuando la estancia pasa de una semana. La cama mide 200 × 200 cm, la más grande de AMARA, y el balcón tiene vistas laterales al mar. A eso se suman wifi de fibra rápida y un sitio para trabajar con enchufes a mano. Por la tarde se está caliente dentro; por la mañana, el primer café con vistas laterales al mar desde el balcón.",
          "Het appartement heeft verwarming, een volledige keuken en een wasmachine — precies wat telt zodra een verblijf langer dan een week duurt. Het bed meet 200 × 200 cm, het grootste bij AMARA, en het balkon heeft zijdelings zeezicht. Daar komen snelle glasvezel-wifi en een plek om te werken met stopcontacten binnen handbereik bij. ’s Avonds blijft het binnen warm; ’s ochtends de eerste koffie met zijdelings zeezicht vanaf het balkon.",
          "Lägenheten har värme, fullt utrustat kök och tvättmaskin — det som betyder något när vistelsen passerar en vecka. Sängen mäter 200 × 200 cm, den största hos AMARA, och balkongen har havsutsikt åt sidan. Till det kommer snabbt fiber-wifi och en plats att arbeta på med eluttag inom räckhåll. Kvällar är varma inomhus; på morgonen den första kaffen med havsutsikt åt sidan från balkongen."
        ),
        l(
