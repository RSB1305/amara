...
export const nerjaWinterStaysContent = {
  ...
  hero: {
    ...
    subtitle: l(
      "Quiet coast, mild sun",
      "Ruhige Küste, milde Sonne",
      "Costa tranquila, sol suave",
      "Rustige kust, milde zon",
      "Lugn kust, mild sol"
    ),
    standfirst: l(
  ...
  sections: [
    {
      ...
      paragraphs: [
        l(
          "In winter the seafront and the Balcón de Europa are far emptier than in July. From AMARA Playa it is roughly 500 metres to the Balcón and about 200 to Torrecilla beach. The walk there is flat, with no climb — unlike the hill village, and an effortless advantage on a longer stay.",
          "Im Winter sind die Uferpromenade und der Balcón de Europa deutlich leerer als im Juli. Von AMARA Playa sind es rund 500 Meter zum Balcón und etwa 200 zum Strand Torrecilla. Der Weg dorthin ist flach, ohne Steigung — anders als im Bergdorf, und gerade für längere Aufenthalte ein müheloser Vorteil.",
          "En invierno el paseo marítimo y el Balcón de Europa están mucho más vacíos que en julio. Desde AMARA Playa hay unos 500 metros al Balcón y unos 200 a la playa de Torrecilla. El camino es llano, sin cuestas — al contrario que en el pueblo de montaña, y una ventaja sin esfuerzo para estancias largas.",
          "In de winter zijn de boulevard en het Balcón de Europa veel leger dan in juli. Vanaf AMARA Playa is het ongeveer 500 meter naar het Balcón en zo'n 200 naar het Torrecilla-strand. De weg ernaartoe is vlak, zonder klim — anders dan in het bergdorp, en juist voor langere verblijven een moeiteloos voordeel.",
          "På vintern är strandpromenaden och Balcón de Europa betydligt tommare än i juli. Från AMARA Playa är det cirka 500 meter till Balcón och omkring 200 till Torrecillastranden. Vägen dit är plan, utan stigning — till skillnad från bergsbyn, och en bekväm fördel vid en längre vistelse."
        ),
        l(
    ...
    },
    {
      ...
      paragraphs: [
        l(
          "Heating comes from a powerful air conditioner with a heating function, along with a full kitchen and a washing machine — the things that matter once a stay runs past a week. The bed measures 200 × 200 cm, the largest at AMARA. The balcony faces **west**: in winter the low afternoon sun falls on the side sea view — a warm spot for a coffee before the evening turns cosy indoors. On top of that: fast fibre Wi-Fi and a place to work with power sockets within reach.",
          "Geheizt wird über eine leistungsstarke Klimaanlage mit Heizfunktion, dazu kommen eine voll ausgestattete Küche und eine Waschmaschine — genau das, was ab der zweiten Woche zählt. Das Bett misst 200 × 200 cm, das größte bei AMARA. Der Balkon zeigt nach **Westen**: Im Winter fällt nachmittags die tiefe Sonne auf den seitlichen Meerblick — ein warmer Platz für den Kaffee, bevor es abends drinnen gemütlich wird. Dazu schnelles Glasfaser-WLAN und ein Platz zum Arbeiten mit Steckdosen in Reichweite.",
          "La calefacción funciona con un aire acondicionado potente con función de calor, además de cocina completa y lavadora: lo que importa cuando la estancia pasa de una semana. La cama mide 200 × 200 cm, la más grande de AMARA. El balcón mira al **oeste**: en invierno el sol bajo de la tarde da sobre las vistas laterales al mar — un rincón cálido para el café antes de que la tarde se vuelva acogedora dentro. A eso se suman wifi de fibra rápida y un sitio para trabajar con enchufes a mano.",
          "Verwarmen gaat via een krachtige airconditioning met verwarmingsfunctie, plus een volledige keuken en een wasmachine — precies wat telt zodra een verblijf langer dan een week duurt. Het bed meet 200 × 200 cm, het grootste bij AMARA. Het balkon ligt op het **westen**: in de winter valt de lage middagzon op het zijdelingse zeezicht — een warme plek voor de koffie voordat het ’s avonds binnen gezellig wordt. Daar komen snelle glasvezel-wifi en een plek om te werken met stopcontacten binnen handbereik bij.",
          "Uppvärmningen sker via en kraftfull luftkonditionering med värmefunktion, plus ett fullt utrustat kök och en tvättmaskin — det som betyder något när vistelsen passerar en vecka. Sängen mäter 200 × 200 cm, den största hos AMARA. Balkongen vetter mot **väster**: på vintern faller den låga eftermiddagssolen på havsutsikten åt sidan — en varm plats för kaffet innan kvällen blir mysig inomhus. Till det kommer snabbt fiber-wifi och en plats att arbeta på med eluttag inom räckhåll."
        ),
        l(
