...
export const frigilianaGeographyContent = {
  ...
  closing: {
    ...
    body: l("Casa AMARA sits on Calle Chorruelo, where Calle Real continues through the historic village. That places the stay on this mental map; the where-to-stay guide explains what the position means for the routes you repeat each day.", "Casa AMARA liegt an der Calle Chorruelo, dort setzt sich die Calle Real durch den historischen Ort fort. Damit ist die Unterkunft auf dieser mentalen Karte verortet; der Überblick zu den Lagen erklärt, was die Position für eure täglichen Wege bedeutet.", "Casa AMARA está en la calle Chorruelo, donde continúa la calle Real por el pueblo histórico. Así queda situada en este mapa mental; la guía sobre dónde alojarse explica qué significa la ubicación para los recorridos que repetís cada día.", "Casa AMARA ligt aan Calle Chorruelo, waar Calle Real door de historische kern verderloopt. Zo krijgt het verblijf een plek op deze mentale kaart; de gids over waar te overnachten legt uit wat de ligging betekent voor jullie dagelijkse routes.", "Casa AMARA ligger på Calle Chorruelo, där Calle Real fortsätter genom den historiska byn. Det placerar boendet på den här mentala kartan; guiden om var man ska bo förklarar vad läget betyder för era dagliga vägar."),
