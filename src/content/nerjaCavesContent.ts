...
export const nerjaCavesContent = {
  ...
  hero: {
    ...
    note: l("Opening hours and prices are with the operator; the link is below.", "Öffnungszeiten und Preise stehen beim Betreiber, der Link ist unten.", "Horarios y precios están en la web del operador; el enlace está abajo.", "Openingstijden en prijzen staan bij de exploitant; de link staat onderaan.", "Öppettider och priser finns hos operatören; länken står nedan."),
