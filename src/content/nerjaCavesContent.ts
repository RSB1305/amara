...
export const nerjaCavesContent = {
  ...
  hero: {
    ...
    note: l("Opening hours, prices and time slots change and are deliberately not listed here — check the operator before you go.", "Öffnungszeiten und Preise stehen beim Betreiber, der Link ist unten.", "Horarios, precios y franjas horarias cambian y no se indican aquí: consultadlos en la fundación antes de ir.", "Openingstijden, prijzen en tijdvakken veranderen en staan hier bewust niet — controleer ze vooraf bij de beheerder.", "Öppettider, priser och tidsluckor ändras och anges medvetet inte här — kontrollera dem hos anläggningen före besöket."),
    updated: l("Reviewed August 2026", "Stand August 2026", "Revisado en agosto de 2026", "Gecontroleerd in augustus 2026", "Granskad i augusti 2026")
  },
  facts: [
    {
