...
export const gettingToTarifaSeo: AmaraAuthoringSeo = {
  ...
  article,
  languages: {
    en: { title: 'Getting to Tarifa & AMARA Family & Surf', description: 'The N-340 from Málaga or Cádiz, coaches to Calle Batalla del Salado, four usable airports and the ferry from Tangier — then Mar Adriático 29 with its own garage space.', robots: 'index, follow', canonical: 'auto' },
    de: { title: 'Anreise nach Tarifa & AMARA Family & Surf', description: 'Die N-340 von Málaga oder Cádiz, Fernbusse zur Calle Batalla del Salado, vier brauchbare Flughäfen und die Fähre aus Tanger — dann Mar Adriático 29 mit eigenem Garagenplatz.', robots: 'index, follow', canonical: 'auto' },
    es: { title: 'Cómo llegar a Tarifa y a AMARA Family & Surf', description: 'La N-340 desde Málaga o Cádiz, autobuses a la Calle Batalla del Salado, cuatro aeropuertos útiles y el ferry desde Tánger, y luego Mar Adriático 29 con plaza de garaje.', robots: 'index, follow', canonical: 'auto' },
    nl: { title: 'Naar Tarifa & AMARA Family & Surf', description: 'De N-340 vanaf Málaga of Cádiz, bussen naar Calle Batalla del Salado, vier bruikbare luchthavens en de ferry uit Tanger — dan Mar Adriático 29 met eigen garageplaats.', robots: 'index, follow', canonical: 'auto' },
    sv: { title: 'Resa till Tarifa & AMARA Family & Surf', description: 'N-340 från Málaga eller Cádiz, bussar till Calle Batalla del Salado, fyra användbara flygplatser och färjan från Tanger — sedan Mar Adriático 29 med egen garageplats.', robots: 'index, follow', canonical: 'auto' }
  }
};
  ...
  sections: [
    {
      ...
      title: l("Four airports, and then a stretch of road", "Vier Flughäfen, und dann noch ein Stück Straße", "Cuatro aeropuertos, y luego un trecho de carretera", "Vier luchthavens, en dan nog een stuk weg", "Fyra flygplatser, och sedan en bit väg"),
      paragraphs: [
        l(
          "Málaga usually has the widest choice of flights. Gibraltar is geographically closer but adds a land border and the documents that go with it. Jerez brings you in from the Cádiz side, Seville from further north on the A-4. Roughly, Málaga is about 160 km and around two hours by road, Seville about 200 km and two to two and a half hours, Jerez about 120 km, and Gibraltar only about 45 km plus the border.",
          "Málaga hat meist die größte Flugauswahl. Gibraltar liegt geografisch näher, bringt aber eine Landgrenze und die dazugehörigen Dokumente mit. Jerez führt euch von der Cádiz-Seite heran, Sevilla von weiter nördlich über die A-4. Grob: Málaga sind etwa 160 km und rund zwei Stunden Fahrt, Sevilla etwa 200 km und zwei bis zweieinhalb Stunden, Jerez etwa 120 km und Gibraltar nur rund 45 km plus Grenze.",
          "Málaga suele tener la mayor oferta de vuelos. Gibraltar queda más cerca pero añade una frontera terrestre y su documentación. Jerez os acerca desde el lado de Cádiz; Sevilla, desde más al norte por la A-4. A grandes rasgos: Málaga está a unos 160 km y cerca de dos horas por carretera, Sevilla a unos 200 km y entre dos horas y dos y media, Jerez a unos 120 km y Gibraltar a solo unos 45 km más la frontera.",
          "Málaga heeft meestal het grootste vluchtaanbod. Gibraltar ligt geografisch dichterbij maar voegt een landgrens en de bijbehorende documenten toe. Jerez brengt je binnen vanaf de kant van Cádiz, Sevilla van verder noordelijk over de A-4. Ruwweg: Málaga is ongeveer 160 km en zo'n twee uur rijden, Sevilla ongeveer 200 km en twee tot tweeënhalf uur, Jerez ongeveer 120 km en Gibraltar maar zo'n 45 km plus de grens.",
          "Málaga har oftast störst flygutbud. Gibraltar ligger geografiskt närmare men lägger till en landgräns och de handlingar som hör dit. Jerez tar er in från Cádizsidan, Sevilla längre norrifrån via A-4. Grovt: Málaga är cirka 160 km och runt två timmars körning, Sevilla cirka 200 km och två till två och en halv timme, Jerez cirka 120 km och Gibraltar bara cirka 45 km plus gränsen."
        ),
        l(
        ...
        l(
          "With a hire car or transfer you are here from the airport in one and a half to two and a half hours; if you land late, take the transfer.",
          "Mit Mietwagen oder Transfer seid ihr vom Flughafen in eineinhalb bis zweieinhalb Stunden da; wer spät landet, nimmt den Transfer.",
          "Con coche de alquiler o traslado tardáis entre una hora y media y dos horas y media desde el aeropuerto; quien aterriza tarde, coge el traslado.",
          "Met huurauto of transfer ben je vanaf de luchthaven in anderhalf tot tweeënhalf uur hier; wie laat landt, neemt de transfer.",
          "Med hyrbil eller transfer är ni här från flygplatsen på en och en halv till två och en halv timme; den som landar sent tar transfern."
        )
      ]
    },
    {
