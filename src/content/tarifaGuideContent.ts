...
const beaches: TarifaGuideContent = {
  ...
  hero: {
    ...
    title: l('Choose the beach for the day you actually have', 'Tarifas Strände', 'Elegir la playa para el día que realmente hace', 'Kies het strand dat past bij de dag van vandaag', 'Välj strand efter dagen du faktiskt har'),
    lead: l('Tarifa’s coastline stretches from a small Mediterranean cove to broad Atlantic beaches and the protected landscape around Bolonia. The best choice depends on wind, activity, season and the atmosphere you want.', 'Playa Chica zum Baden, Los Lances für die Weite und den Wind, Valdevaqueros für die Düne, Bolonia für einen ganzen Tag. Welcher heute passt, entscheidet der Wind: Bei Levante liegt die Playa Chica auf der Mittelmeerseite geschützt, bei Poniente ist Los Lances der Strand vor unserer Tür.', 'La costa de Tarifa va desde una pequeña cala mediterránea hasta amplias playas atlánticas y el paisaje protegido de Bolonia. La mejor elección depende del viento, la actividad, la temporada y el ambiente buscado.', 'De kust van Tarifa loopt van een kleine mediterrane baai tot brede Atlantische stranden en het beschermde landschap rond Bolonia. De beste keuze hangt af van wind, activiteit, seizoen en gewenste sfeer.', 'Tarifas kust sträcker sig från en liten Medelhavsvik till breda Atlantstränder och det skyddade landskapet kring Bolonia. Bästa valet beror på vind, aktivitet, säsong och önskad stämning.'),
