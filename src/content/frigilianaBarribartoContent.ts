...
export const frigilianaBarribartoCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: l(
        'The word to know up here is adarve. An adarve is a lane that belongs partly to the street and partly to the houses along it — sometimes open, sometimes reached under an algorfa, a room built across the passage overhead. The Barribarto has eleven that carry names: the Zacatín, the Túnel, the Señor, the Huerta, the Amargura, the Peñón, the Batanero, the Torreón, the Cura Soto, the Corralón and the Inquisidor. Almost all of them are dead-ends: half-private cul-de-sacs that serve only the houses along them, not public through-streets, and you feel it as the lane narrows and turns. When a passage begins to feel like a courtyard, it is one — step back to the open lanes and leave it to its houses.',
        'Das Wort, das man hier oben kennen sollte, ist Adarve. Ein Adarve ist eine Gasse, die halb der Straße gehört und halb den Häusern an ihr — mal offen, mal unter einer Algorfa betreten, einem Raum, der über den Durchgang gebaut ist. Das Barribarto hat elf mit Namen: den Zacatín, den Túnel, den Señor, die Huerta, die Amargura, den Peñón, den Batanero, den Torreón, den Cura Soto, den Corralón und den Inquisidor. Fast alle sind Sackgassen: halbprivate Stichwege, die nur den Häusern an ihnen dienen, keine öffentlichen Durchgangsstraßen, und man spürt es, wie die Gasse sich verengt und abknickt. Wenn sich ein Durchgang wie ein Hof anfühlt, ist er einer — tretet zurück in die offenen Gassen und überlasst ihn seinen Häusern.',
        'La palabra que conviene conocer aquí arriba es adarve. Un adarve es un callejón que pertenece en parte a la calle y en parte a las casas que dan a él: unas veces abierto, otras al que se entra bajo una algorfa, una estancia construida sobre el paso. El Barribarto tiene once con nombre: el Zacatín, el Túnel, el del Señor, el de la Huerta, el de la Amargura, el del Peñón, el del Batanero, el del Torreón, el de Cura Soto, el del Corralón y el del Inquisidor. Casi todos son callejones sin salida: fondos de saco semiprivados que solo dan servicio a las casas que dan a ellos, no vías públicas de paso, y se nota cuando la calle se estrecha y quiebra. Cuando un pasaje empieza a sentirse como un patio, lo es: volved a las calles abiertas y dejadlo a sus casas.',
        'Het woord dat je hierboven moet kennen is adarve. Een adarve is een straatje dat deels bij de straat hoort en deels bij de huizen eraan — soms open, soms betreden onder een algorfa, een kamer die over de doorgang heen is gebouwd. Het Barribarto telt er elf met een naam: de Zacatín, de Túnel, de Señor, de Huerta, de Amargura, de Peñón, de Batanero, de Torreón, de Cura Soto, de Corralón en de Inquisidor. Bijna allemaal zijn het doodlopende steegjes: halfprivé hofjes die alleen de huizen eraan ontsluiten, geen openbare doorgaande straten, en je voelt het als het straatje versmalt en afbuigt. Als een doorgang als een binnenplaats gaat aanvoelen, is het er een — stap terug naar de open straatjes en laat hem aan zijn huizen.',
        'Ordet man bör kunna här uppe är adarve. En adarve är en gränd som delvis hör till gatan och delvis till husen längs den — ibland öppen, ibland nådd under en algorfa, ett rum byggt tvärs över passagen ovanför. Barribarto har elva med namn: Zacatín, Túnel, Señor, Huerta, Amargura, Peñón, Batanero, Torreón, Cura Soto, Corralón och Inquisidor. Nästan alla är återvändsgränder: halvprivata återvändor som bara betjänar husen längs dem, inte offentliga genomfartsgator, och man känner det när gränden smalnar av och viker. När en passage börjar kännas som en gårdsplan är den det — kliv tillbaka till de öppna gränderna och lämna den åt sina hus.'
      )
    },
    {
