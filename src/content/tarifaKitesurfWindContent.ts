...
export const tarifaKitesurfWindContent: TarifaKitesurfWindContent = {
  ...
  hero: {
    ...
    note: l('Model values, official guidance and Robert’s personal observations are marked separately.', 'Wir wohnen und kiten hier selbst.', 'Los valores del modelo, la información oficial y las observaciones personales de Robert se distinguen con claridad.', 'Modelwaarden, officiële informatie en Roberts persoonlijke observaties zijn apart gemarkeerd.', 'Modellvärden, officiell information och Roberts personliga iakttagelser anges var för sig.')
  },
  live: {
  ...
  windguru: {
    ...
    terms: [
      ...
      },
      {
        ...
        text: l('The period of the most energetic part of the spectrum. Not a guaranteed gap between two particular waves.', 'Die Periode des Anteils mit der meisten Energie, ein Rechenwert aus dem Modell.', 'El periodo de la parte con más energía. No es una distancia garantizada entre dos olas concretas.', 'De periode van het energierijkste deel. Geen gegarandeerde afstand tussen twee concrete golven.', 'Perioden för den mest energirika delen. Inget garanterat avstånd mellan två konkreta vågor.')
      },
      {
        id: 'wind-wave',
