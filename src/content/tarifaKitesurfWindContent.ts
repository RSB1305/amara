...
export const tarifaKitesurfWindContent: TarifaKitesurfWindContent = {
  ...
  safety: {
    ...
    aemetText: l('Official AEMET warnings take precedence over any model calculation. We do not summarise them and we do not weigh them against other models. The machine-readable warning zone for Tarifa has not yet been verified; until then we link directly to AEMET’s official Tarifa forecast and warnings.', 'Amtliche AEMET-Warnungen haben Vorrang vor jeder Modellrechnung. Wir fassen sie nicht zusammen und rechnen sie nicht gegen andere Modelle auf. Die maschinenlesbare Warnzone für Tarifa ist noch nicht verifiziert; bis dahin verlinken wir direkt zur amtlichen Tarifa-Vorhersage und zu den Warnungen von AEMET.', 'Los avisos oficiales de AEMET prevalecen sobre cualquier cálculo de modelo. No los resumimos ni los contraponemos a otros modelos. La zona de aviso legible por máquina para Tarifa aún no está verificada; hasta entonces enlazamos directamente a la previsión oficial de Tarifa y a los avisos de AEMET.', 'Officiële AEMET-waarschuwingen gaan boven elke modelberekening. We vatten ze niet samen en zetten ze niet af tegen andere modellen. De machineleesbare waarschuwingszone voor Tarifa is nog niet geverifieerd; tot die tijd linken we rechtstreeks naar de officiële Tarifa-verwachting en de waarschuwingen van AEMET.', 'Officiella AEMET-varningar går före varje modellberäkning. Vi sammanfattar dem inte och väger dem inte mot andra modeller. Den maskinläsbara varningszonen för Tarifa är ännu inte verifierad; tills dess länkar vi direkt till AEMET:s officiella Tarifa-prognos och varningar.'),
