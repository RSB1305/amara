...
export const tarifaKitesurfWindContent: TarifaKitesurfWindContent = {
  ...
  windguru: {
    ...
    intro: l(
      'The first time you look at Windguru as a beginner, you see a wall of numbers, colours and arrows — and it makes you nervous. It did the same to us. So we go through it calmly here, on real live data. We show you two models: GFS 13 km on top for the rough trend over the next days, WRF 3 km below it for the local day — exactly the two the locals here work with. What each row means comes next, step by step.',
      'Als Anfänger schaut ihr zum ersten Mal auf Windguru und seht eine Wand aus Zahlen, Farben und Pfeilen — und werdet erst mal nervös. Ging uns genauso. Deshalb gehen wir es hier in Ruhe durch, an echten Live-Daten. Wir zeigen euch zwei Modelle: oben GFS 13 km für den groben Trend der nächsten Tage, darunter WRF 3 km für den lokalen Tag — genau die zwei, mit denen die Locals hier arbeiten. Was jede Zeile bedeutet, kommt gleich Schritt für Schritt.',
      'La primera vez que miráis Windguru como principiantes veis un muro de números, colores y flechas, y os ponéis nerviosos. A nosotros nos pasó igual. Por eso aquí lo vemos con calma, con datos reales en directo. Os mostramos dos modelos: arriba GFS 13 km para la tendencia general de los próximos días, y debajo WRF 3 km para el día local, justo los dos con los que trabajan los locales. Lo que significa cada fila viene ahora, paso a paso.',
      'De eerste keer dat jullie als beginner naar Windguru kijken, zien jullie een muur van cijfers, kleuren en pijlen — en worden jullie nerveus. Ging ons net zo. Daarom nemen we het hier rustig door, met echte livegegevens. We laten jullie twee modellen zien: bovenaan GFS 13 km voor de grove trend van de komende dagen, daaronder WRF 3 km voor de lokale dag — precies de twee waar de locals hier mee werken. Wat elke rij betekent, komt zo, stap voor stap.',
      'Första gången ni som nybörjare tittar på Windguru ser ni en vägg av siffror, färger och pilar — och blir nervösa. Det gick likadant för oss. Därför går vi igenom det i lugn och ro här, på riktiga livedata. Vi visar er två modeller: överst GFS 13 km för den grova trenden de närmaste dagarna, under den WRF 3 km för den lokala dagen — precis de två som de lokala här jobbar med. Vad varje rad betyder kommer strax, steg för steg.'
    ),
  ...
  closing: {
    ...
    finalLine: l('Forecasts are calculations. Official warnings come first, and on the beach the signs, buoys and instructions on site apply.', 'Forecasts sind Rechnungen. Amtliche Warnungen zählen zuerst, und am Strand gelten Beschilderung, Bojen und die Anweisungen vor Ort.', 'Los pronósticos son cálculos. Los avisos oficiales van primero, y en la playa mandan las señales, las boyas y las indicaciones del lugar.', 'Voorspellingen zijn berekeningen. Officiële waarschuwingen gaan voor, en op het strand gelden de borden, boeien en aanwijzingen ter plaatse.', 'Prognoser är beräkningar. Officiella varningar går först, och på stranden gäller skyltar, bojar och anvisningarna på plats.')
  }
};
