...
export const tarifaKitesurfBeginnerGuide: TarifaKitesurfGuideContent = {
  ...
  explore: {
    ...
    links: [
      ...
      { token: 'tarifa_wind_kitesurfing_authority', label: l('Wind & safety', 'Wind & Sicherheit', 'Viento y seguridad', 'Wind & veiligheid', 'Vind & säkerhet'), text: l('The current read on wind and conditions before your kite day, and how to read the forecast yourself.', 'Der aktuelle Blick auf Wind und Bedingungen vor eurem Kitetag — und wie ihr die Vorhersage selbst lest.', 'La lectura actual del viento y las condiciones antes de tu día de kite, y cómo leer tú mismo la previsión.', 'De actuele blik op wind en omstandigheden vóór je kitedag, en hoe je de voorspelling zelf leest.', 'Den aktuella bilden av vind och förhållanden före din kitedag, och hur du själv läser prognosen.') },
