  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        l(
          'A water park is high on many children’s wish list. The nearest one, Bahía Park in Algeciras, is closed right now — shut until June 2027, so the long drive is not worth it. But you hardly need it for a splash: the water at Playa Chica is shallow and calm, on the long Atlantic beaches the children jump through the waves, and a bucket and spade save a whole afternoon.',
          'Ganz oben auf dem Wunschzettel steht bei vielen Kindern ein Wasserpark 💦. Der nächste, der Bahía Park in Algeciras, hat allerdings gerade zu — er ist **bis Juni 2027 geschlossen**, die weite Fahrt lohnt sich also nicht. Zum Planschen braucht es ihn aber kaum: Am Playa Chica ist das Wasser flach und ruhig, an den langen Atlantikstränden springen die Kinder durch die Wellen 🌊, und mit Eimer und Schaufel 🪣 ist ein ganzer Nachmittag gerettet.',
          'Un parque acuático está muy arriba en la lista de deseos de muchos niños. El más cercano, Bahía Park en Algeciras, está cerrado ahora mismo — hasta junio de 2027, así que el largo viaje no compensa. Pero apenas hace falta para chapotear: en Playa Chica el agua es poco profunda y tranquila, en las largas playas atlánticas los niños saltan entre las olas, y con cubo y pala se salva toda una tarde.',
          'Een waterpark staat bij veel kinderen hoog op het verlanglijstje. Het dichtstbijzijnde, Bahía Park in Algeciras, is nu dicht — gesloten tot juni 2027, dus de lange rit is het niet waard. Maar om te spetteren heb je het amper nodig: bij Playa Chica is het water ondiep en rustig, op de lange Atlantische stranden springen de kinderen door de golven, en met emmer en schep is een hele middag gered.',
          'En vattenpark står högt på många barns önskelista. Den närmaste, Bahía Park i Algeciras, är stängd just nu — stängd till juni 2027, så den långa körningen lönar sig inte. Men för att plaska behövs den knappt: vid Playa Chica är vattnet grunt och lugnt, på de långa atlantstränderna hoppar barnen genom vågorna, och med hink och spade räddas en hel eftermiddag.'
        )
      ]
    }
  ],
