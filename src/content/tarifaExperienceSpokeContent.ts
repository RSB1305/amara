  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        l(
          'Older children can try a kite taster with a proper school from around age eight, a first riding lesson or a guided e-bike route — we point you to the right people and help you book.',
          ...
          'Los niños mayores pueden probar el kitesurf con una escuela de verdad a partir de unos ocho años, una primera clase de equitación o una ruta guiada en bici eléctrica — os remitimos a la gente adecuada y os ayudamos a reservar.',
          'Oudere kinderen kunnen vanaf een jaar of acht een kite-proefles bij een echte school proberen, een eerste rijles of een begeleide e-biketocht — we verwijzen je naar de juiste mensen en helpen met boeken.',
          'Äldre barn kan prova på kitesurfing med en riktig skola från omkring åtta års ålder, en första ridlektion eller en guidad elcykeltur — vi hänvisar er till rätt personer och hjälper till att boka.'
        ),
        l(
