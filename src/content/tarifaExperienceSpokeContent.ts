...
const family: TarifaExperienceSpokeContent = {
  ...
  hero: {
    eyebrow: l('Tarifa experience guide', 'Tarifa erleben', 'Experiencias en Tarifa', 'Tarifa beleven', 'Upplev Tarifa'),
    title: l(
      'Tarifa with children, at your own pace 🏖️',
      'Tarifa mit Kindern, in eurem Tempo 🏖️',
      'Tarifa con niños, a vuestro ritmo 🏖️',
      'Tarifa met kinderen, in jullie tempo 🏖️',
      'Tarifa med barn, i er egen takt 🏖️'
    ),
    standfirst: l(
      'Tarifa is known for the wind, but for families other things count: a calm town beach with a play area 🛝 for the little ones, whales and dolphins 🐬 from a big, stable boat, the huge Bolonia dune to run up, and a car-free old town where children can just set off with an ice cream 🍦 in hand. We have welcomed many families at Family & Surf and plan the day with the wind rather than against it.',
      'Tarifa ist für den Wind bekannt, für Familien zählt aber anderes: ein ruhiger Stadtstrand mit Spielbereich 🛝 für die Kleinen, Wale und Delfine 🐬 von einem großen, stabilen Boot aus, die riesige Düne von Bolonia zum Hochrennen und eine autofreie Altstadt, in der Kinder mit einem Eis 🍦 in der Hand einfach loslaufen dürfen. Wir haben im Family & Surf schon viele Familien begrüßt und planen den Tag lieber mit dem Wind als gegen ihn.',
      'Tarifa es conocida por el viento, pero para las familias cuenta otra cosa: una playa urbana tranquila con zona de juegos 🛝 para los más pequeños, ballenas y delfines 🐬 desde un barco grande y estable, la enorme duna de Bolonia para subir corriendo y un casco antiguo peatonal por el que los niños pueden echar a andar con un helado 🍦 en la mano. En Family & Surf hemos recibido a muchas familias y planificamos el día con el viento, no contra él.',
      'Tarifa staat bekend om de wind, maar voor gezinnen telt iets anders: een rustig stadsstrand met speelplek 🛝 voor de kleintjes, walvissen en dolfijnen 🐬 vanaf een grote, stabiele boot, het enorme duin van Bolonia om op te rennen en een autovrije oude stad waar kinderen zomaar op pad kunnen met een ijsje 🍦 in de hand. In Family & Surf hebben we veel gezinnen ontvangen en plannen we de dag met de wind in plaats van ertegen.',
      'Tarifa är känt för vinden, men för familjer räknas annat: en lugn stadsstrand med lekplats 🛝 för de små, valar och delfiner 🐬 från en stor, stabil båt, den väldiga dynen i Bolonia att springa uppför och en bilfri gamla stan där barnen bara kan ge sig av med en glass 🍦 i handen. På Family & Surf har vi tagit emot många familjer och planerar dagen med vinden i stället för mot den.'
    ),
    note: l(
  ...
  facts: [
    { label: l('With little ones', 'Mit den Kleinen', 'Con los más pequeños', 'Met de kleintjes', 'Med de små'), value: l('🏖️ Playa Chica: calm water, showers, a play area', '🏖️ Playa Chica: ruhiges Wasser, Duschen, Spielbereich', '🏖️ Playa Chica: agua tranquila, duchas, zona de juegos', '🏖️ Playa Chica: rustig water, douches, speelplek', '🏖️ Playa Chica: lugnt vatten, duschar, lekplats') },
    ...
    { label: l('One bigger day', 'Ein großer Tag', 'Un día grande', 'Eén grotere dag', 'En större dag'), value: l('🏛️ Bolonia & Baelo Claudia: beach, dune and a Roman town', '🏛️ Bolonia & Baelo Claudia: Strand, Düne und Römerstadt', '🏛️ Bolonia y Baelo Claudia: playa, duna y ciudad romana', '🏛️ Bolonia & Baelo Claudia: strand, duin en Romeinse stad', '🏛️ Bolonia & Baelo Claudia: strand, dyn och romersk stad') }
  ],
  sections: [
    {
      id: 'relaxed-base',
      ...
      paragraphs: [
        l(
          'Tarifa’s name comes from kitesurfing, but a family week here runs on sand, animals and time outdoors. The strength of the place is the mix: swimming at the calm Playa Chica 🏖️, watching whales and birds, watching the fishing boats ⛵ in the harbour, an ice cream 🍦 in the car-free old town in the evening — and a Roman town by the sea for the big day. Almost all of it is **within walking distance or a short drive**.',
          'Tarifas Name kommt vom Kitesurfen, doch eine Familienwoche hier lebt von Sand, Tieren und Zeit draußen. Die Stärke des Ortes ist die Mischung: baden am ruhigen Playa Chica 🏖️, Wale und Vögel beobachten, im Hafen den Fischerbooten ⛵ zusehen, abends ein Eis 🍦 in der autofreien Altstadt — und für den großen Tag eine Römerstadt am Meer. Fast alles liegt **zu Fuß oder eine kurze Fahrt entfernt**.',
          'El nombre de Tarifa viene del kitesurf, pero una semana en familia aquí se sostiene en arena, animales y tiempo al aire libre. La fuerza del lugar es la mezcla: bañarse en la tranquila Playa Chica 🏖️, observar ballenas y aves, ver los barcos de pesca ⛵ en el puerto, un helado 🍦 al atardecer en el casco antiguo peatonal — y para el día grande una ciudad romana junto al mar. Casi todo queda **a pie o a poca distancia en coche**.',
          'De naam Tarifa komt van het kitesurfen, maar een gezinsweek hier draait op zand, dieren en tijd buiten. De kracht van de plek is de mix: zwemmen bij het rustige Playa Chica 🏖️, walvissen en vogels spotten, in de haven naar de vissersboten ⛵ kijken, ’s avonds een ijsje 🍦 in de autovrije oude stad — en voor de grote dag een Romeinse stad aan zee. Bijna alles ligt **op loopafstand of een korte rit weg**.',
          'Namnet Tarifa kommer från kitesurfing, men en familjevecka här bygger på sand, djur och tid utomhus. Platsens styrka är blandningen: bada vid lugna Playa Chica 🏖️, titta på valar och fåglar, se fiskebåtarna ⛵ i hamnen, en glass 🍦 på kvällen i den bilfria gamla stan — och en romersk stad vid havet för den stora dagen. Nästan allt ligger **på gångavstånd eller en kort bilfärd bort**.'
        ),
        l(
          'The one thing to plan around is the wind 🌬️. It can turn a beach afternoon into a hill walk within hours, so we do not fix every day in advance. We keep the whale trip and the water day flexible and always keep **something quieter up our sleeve** for windy days — the play area at Playa Chica, the old town, an outing into the countryside. That way the wind shapes the holiday instead of spoiling it.',
          'Womit ihr wirklich planen solltet, ist der Wind 🌬️. Er macht aus einem Strandnachmittag binnen Stunden eine Wanderung, deshalb legen wir nicht jeden Tag vorab fest. Wir halten Walfahrt und Wassertag flexibel und haben für windige Tage immer **etwas Ruhigeres in der Hinterhand** — den Spielbereich am Playa Chica, die Altstadt, einen Ausflug ins Grüne. So formt der Wind den Urlaub, statt ihn zu verderben.',
          'Con lo que de verdad hay que contar es con el viento 🌬️. Puede convertir una tarde de playa en una caminata en pocas horas, así que no fijamos cada día por adelantado. Mantenemos flexibles la salida de ballenas y el día de agua y siempre guardamos **algo más tranquilo en la recámara** para los días de viento: la zona de juegos de Playa Chica, el casco antiguo, una excursión al campo. Así el viento da forma a las vacaciones en lugar de estropearlas.',
          'Waar je echt rekening mee moet houden, is de wind 🌬️. Hij kan een strandmiddag binnen enkele uren in een wandeling veranderen, dus leggen we niet elke dag vooraf vast. We houden de walvistocht en de waterdag flexibel en hebben voor winderige dagen altijd **iets rustigers achter de hand** — de speelplek bij Playa Chica, de oude stad, een uitstap het groen in. Zo vormt de wind de vakantie in plaats van hem te bederven.',
          'Det man verkligen ska planera kring är vinden 🌬️. Den kan förvandla en strandeftermiddag till en vandring på några timmar, så vi låser inte varje dag i förväg. Vi håller valturen och vattendagen flexibla och har alltid **något lugnare i bakfickan** för blåsiga dagar — lekplatsen vid Playa Chica, gamla stan, en utflykt ut i det gröna. Så formar vinden semestern i stället för att förstöra den.'
        )
      ]
    },
    {
      ...
      paragraphs: [
        l(
          'Playa Chica, right in town, is **the easiest beach with small children**: comparatively calm water for paddling 💦, showers and a play area 🛝 right next to it, all a few minutes on foot. On the days when the Atlantic beaches are too windy, this is where the families move — and the children barely notice the wind.',
          'Playa Chica mitten in der Stadt ist **der einfachste Strand mit kleinen Kindern**: vergleichsweise ruhiges Wasser zum Planschen 💦, Duschen und ein Spielbereich 🛝 gleich daneben, alles wenige Minuten zu Fuß. An Tagen, an denen die Atlantikstrände zu windig sind, ziehen die Familien hierher — und die Kinder merken vom Wind kaum etwas.',
          'Playa Chica, en pleno pueblo, es **la playa más fácil con niños pequeños**: agua relativamente tranquila para chapotear 💦, duchas y una zona de juegos 🛝 justo al lado, todo a pocos minutos a pie. Los días en que las playas atlánticas soplan demasiado, aquí es donde se van las familias — y los niños apenas notan el viento.',
          'Playa Chica, midden in het dorp, is **het makkelijkste strand met kleine kinderen**: relatief rustig water om te spetteren 💦, douches en een speelplek 🛝 er vlak naast, alles een paar minuten lopen. Op de dagen dat de Atlantische stranden te winderig zijn, wijken de gezinnen hierheen uit — en de kinderen merken amper iets van de wind.',
          'Playa Chica, mitt i stan, är **den enklaste stranden med små barn**: förhållandevis lugnt vatten att plaska i 💦, duschar och en lekplats 🛝 alldeles intill, allt några minuters promenad. De dagar då atlantstränderna blåser för mycket är det hit familjerna flyttar — och barnen märker knappt av vinden.'
        ),
        l(
          'For a full beach day, the southern stretch of Los Lances is a wide family beach 🏖️ with walkways and places to eat. It is more exposed, so **on a strong Levante** it becomes a walk rather than a swim — which is exactly when Playa Chica or the hills are the better call.',
          'Für einen ganzen Strandtag ist der südliche Abschnitt von Los Lances ein weiter Familienstrand 🏖️ mit Stegen und Lokalen. Er ist offener, **bei kräftigem Levante** wird daraus ein Spaziergang statt eines Bades — genau dann sind Playa Chica oder die Hügel die bessere Wahl.',
          'Para un día entero de playa, el tramo sur de Los Lances es una amplia playa familiar 🏖️ con pasarelas y sitios para comer. Está más expuesto, así que **con levante fuerte** se convierte en un paseo más que en un baño, y es justo entonces cuando Playa Chica o las colinas son mejor opción.',
          'Voor een hele stranddag is het zuidelijke stuk van Los Lances een breed gezinsstrand 🏖️ met vlonders en eetgelegenheden. Het is opener, dus **bij een stevige Levante** wordt het eerder een wandeling dan een duik — precies dan zijn Playa Chica of de heuvels de betere keuze.',
          'För en hel strandag är den södra delen av Los Lances en bred familjestrand 🏖️ med spänger och ställen att äta. Den är mer utsatt, så **vid stark Levante** blir det en promenad snarare än ett bad — och då är Playa Chica eller kullarna det bättre valet.'
        ),
        l(
          'Between two beach days it takes little to keep children happy: watching the fishing and excursion boats ⛵ in the harbour, wandering the car-free lanes of the old town, an ice cream 🍦 in hand. Most of it is **on foot from Family & Surf**.',
          'Zwischen zwei Strandtagen braucht es nicht viel: im Hafen den Fischer- und Ausflugsbooten ⛵ zusehen, durch die autofreien Gassen der Altstadt bummeln, ein Eis 🍦 in der Hand — und die Kinder sind zufrieden. Das meiste davon liegt **vom Family & Surf aus zu Fuß**.',
          'Entre dos días de playa hace falta poco para tener contentos a los niños: ver los barcos de pesca y de excursión ⛵ en el puerto, pasear por las calles peatonales del casco antiguo, un helado 🍦 en la mano. Casi todo queda **a pie desde Family & Surf**.',
          'Tussen twee stranddagen is er weinig nodig om kinderen tevreden te houden: in de haven naar de vissers- en excursieboten ⛵ kijken, door de autovrije straatjes van de oude stad slenteren, een ijsje 🍦 in de hand. Het meeste ligt **op loopafstand van Family & Surf**.',
          'Mellan två strandagar krävs det inte mycket för att hålla barnen nöjda: titta på fiske- och utflyktsbåtarna ⛵ i hamnen, strosa genom gamla stans bilfria gränder, en glass 🍦 i handen. Det mesta ligger **på gångavstånd från Family & Surf**.'
        )
      ]
    },
    {
      ...
      paragraphs: [
        l(
          'A whale-watching trip 🐋 is one of the loveliest things to do with children here — and genuinely family-suitable: the big, stable boats take **small children and even babies**, often at reduced fares, and a guide explains on board what to look for. In the Strait of Gibraltar pilot whales and dolphins are around almost all year, and in high summer even orcas pass through. For children, spotting a fin in the water for the first time is the real thing. It depends heavily on the weather, so we keep it flexible and arrange a trip that fits the day.',
          'Eine Walbeobachtung 🐋 ist hier fast das Schönste mit Kindern — und wirklich familientauglich: Die großen, stabilen Boote nehmen **kleine Kinder und sogar Babys** mit, oft zu ermäßigten Preisen, und ein Guide erklärt an Bord, worauf man achten muss. In der Straße von Gibraltar sind Grindwale und Delfine fast das ganze Jahr unterwegs, im Hochsommer ziehen sogar Orcas durch. Für die Kinder ist es großes Kino, das erste Mal eine Flosse im Wasser zu entdecken. Die Fahrt hängt stark vom Wetter ab, deshalb halten wir sie flexibel und vermitteln euch eine, die zum Tag passt.',
          'Una salida de avistamiento 🐋 es de lo más bonito que se puede hacer aquí con niños — y de verdad apta para familias: los barcos grandes y estables llevan a **niños pequeños e incluso bebés**, a menudo con tarifas reducidas, y un guía explica a bordo en qué fijarse. En el Estrecho de Gibraltar hay calderones y delfines casi todo el año, y en pleno verano incluso pasan orcas. Para los niños, descubrir por primera vez una aleta en el agua es todo un espectáculo. Depende mucho del tiempo, así que la mantenemos flexible y os buscamos una salida que encaje en el día.',
          'Een walvistocht 🐋 is een van de leukste dingen om hier met kinderen te doen — en echt gezinsvriendelijk: de grote, stabiele boten nemen **kleine kinderen en zelfs baby’s** mee, vaak met korting, en een gids legt aan boord uit waar je op moet letten. In de Straat van Gibraltar zijn griend en dolfijnen bijna het hele jaar aanwezig, en in de hoogzomer trekken er zelfs orka’s door. Voor kinderen is het groots om voor het eerst een vin in het water te ontdekken. Het hangt sterk van het weer af, dus we houden het flexibel en regelen een tocht die bij de dag past.',
          'En valskådningstur 🐋 är en av de finaste sakerna att göra med barn här — och verkligen familjevänlig: de stora, stabila båtarna tar med **små barn och till och med bebisar**, ofta till reducerat pris, och en guide förklarar ombord vad man ska titta efter. I Gibraltar sund finns grindvalar och delfiner nästan hela året, och på högsommaren passerar till och med späckhuggare. För barnen är det stort att för första gången upptäcka en fena i vattnet. Det beror mycket på vädret, så vi håller det flexibelt och ordnar en tur som passar dagen.'
        ),
        l(
          'On land the Parque Natural del Estrecho has short, kid-friendly walks with views all the way to Africa, and in migration season storks and raptors 🦅 cross the Strait in droves. The best single outing is **Bolonia**: a wide beach and a huge shifting dune that children run up and down, right next to the Roman town of Baelo Claudia — from building sandcastles into a two-thousand-year-old street in two minutes.',
          'An Land bietet der Parque Natural del Estrecho kurze, kinderleichte Wege mit Blick bis nach Afrika, und zur Zugzeit ziehen Störche und Greifvögel 🦅 in Scharen über die Meerenge. Der schönste einzelne Ausflug ist **Bolonia**: ein breiter Strand und eine riesige Wanderdüne, die Kinder rauf- und runterrennen, direkt neben der Römerstadt Baelo Claudia — vom Sandburgenbauen in zwei Minuten in eine zweitausend Jahre alte Straße.',
          'En tierra, el Parque Natural del Estrecho tiene paseos cortos y fáciles para niños con vistas hasta África, y en época de paso cigüeñas y rapaces 🦅 cruzan el Estrecho en bandadas. La mejor excursión es **Bolonia**: una playa amplia y una enorme duna móvil que los niños suben y bajan corriendo, justo al lado de la ciudad romana de Baelo Claudia — de hacer castillos de arena a una calle de hace dos mil años en dos minutos.',
          'Op het land heeft het Parque Natural del Estrecho korte, kindvriendelijke wandelingen met uitzicht tot aan Afrika, en in de trektijd trekken ooievaars en roofvogels 🦅 in drommen over de Straat. De mooiste losse uitstap is **Bolonia**: een breed strand en een enorm wandelduin waar kinderen op en af rennen, vlak naast de Romeinse stad Baelo Claudia — van zandkastelen bouwen naar een tweeduizend jaar oude straat in twee minuten.',
          'På land har Parque Natural del Estrecho korta, barnvänliga vandringar med utsikt ända till Afrika, och under flyttningstiden drar storkar och rovfåglar 🦅 i mängd över sundet. Den finaste enskilda utflykten är **Bolonia**: en bred strand och en väldig vandringsdyn som barnen springer upp och ner för, alldeles intill den romerska staden Baelo Claudia — från sandslottsbygge till en tvåtusen år gammal gata på två minuter.'
        )
      ]
    },
    {
      ...
      paragraphs: [
        l(
          'For a week we would not try to tick everything off — one larger outing is plenty. For younger children, an animal-rescue zoo about an hour inland; for older ones, the Rock of Gibraltar with its cheeky macaques 🐒. Both are full days; Gibraltar’s cable car is **closed for refurbishment until at least 2027**, so the Rock is reached by shuttle for now.',
          'Für eine Woche würden wir nicht versuchen, alles abzuhaken — ein größerer Ausflug reicht völlig. Für jüngere Kinder ein Tier-Rettungszoo etwa eine Stunde im Landesinneren, für ältere der Fels von Gibraltar mit seinen frechen Makaken 🐒. Beides sind ganze Tage; Gibraltars Seilbahn ist **bis mindestens 2027 wegen Sanierung dicht**, den Fels erreicht man vorerst per Shuttle.',
          'Para una semana no intentaríamos verlo todo — con una excursión mayor basta. Para los más pequeños, un zoo de rescate de animales a una hora hacia el interior; para los mayores, el Peñón de Gibraltar con sus traviesos macacos 🐒. Ambos son días enteros; el teleférico de Gibraltar está **cerrado por reforma hasta al menos 2027**, así que al Peñón se sube en lanzadera por ahora.',
          'Voor een week zouden we niet alles willen afvinken — één grotere uitstap is genoeg. Voor jongere kinderen een dierenopvangzoo op zo’n uur landinwaarts; voor oudere de Rots van Gibraltar met haar brutale makaken 🐒. Beide zijn hele dagen; Gibraltars kabelbaan is **wegens renovatie dicht tot minstens 2027**, dus de Rots bereik je voorlopig met een shuttle.',
          'För en vecka skulle vi inte försöka pricka av allt — en större utflykt räcker gott. För yngre barn en djurräddningszoo ungefär en timme inåt landet; för äldre Gibraltarklippan med sina fräcka makaker 🐒. Båda är heldagar; Gibraltars linbana är **stängd för renovering till minst 2027**, så klippan nås med skyttel tills vidare.'
        ),
        l(
          'Older children can try a kite taster 🪁 with a proper school from around **age eight**, a first riding lesson 🐴 or a guided e-bike route 🚲 with us — we point you to the right people and help you book.',
          'Ältere Kinder können ab etwa **acht Jahren** einen Kite-Schnupperkurs 🪁 bei einer echten Schule machen, eine erste Reitstunde 🐴 nehmen oder mit uns eine E-Bike-Runde 🚲 drehen — wir verweisen euch auf die richtigen Leute und helfen beim Buchen.',
          'Los niños mayores pueden probar el kitesurf 🪁 con una escuela de verdad a partir de unos **ocho años**, una primera clase de equitación 🐴 o una ruta guiada en bici eléctrica 🚲 con nosotros — os remitimos a la gente adecuada y os ayudamos a reservar.',
          'Oudere kinderen kunnen vanaf een jaar of **acht** een kite-proefles 🪁 bij een echte school proberen, een eerste rijles 🐴 of een begeleide e-biketocht 🚲 met ons — we verwijzen je naar de juiste mensen en helpen met boeken.',
          'Äldre barn kan prova på kitesurfing 🪁 med en riktig skola från omkring **åtta års ålder**, en första ridlektion 🐴 eller en guidad elcykeltur 🚲 med oss — vi hänvisar er till rätt personer och hjälper till att boka.'
        ),
        l(
          'A water park 💦 is high on many children’s wish list. The nearest one, Bahía Park in Algeciras, is closed until June 2027, so the long drive is not worth it. But you hardly need it for a splash: the accommodation has its **own pool** 🏊 (open depending on the weather, usually mid-May to mid-September), plus the shallow, calm water at Playa Chica and the long Atlantic beaches where the children jump through the waves 🌊 — a bucket and spade 🪣 save a whole afternoon.',
          'Ganz oben auf dem Wunschzettel steht bei vielen Kindern ein Wasserpark 💦. Der nächste, der Bahía Park in Algeciras, ist allerdings bis Juni 2027 geschlossen — die weite Fahrt lohnt sich also nicht. Zum Planschen braucht es ihn aber kaum: Die Unterkunft hat einen **eigenen Pool** 🏊 (je nach Wetter geöffnet, meist von Mitte Mai bis Mitte September), dazu das flache, ruhige Wasser am Playa Chica und die langen Atlantikstrände, an denen die Kinder durch die Wellen 🌊 springen — mit Eimer und Schaufel 🪣 ist ein ganzer Nachmittag gerettet.',
          'Un parque acuático 💦 está muy arriba en la lista de deseos de muchos niños. El más cercano, Bahía Park en Algeciras, está cerrado hasta junio de 2027, así que el largo viaje no compensa. Pero apenas hace falta para chapotear: el alojamiento tiene su **propia piscina** 🏊 (abierta según el tiempo, normalmente de mediados de mayo a mediados de septiembre), además del agua poco profunda y tranquila de Playa Chica y las largas playas atlánticas donde los niños saltan entre las olas 🌊 — con cubo y pala 🪣 se salva toda una tarde.',
          'Een waterpark 💦 staat bij veel kinderen hoog op het verlanglijstje. Het dichtstbijzijnde, Bahía Park in Algeciras, is gesloten tot juni 2027, dus de lange rit is het niet waard. Maar om te spetteren heb je het amper nodig: de accommodatie heeft een **eigen zwembad** 🏊 (open afhankelijk van het weer, meestal van half mei tot half september), plus het ondiepe, rustige water bij Playa Chica en de lange Atlantische stranden waar de kinderen door de golven 🌊 springen — met emmer en schep 🪣 is een hele middag gered.',
          'En vattenpark 💦 står högt på många barns önskelista. Den närmaste, Bahía Park i Algeciras, är stängd till juni 2027, så den långa körningen lönar sig inte. Men för att plaska behövs den knappt: boendet har en **egen pool** 🏊 (öppen beroende på vädret, oftast från mitten av maj till mitten av september), plus det grunda, lugna vattnet vid Playa Chica och de långa atlantstränderna där barnen hoppar genom vågorna 🌊 — med hink och spade 🪣 räddas en hel eftermiddag.'
        )
      ]
    }
  ],
  host: {
    ...
    paragraphs: [
      ...
      l(
        'And for the rainy or especially windy afternoons, there is a **waffle iron** 🧇 in the flat — our guests’ children have loved nothing more than baking their own waffles. Whatever else they are into — a boat, a beach, a first kite lesson — just ask us. We live with the same wind, and we are glad to point you to the day that will actually work.',
        'Und für die verregneten oder besonders windigen Nachmittage steht in der Wohnung ein **Waffeleisen** 🧇 — die Kinder unserer Gäste haben nichts lieber gemacht, als sich ihre eigenen Waffeln zu backen. Worauf sie sonst Lust haben, ein Boot, ein Strand, eine erste Kitestunde: fragt uns einfach. Wir leben mit demselben Wind und zeigen euch gern den Tag, der wirklich funktioniert.',
        'Y para las tardes de lluvia o de mucho viento, en el piso hay una **gofrera** 🧇 — a los niños de nuestros huéspedes nada les ha gustado más que hornear sus propios gofres. Y lo que sea que les apetezca — un barco, una playa, una primera clase de kite — preguntadnos sin más. Vivimos con el mismo viento y os indicamos con gusto el día que de verdad va a salir bien.',
        'En voor de regenachtige of juist winderige middagen staat er een **wafelijzer** 🧇 in het appartement — de kinderen van onze gasten deden niets liever dan hun eigen wafels bakken. En waar ze verder ook van houden — een boot, een strand, een eerste kiteles — vraag het ons gerust. Wij leven met dezelfde wind en wijzen je graag de dag die echt gaat lukken.',
        'Och för de regniga eller särskilt blåsiga eftermiddagarna finns det ett **våffeljärn** 🧇 i lägenheten — våra gästers barn har inte gjort något hellre än att grädda sina egna våfflor. Och vad de än gillar — en båt, en strand, en första kitelektion — fråga oss bara. Vi lever med samma vind och visar er gärna den dag som faktiskt fungerar.'
      )
    ]
  },
  related: {
