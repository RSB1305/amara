  ...
  sections: [
    {
      ...
      paragraphs: [
        l(
          ...
          'Tarifas Name kommt vom Kitesurfen, doch eine Familienwoche hier lebt von Sand, Tieren und Zeit draußen. Die Stärke des Ortes ist die Mischung: baden am ruhigen Playa Chica, Wale und Vögel beobachten, im Hafen den Fischerbooten zusehen, abends ein Eis in der autofreien Altstadt — und für den großen Tag eine Römerstadt am Meer. Fast alles liegt **zu Fuß oder eine kurze Fahrt entfernt**.',
        ...
        l(
          ...
          'Womit ihr wirklich planen solltet, ist der Wind. Er macht aus einem Strandnachmittag binnen Stunden eine Wanderung, deshalb legen wir nicht jeden Tag vorab fest. Wir halten Walfahrt und Wassertag flexibel und haben für windige Tage immer **etwas Ruhigeres in der Hinterhand** — den Spielbereich am Playa Chica, die Altstadt, einen Ausflug ins Grüne. So formt der Wind den Urlaub, statt ihn zu verderben.',
