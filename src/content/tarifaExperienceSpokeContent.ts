...
const yoga: TarifaExperienceSpokeContent = {
  ...
  hero: {
    ...
    standfirst: l(
      'For its size, Tarifa carries an unusually broad yoga scene: town studios, classes by the sea, family and aerial formats and multi-day retreats. From Family & Surf in La Marina you begin inside a small wellness cluster on Calle Mar Adriático, with yoga mats already in the apartment for your own morning flow. Class times here follow the season and are often shared at short notice, so we hand you the current booking links when you arrive rather than printing a timetable that may have moved.',
      'Für seine Größe hat Tarifa eine ungewöhnlich breite Yoga-Szene: Studios im Ort, Kurse am Meer, Familien- und Aerial-Formate und mehrtägige Retreats. Von Family & Surf in La Marina startet ihr mitten in einem kleinen Wellness-Cluster an der Calle Mar Adriático, mit Yogamatten, die schon in der Unterkunft liegen – für euren eigenen Morning Flow. Die Kurszeiten richten sich hier nach der Saison und werden oft kurzfristig geteilt; deshalb geben wir euch bei der Anreise die aktuellen Buchungslinks statt eines Stundenplans, der sich längst verschoben haben kann.',
      'Para su tamaño, Tarifa reúne una escena de yoga sorprendentemente amplia: estudios en el pueblo, clases junto al mar, formatos familiares y aéreos y retiros de varios días. Desde Family & Surf, en La Marina, empezáis dentro de un pequeño núcleo de bienestar en la calle Mar Adriático, con esterillas ya en el apartamento para vuestra práctica de la mañana. Los horarios siguen la temporada y suelen anunciarse con poca antelación, así que a la llegada os pasamos los enlaces de reserva vigentes en lugar de un cuadro que puede haber cambiado.',
      'Voor haar formaat heeft Tarifa een opvallend brede yogascene: studio’s in het dorp, lessen aan zee, familie- en aerial-vormen en meerdaagse retreats. Vanaf Family & Surf in La Marina begin je midden in een klein wellnesscluster aan de Calle Mar Adriático, met yogamatten die al in het appartement liggen voor je eigen ochtendflow. Lestijden volgen hier het seizoen en worden vaak kort van tevoren gedeeld, dus bij aankomst geven we je de actuele boekingslinks in plaats van een rooster dat verschoven kan zijn.',
      'För sin storlek har Tarifa en ovanligt bred yogascen: studior i stan, klasser vid havet, familje- och aerialformer och flerdagarsretreat. Från Family & Surf i La Marina börjar ni mitt i ett litet wellnesskluster vid Calle Mar Adriático, med yogamattor som redan finns i lägenheten för er egen morgonflow. Tiderna följer säsongen och delas ofta med kort varsel, så vid ankomst ger vi er de aktuella bokningslänkarna i stället för ett schema som kan ha ändrats.'
    ),
    note: l(
