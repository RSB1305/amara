...
export const tarifaArrivalGuideBusRoutes = {
  en: [{ title: 'Local taxi for the final leg', meta: 'Best with children, boards or several bags', text: 'Ask for Las Terrazas de la Marina at Mar Adriático 29 so the driver has both the complex name and address.' }, { title: 'Walk from Calle Batalla del Salado', meta: 'Check the live route before travel', text: 'A coach stops in town, not at the apartment. Confirm the current walking route and conditions before relying on it.' }],
  de: [{ title: 'Lokales Taxi für die letzte Etappe', meta: 'Am besten mit Kindern, Boards oder mehreren Koffern', text: 'Nennt Las Terrazas de la Marina in der Mar Adriático 29, damit der Fahrer Anlagenamen und Adresse hat.' }, { title: 'Ab Calle Batalla del Salado laufen', meta: 'Aktuellen Weg vor der Reise prüfen', text: 'Der Bus hält im Ort, nicht am Apartment. Prüft Fußweg und Bedingungen aktuell, bevor ihr damit plant.' }],
  es: [{ title: 'Taxi local para el último tramo', meta: 'Mejor con niños, tablas o varias maletas', text: 'Pedid Las Terrazas de la Marina, Mar Adriático 29, para que el conductor tenga el nombre y la dirección.' }, { title: 'Ir andando desde Batalla del Salado', meta: 'Comprobad la ruta antes del viaje', text: 'El autobús para en la localidad, no en el apartamento. Confirmad la ruta y las condiciones actuales antes de contar con ella.' }],
  nl: [{ title: 'Lokale taxi voor het laatste stuk', meta: 'Het beste met kinderen, boards of meerdere koffers', text: 'Vraag om Las Terrazas de la Marina aan Mar Adriático 29 zodat de chauffeur naam en adres heeft.' }, { title: 'Lopen vanaf Calle Batalla del Salado', meta: 'Controleer de actuele route voor vertrek', text: 'De bus stopt in de stad, niet bij het appartement. Bevestig route en omstandigheden voordat jullie erop rekenen.' }],
  sv: [{ title: 'Lokal taxi för sista sträckan', meta: 'Bäst med barn, brädor eller flera väskor', text: 'Be om Las Terrazas de la Marina på Mar Adriático 29 så att föraren har både namn och adress.' }, { title: 'Promenera från Calle Batalla del Salado', meta: 'Kontrollera aktuell väg före resan', text: 'Bussen stannar i staden, inte vid lägenheten. Bekräfta gångväg och förhållanden innan ni planerar efter den.' }]
};
