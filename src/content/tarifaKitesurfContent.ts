...
const equipment: TarifaKitesurfSpokeContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ll(
        ['Tell us before your trip what you ride and what you would like to rent. We coordinate it with the club, so your set is waiting at AMARA Family & Surf when you arrive. And if a size still needs changing, the club’s shop is on the same street as AMARA Family & Surf — two houses down, barely 20 m away — so a quick message or a one-minute walk over is all it takes.', 'On offshore-wind days, rental with Help to Kite gives you company on the water and support from the rescue boat. We are happy to arrange that with the club too.'],
        ['Sagt uns vor der Reise kurz, welches Material ihr fahrt und was ihr leihen möchtet. Wir stimmen alles mit dem Club ab, damit euer Set bei eurer Ankunft in AMARA Family & Surf bereitliegt. Und wenn eine Größe doch noch nicht passt: Der Shop des Clubs liegt in derselben Straße wie AMARA Family & Surf, zwei Häuser weiter und keine 20 Meter entfernt – eine kurze Nachricht oder der Gang zu Fuß genügt.', 'An Tagen mit ablandigem Wind seid ihr mit Verleih plus Help to Kite gemeinsam mit anderen auf dem Wasser und habt die Unterstützung des Rescue-Boots. Auch das stimmen wir gerne mit dem Club für euch ab.'],
        ['Decidnos antes del viaje qué material usáis y qué os gustaría alquilar. Lo coordinamos con el club para que el set os espere en AMARA Family & Surf cuando lleguéis. Y si aún hay que cambiar una talla, la tienda del club está en la misma calle que AMARA Family & Surf, dos casas más allá y a apenas 20 metros, así que basta con un mensaje o un paseo de un minuto.', 'Los días de viento de tierra, el alquiler con Help to Kite os permite salir acompañados y contar con el apoyo de la lancha de rescate. También os ayudamos a coordinarlo con el club.'],
        ['Vertel ons voor de reis kort met welk materiaal jullie varen en wat jullie willen huren. Wij stemmen alles af met de club, zodat jullie set bij aankomst in AMARA Family & Surf klaarligt. En past een maat toch nog niet, dan ligt de shop van de club in dezelfde straat als AMARA Family & Surf, twee huizen verderop en amper 20 meter weg — een berichtje of een korte wandeling is genoeg.', 'Op dagen met aflandige wind gaan jullie met huur plus Help to Kite samen met anderen het water op en is de rescueboot erbij. Ook dat regelen we graag met de club.'],
        ['Berätta före resan vilken utrustning ni åker med och vad ni vill hyra. Vi stämmer av allt med klubben så att setet väntar på AMARA Family & Surf när ni kommer. Och om en storlek ändå behöver bytas ligger klubbens butik på samma gata som AMARA Family & Surf, två hus bort och knappt 20 meter, så det räcker med ett meddelande eller en kort promenad.', 'På dagar med frånlandsvind ger hyra med Help to Kite er sällskap på vattnet och stöd från räddningsbåten. Vi hjälper gärna till att ordna det med klubben.']
      )
    },
    {
      id: 'test-and-buy',
