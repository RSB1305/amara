...
const camp: TarifaKitesurfSpokeContent = {
  ...
  hero: {
    ...
    lead: l(
      'The name Tarifa Surf Club describes what happens here. Mark and I met ten years ago at one of its kitecamps. Days on the water became a close friendship, and our shared love of kitesurfing still connects us. The same sense of belonging brings many regular guests back: you arrive, meet like-minded people and quickly feel part of the club. A camp runs from mid-September to mid-June and includes six nights in the club’s accommodation, course days or Help 2 Kite, all gear and the rescue boat on offshore days. Dates are flexible. If you stay at AMARA, book the course days separately and we coordinate the rest with the club.',
      'Der Name Tarifa Surf Club beschreibt, was hier passiert. Mark und ich haben uns vor zehn Jahren in einem seiner Kitecamps kennengelernt. Aus den Tagen auf dem Wasser wurde eine enge Freundschaft, und unsere Liebe zum Kitesurfen verbindet uns bis heute. Dasselbe Zugehörigkeitsgefühl bringt viele Stammgäste zurück: Ihr kommt an, trefft Gleichgesinnte und gehört schnell zum Club. Ein Camp läuft von Mitte September bis Mitte Juni und umfasst sechs Nächte in der Unterkunft des Clubs, Kurstage oder Help 2 Kite, das komplette Material und das Rescue-Boot an Tagen mit ablandigem Wind. Die Anreise ist flexibel. Wer bei AMARA wohnt, bucht die Kurstage einzeln; den Rest koordinieren wir mit dem Club.',
      'El nombre Tarifa Surf Club describe lo que ocurre aquí. Mark y yo nos conocimos hace diez años en uno de sus kitecamps. De aquellos días en el agua nació una amistad muy estrecha y nuestro amor por el kitesurf nos une hasta hoy. Ese mismo sentimiento de pertenencia hace que muchos huéspedes habituales vuelvan: llegáis, conocéis a gente afín y enseguida os sentís parte del club. Un camp funciona de mediados de septiembre a mediados de junio e incluye seis noches en el alojamiento del club, días de curso o Help 2 Kite, todo el material y la lancha de rescate los días de viento de tierra. Las fechas son flexibles. Si os alojáis en AMARA, reserváis los días de curso por separado y coordinamos el resto con el club.',
      'De naam Tarifa Surf Club beschrijft wat hier gebeurt. Mark en ik leerden elkaar tien jaar geleden kennen tijdens een van de kitecamps. Uit de dagen op het water groeide een hechte vriendschap en onze liefde voor kitesurfen verbindt ons nog altijd. Datzelfde gevoel van verbondenheid brengt veel vaste gasten terug: jullie komen aan, ontmoeten gelijkgestemden en horen al snel bij de club. Een camp loopt van half september tot half juni en omvat zes nachten in de accommodatie van de club, lesdagen of Help 2 Kite, al het materiaal en de rescueboot op dagen met aflandige wind. De data zijn flexibel. Wie bij AMARA verblijft, boekt de lesdagen apart; wij stemmen de rest af met de club.',
      'Namnet Tarifa Surf Club beskriver vad som händer här. Mark och jag lärde känna varandra för tio år sedan på ett av klubbens kitecamp. Dagarna på vattnet växte till en nära vänskap, och kärleken till kitesurfingen förenar oss fortfarande. Samma känsla av tillhörighet får många stamgäster att återvända: ni kommer hit, träffar likasinnade och blir snabbt en del av klubben. Ett camp pågår från mitten av september till mitten av juni och omfattar sex nätter i klubbens boende, kursdagar eller Help 2 Kite, all utrustning och räddningsbåten på dagar med frånlandsvind. Datumen är flexibla. Bor ni hos AMARA bokar ni kursdagarna separat, och vi samordnar resten med klubben.'
    ),
    imageAlt: common.imageAlt
  },
  facts: [
