...
export const tarifaWinterStaysContent = {
  ...
  hero: {
    ...
    standfirst: l(
      ...
      "Im Sommer ist Tarifa ständig in Bewegung; im Winter erleben wir es ruhiger und vertrauter – das ist unsere Erfahrung, kein Versprechen. Weil AMARA Family & Surf 75 m² auf zwei Etagen mit Holzkamin, Heizung, voll ausgestatteter Küche und Waschmaschine bietet, taugen die ruhigen Wochen gut für längere Aufenthalte – auch zum Arbeiten, mit dem Supermarkt direkt gegenüber und dem Strand Los Lances rund 500 Meter entfernt. Der Wind bleibt der Taktgeber: Levante und Poniente prägen die Meerenge, und welcher weht, entscheidet sich am Tag und nicht in der Jahreszeit – deshalb lohnt sich hier ein zweiter Plan mehr als anderswo. Ein reservierter Tiefgaragenplatz gehört zur Wohnung. Nebensaison heißt auch ruhigere Raten; schickt uns eure Reisedaten, dann sagen wir euch, was in der Woche läuft.",
