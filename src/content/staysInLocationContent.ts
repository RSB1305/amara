...
export const staysInLocationContent: Partial<Record<StayLocation, StaysLocationCopy>> = {
  ...
  tarifa: {
    hero: {
      ...
      answer: lp(
        ['In Tarifa we have one AMARA stay: AMARA Family & Surf, 75 m² over two floors with two bedrooms and two bathrooms, room for up to four. A private balcony faces the Atlantic, and there is a shared pool and a reserved underground parking space. It is generous for two and comfortable for a family or surf crew. Check availability below, or first read which corner of Tarifa suits you.'],
        ['In Tarifa haben wir eine AMARA-Unterkunft: AMARA Family & Surf, 75 m² auf zwei Etagen mit zwei Schlafzimmern und zwei Bädern, Platz für bis zu vier. Ein privater Balkon zeigt zum Atlantik; dazu kommen ein Gemeinschaftspool und ein reservierter Tiefgaragenplatz. Zu zweit wohnt ihr großzügig, als Familie oder Surf-Crew passt ihr bequem hinein. Prüft unten die Verfügbarkeit, oder lest zuerst, welche Ecke von Tarifa zu euch passt.'],
        ['En Tarifa tenemos un alojamiento AMARA: AMARA Family & Surf, 75 m² en dos plantas con dos dormitorios y dos baños, espacio para hasta cuatro. Un balcón privado mira al Atlántico, y hay piscina comunitaria y plaza reservada en el garaje. Para dos resulta amplio y para una familia o un grupo de surf, cómodo. Consultad la disponibilidad abajo, o leed primero qué zona de Tarifa os conviene.'],
        ['In Tarifa hebben we één AMARA-verblijf: AMARA Family & Surf, 75 m² over twee verdiepingen met twee slaapkamers en twee badkamers, plaats voor maximaal vier. Een privébalkon kijkt uit op de Atlantische Oceaan, en er zijn een gedeeld zwembad en een gereserveerde parkeerplaats. Voor twee is het ruim en voor een gezin of surfploeg comfortabel. Bekijk hieronder de beschikbaarheid, of lees eerst welke hoek van Tarifa bij jullie past.'],
        ['I Tarifa har vi ett AMARA-boende: AMARA Family & Surf, 75 m² i två plan med två sovrum och två badrum, plats för upp till fyra. En privat balkong vetter mot Atlanten, och det finns gemensam pool och reserverad garageplats. För två är det rymligt och för en familj eller ett surfgäng bekvämt. Se tillgängligheten nedan, eller läs först vilken del av Tarifa som passar er.']
      )
    },
    collection: {
      title: l('The apartment', 'Die Unterkunft', 'El apartamento', 'Het appartement', 'Lägenheten'),
    ...
    stayNotes: {
      'la-amara-family-and-surf': l('Two floors and two bathrooms with a private Atlantic-facing balcony, a shared pool and reserved parking.', 'Zwei Etagen und zwei Bäder mit privatem Balkon zum Atlantik, Gemeinschaftspool und reserviertem Parkplatz.', 'Dos plantas y dos baños con balcón privado hacia el Atlántico, piscina comunitaria y plaza reservada.', 'Twee verdiepingen en twee badkamers met een privébalkon aan de Atlantische Oceaan, een gedeeld zwembad en gereserveerd parkeren.', 'Två plan och två badrum med privat balkong mot Atlanten, gemensam pool och reserverad parkering.')
    },
    handoff: {
      advisory: {
        eyebrow: l('Still deciding', 'Noch am Überlegen', 'Aún decidiendo', 'Nog aan het kiezen', 'Fortfarande osäkra'),
