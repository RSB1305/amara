...
> = {
  en: {
    ...
    localFood: {
      title: 'What grows and gets cooked around here',
      intro:
  ...
  de: {
    ...
    localFood: {
      title: 'Was hier wächst und auf den Teller kommt',
      intro:
  ...
  es: {
    ...
    localFood: {
      title: 'Lo que se cultiva y se cocina por aquí',
      intro:
  ...
  nl: {
    ...
    localFood: {
      title: 'Wat hier groeit en op het bord komt',
      intro:
  ...
  sv: {
    ...
    localFood: {
      title: 'Det som växer och lagas här',
      intro:
