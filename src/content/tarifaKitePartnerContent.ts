...
export const tarifaKitePartnerContent: TarifaKitePartnerContent = {
  ...
  hero: {
    ...
    title: l('Two partners, one Tarifa', 'Zwei Partner, ein Tarifa', 'Dos socios, un mismo Tarifa', 'Twee partners, één Tarifa', 'Två partner, ett Tarifa'),
    subtitle: l('Accommodation from AMARA, kiting in a club where friendships begin', 'Unterkunft von AMARA, Kiten in einem Club, in dem Freundschaften entstehen', 'Alojamiento de AMARA, kite en un club donde nacen amistades', 'Accommodatie van AMARA, kiten in een club waar vriendschappen ontstaan', 'Boende från AMARA, kitesurfing i en klubb där vänskap växer fram'),
    lead: l(
  ...
  paths: {
    ...
    items: [
      ...
      },
      {
        ...
        title: l('Kiting, sundowners and friendships', 'Kiten, Sundowner und Freundschaften', 'Kitesurf, atardeceres y amistades', 'Kiten, sundowners en vriendschappen', 'Kitesurfing, sundowners och vänskap'),
        text: l('Seven days with course, bed, gear and rescue, in a club where newcomers quickly belong and many regular guests return.', 'Sieben Tage mit Kurs, Bett, Material und Rescue, in einem Club, in dem Neuankömmlinge schnell dazugehören und viele Stammgäste zurückkehren.', 'Siete días con curso, cama, material y rescate, en un club donde quienes llegan enseguida se sienten parte y muchos habituales vuelven.', 'Zeven dagen met les, bed, materiaal en rescue, in een club waar nieuwkomers er snel bij horen en veel vaste gasten terugkeren.', 'Sju dagar med kurs, säng, utrustning och räddning, i en klubb där nya gäster snabbt hör hemma och många stamgäster återvänder.')
      },
      {
        id: 'education',
        token: 'tarifa_kitecamp',
  ...
  stays: {
    ...
    note: l('For kitecamps, accommodation is part of the package; depending on group size and availability, AMARA Family & Surf can be one of the places provided. Outside a camp, the club’s accommodation is booked with the club and AMARA Family & Surf with us.', 'Bei Kitecamps ist die Unterkunft Teil des Pakets; je nach Gruppengröße und Verfügbarkeit kann AMARA Family & Surf eine der bereitgestellten Unterkünfte sein. Außerhalb eines Camps bucht ihr die Unterkünfte des Clubs beim Club und AMARA Family & Surf bei uns.', 'En los kitecamps el alojamiento forma parte del paquete; según el tamaño del grupo y la disponibilidad, AMARA Family & Surf puede ser uno de los alojamientos previstos. Fuera de un camp, los alojamientos del club se reservan con el club y AMARA Family & Surf con nosotros.', 'Bij kitecamps maakt de accommodatie deel uit van het pakket; afhankelijk van groepsgrootte en beschikbaarheid kan AMARA Family & Surf een van de aangeboden accommodaties zijn. Buiten een camp boeken jullie de accommodaties van de club bij de club en AMARA Family & Surf bij ons.', 'Vid kitecamp ingår boendet i paketet; beroende på gruppstorlek och tillgänglighet kan AMARA Family & Surf vara ett av boendena som erbjuds. Utanför ett camp bokar ni klubbens boenden hos klubben och AMARA Family & Surf hos oss.')
  },
  knowledge: {
  ...
  story: {
    eyebrow: l('How it began', 'Wie alles begann', 'Cómo empezó', 'Hoe het begon', 'Hur det började'),
    title: l('One kitecamp, ten years of friendship', 'Ein Kitecamp, zehn Jahre Freundschaft', 'Un kitecamp, diez años de amistad', 'Eén kitecamp, tien jaar vriendschap', 'Ett kitecamp, tio års vänskap'),
    text: l(
      'Mark and I met ten years ago at a Tarifa Surf Club kitecamp. Our shared love of kitesurfing grew into a close friendship. The word club describes the place Mark has created: you arrive, feel welcome immediately, meet like-minded people and quickly become part of it. The many regular guests who return to the club and its camps show how long that sense of belonging lasts. Today we see and speak to each other almost every day in Tarifa, so we also settle questions and changes for our guests personally and directly.',
      'Mark und ich haben uns vor zehn Jahren in einem Kitecamp des Tarifa Surf Club kennengelernt. Aus der gemeinsamen Liebe zum Kitesurfen ist eine enge Freundschaft gewachsen. Das Wort Club beschreibt den Ort, den Mark geschaffen hat: Ihr kommt an, fühlt euch sofort willkommen, trefft Gleichgesinnte und gehört schnell dazu. Wie lange dieses Zugehörigkeitsgefühl trägt, zeigen die vielen Stammgäste, die zum Club und in die Camps zurückkehren. Heute sehen und sprechen wir uns in Tarifa fast täglich; deshalb klären wir auch für unsere Gäste Fragen und Änderungen persönlich und auf kurzem Weg.',
      'Mark y yo nos conocimos hace diez años en un kitecamp de Tarifa Surf Club. De nuestro amor compartido por el kitesurf nació una amistad muy estrecha. La palabra club describe el lugar que Mark ha creado: llegáis, os sentís bienvenidos desde el primer momento, conocéis a gente afín y enseguida formáis parte del grupo. Los muchos huéspedes habituales que vuelven al club y a sus camps demuestran cuánto perdura ese sentimiento de pertenencia. Hoy nos vemos y hablamos casi a diario en Tarifa, así que también resolvemos las preguntas y los cambios de nuestros huéspedes de forma personal y directa.',
      'Mark en ik leerden elkaar tien jaar geleden kennen tijdens een kitecamp van Tarifa Surf Club. Uit onze gedeelde liefde voor kitesurfen groeide een hechte vriendschap. Het woord club beschrijft de plek die Mark heeft gecreëerd: jullie komen aan, voelen je meteen welkom, ontmoeten gelijkgestemden en horen er snel bij. De vele vaste gasten die terugkeren naar de club en de camps laten zien hoe lang dat gevoel van verbondenheid blijft. Tegenwoordig zien en spreken we elkaar in Tarifa bijna dagelijks, waardoor we ook vragen en wijzigingen voor onze gasten persoonlijk en rechtstreeks regelen.',
      'Mark och jag lärde känna varandra för tio år sedan på ett av Tarifa Surf Clubs kitecamp. Vår gemensamma kärlek till kitesurfingen växte till en nära vänskap. Ordet klubb beskriver platsen Mark har skapat: ni kommer hit, känner er genast välkomna, träffar likasinnade och blir snabbt en del av gemenskapen. De många stamgäster som återvänder till klubben och dess kitecamp visar hur länge den känslan av tillhörighet består. I dag ses och hörs vi nästan varje dag i Tarifa, så vi löser också frågor och ändringar för våra gäster personligt och direkt.'
    ),
