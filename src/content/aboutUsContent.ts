...
export const aboutUsContent: AboutUsContent = {
  ...
  host: {
    ...
    paragraphs: [
      {
        en: 'Frigiliana was only meant to be a stop along the way. I was driving to Tarifa with my girlfriend at the time and wanted to see the famous white villages en route. I got out in Frigiliana and never quite drove on again — it was the quiet. As it happened, a house in the old town was for sale that very week. I bought it during that same stay, entirely unplanned, and found myself with a restoration project. The first guest arrived in May 2021.',
        de: 'Frigiliana war eigentlich nur eine Zwischenstation. Ich war mit meiner damaligen Freundin auf dem Weg nach Tarifa und wollte unterwegs die berühmten weißen Dörfer sehen. In Frigiliana bin ich ausgestiegen und nicht mehr richtig weitergefahren – es war die Ruhe. Zufällig stand genau in dieser Zeit ein Haus in der Altstadt zum Verkauf. Ich habe es noch während dieses Aufenthalts gekauft, völlig ungeplant, und hatte damit ein Renovierungsprojekt. Im Mai 2021 kam der erste Gast.',
        es: 'Frigiliana iba a ser solo una parada en el camino. Viajaba hacia Tarifa con mi pareja de entonces y quería ver de paso los famosos pueblos blancos. Me bajé en Frigiliana y ya no seguí del todo: fue la calma. Justo esos días había una casa en venta en el casco antiguo. La compré durante aquella misma estancia, sin haberlo planeado en absoluto, y me encontré con un proyecto de restauración. El primer huésped llegó en mayo de 2021.',
        nl: 'Frigiliana was eigenlijk maar een tussenstop. Ik was met mijn toenmalige vriendin op weg naar Tarifa en wilde onderweg de beroemde witte dorpen zien. In Frigiliana stapte ik uit en ben eigenlijk nooit meer echt verder gereden — het was de rust. Toevallig stond juist in die dagen een huis in de oude kern te koop. Ik heb het tijdens datzelfde verblijf gekocht, volkomen ongepland, en had daarmee een restauratieproject. In mei 2021 kwam de eerste gast.',
        sv: 'Frigiliana var egentligen bara ett stopp på vägen. Jag var på väg till Tarifa med min dåvarande flickvän och ville se de berömda vita byarna på vägen. I Frigiliana klev jag av och åkte aldrig riktigt vidare — det var lugnet. Av en slump låg ett hus i gamla stan ute till försäljning just då. Jag köpte det under samma vistelse, helt oplanerat, och hade därmed ett renoveringsprojekt. I maj 2021 kom den första gästen.'
      },
      {
        en: 'Tarifa is still the most beautiful place on this planet as far as I am concerned, and kitesurfing there is what I burn for. The friendship with the founder of Tarifa Surf Club dates from that time — which is why kite lessons and equipment are so straightforward to arrange for our guests in Tarifa.',
        de: 'Tarifa ist für mich bis heute der schönste Ort auf diesem Planeten, und Kitesurfen dort ist das, wofür ich brenne. Aus dieser Zeit stammt auch die Freundschaft mit dem Gründer des Tarifa Surf Club – deshalb lassen sich Kitekurse und Material für unsere Gäste in Tarifa so unkompliziert organisieren.',
        es: 'Tarifa sigue siendo para mí el lugar más bonito de este planeta, y el kitesurf allí es lo que de verdad me apasiona. De aquella época viene también la amistad con el fundador del Tarifa Surf Club, y por eso resulta tan sencillo organizar clases y material para nuestros huéspedes en Tarifa.',
        nl: 'Tarifa is voor mij nog altijd de mooiste plek op deze planeet, en kitesurfen daar is waar mijn hart ligt. Uit die tijd stamt ook de vriendschap met de oprichter van Tarifa Surf Club — daarom zijn kitelessen en materiaal voor onze gasten in Tarifa zo eenvoudig te regelen.',
        sv: 'Tarifa är fortfarande den vackraste platsen på den här planeten för mig, och att kitesurfa där är det jag brinner för. Från den tiden kommer också vänskapen med grundaren av Tarifa Surf Club — därför är kitelektioner och utrustning så enkla att ordna för våra gäster i Tarifa.'
      },
      {
    ...
    stats: [
      { label: { en: 'Hosting since 2021', de: 'Gastgeber seit 2021', es: 'Anfitrión desde 2021', nl: 'Host sinds 2021', sv: 'Värd sedan 2021' }, value: { en: 'First guest in May 2021. Today six stays across Frigiliana, Nerja and Tarifa.', de: 'Erster Gast im Mai 2021. Heute sechs Unterkünfte in Frigiliana, Nerja und Tarifa.', es: 'Primer huésped en mayo de 2021. Hoy, seis alojamientos en Frigiliana, Nerja y Tarifa.', nl: 'Eerste gast in mei 2021. Vandaag zes verblijven in Frigiliana, Nerja en Tarifa.', sv: 'Första gästen i maj 2021. I dag sex boenden i Frigiliana, Nerja och Tarifa.' } },
      { label: { en: 'More than 2,000 stays', de: 'Über 2.000 Gästewechsel', es: 'Más de 2.000 estancias', nl: 'Meer dan 2.000 verblijven', sv: 'Fler än 2 000 vistelser' }, value: { en: '4.94 out of 5 from more than 550 Airbnb reviews, and five Traveller Review Awards in 2026.', de: '4,94 von 5 aus über 550 Airbnb-Bewertungen und fünf Traveller Review Awards 2026.', es: '4,94 sobre 5 a partir de más de 550 reseñas en Airbnb y cinco Traveller Review Awards en 2026.', nl: '4,94 van 5 uit meer dan 550 Airbnb-beoordelingen en vijf Traveller Review Awards in 2026.', sv: '4,94 av 5 från fler än 550 Airbnb-omdömen och fem Traveller Review Awards 2026.' } },
