...
export const frigilianaLocationCopy = {
  ...
  "de": {
    ...
    "h1": "In Frigiliana wohnen: Altstadt vor der Tür, Meer in der Nähe",
    "heroUpdated": "Geprüft im August 2026",
    "heroNote": "Unser ehrlicher Blick auf das Dorf, in dem wir selbst leben und Gastgeber sind.",
    "intro": [
      ...
      "Casa AMARA liegt in der Calle Chorruelo neben der Kirche San Antonio. Von der Hauptstraße unterhalb sind es etwa 150 Meter bergauf, rund 30 Höhenmeter und ungefähr 30 Stufen bis zu unserer Tür. Oben angekommen, erreicht ihr Cafés, Restaurants und den Ortskern zu Fuß; einen privaten Parkplatz haben die Unterkünfte nicht."
    ],
    ...
    "decision": { "title": "Frigiliana passt zu euch, wenn die Gassen zum Urlaub gehören dürfen", "paragraphs": ["Hier wohnt ihr nicht neben einer Sehenswürdigkeit, sondern mitten im alten Dorf. Das bedeutet kurze Wege zu Restaurants und ruhige Stunden vor und nach den Tagesbesuchern – aber auch Steigungen, Stufen und keinen privaten Parkplatz."], "subsections": [{ "title": "Vier Unterkünfte hinter unserer Haustür", "paragraphs": ["Lounis, Zaid und Maha sind Apartments mit eigener Terrasse; Farah ist eine kompakte Suite ohne private Terrasse. Alle liegen in der Calle Chorruelo neben San Antonio."], "ctas": [{ "token": "FRIGILIANA_STAYS", "label": "Unterkünfte in Frigiliana ansehen" }, { "token": "COMPARISON", "label": "Frigiliana und Nerja vergleichen" }, { "token": "AVAILABILITY", "label": "Verfügbarkeit in Frigiliana prüfen" }] }], "ctas": [] }
  },
  "en": {
