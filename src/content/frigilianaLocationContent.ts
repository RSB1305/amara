...
export const frigilianaLocationCopy = {
  ...
  arrival: {
    ...
    steps: [
      { id: 'transport', num: '01', headline: text('Choose how to travel', 'Ab Málaga', 'Elegir cómo llegar', 'Kies hoe jullie reizen', 'Välj resesätt'), text: text('Compare rental car, transfer and public transport via Nerja for your whole trip.', 'Eine Stunde mit dem Mietwagen, mit dem Bus über Nerja.', 'Comparad coche de alquiler, traslado y transporte público vía Nerja para todo el viaje.', 'Vergelijk huurauto, transfer en openbaar vervoer via Nerja voor jullie hele reis.', 'Jämför hyrbil, transfer och kollektivtrafik via Nerja för hela resan.') },
      { id: 'last-route', num: '02', headline: text('Plan the final approach', 'Der letzte Weg', 'Planificar el último tramo', 'Plan de laatste route', 'Planera sista sträckan'), text: text('Parking, cobbles, slopes and steps matter more than the last few kilometres on the map.', 'Parken an der Avenida Carlos Cano, fünf Minuten bergauf über Pflaster und rund 30 Stufen.', 'El aparcamiento, el empedrado, las pendientes y los escalones importan más que los últimos kilómetros del mapa.', 'Parkeren, keien, hellingen en trappen zijn belangrijker dan de laatste kilometers op de kaart.', 'Parkering, stenläggning, backar och trappor betyder mer än de sista kilometrarna på kartan.') },
      { id: 'guide', num: '03', headline: text('Check the detailed guide', 'Vor der Anreise', 'Consultar la guía detallada', 'Bekijk vooraf de details', 'Läs detaljerna i förväg'), text: text('Our arrival guide brings the current route, parking and access information together.', 'Ihr bekommt von uns den Weg mit einem Foto der Haustür.', 'Nuestra guía de llegada reúne la información actual sobre ruta, aparcamiento y acceso.', 'Onze aankomstgids bundelt de actuele informatie over route, parkeren en toegang.', 'Vår ankomstguide samlar aktuell information om väg, parkering och tillträde.') }
    ],
  ...
  planning: {
    ...
    title: text('When Frigiliana becomes more than a backdrop', 'Wenn das Dorf Alltag wird', 'Cuando Frigiliana deja de ser solo un paisaje', 'Wanneer Frigiliana meer wordt dan een decor', 'När Frigiliana blir mer än en kuliss'),
    intro: text('A stay finds its own rhythm once you fetch bread in the morning, walk home through the lanes at night and leave the car alone for the small things.', 'Nach zwei Tagen kennt ihr den Weg zur Bäckerei, den Tisch für den Abend und den Heimweg durch die Gassen. Das Auto bleibt stehen.', 'La estancia encuentra su propio ritmo cuando salís a por pan por la mañana, volvéis andando por las calles de noche y dejáis el coche para los trayectos que de verdad lo necesitan.', 'Een verblijf krijgt een eigen ritme zodra jullie ’s ochtends brood halen, ’s avonds door de straatjes naar huis lopen en de auto laten staan voor de kleine dingen.', 'Vistelsen får sin egen rytm när ni hämtar bröd på morgonen, promenerar hem genom gränderna på kvällen och låter bilen stå för de små ärendena.'),
    gettingThere: { label: text('The first road into the hills', 'Eine Stunde ab Málaga', 'El primer camino hacia el pueblo', 'De eerste weg omhoog naar het dorp', 'Den första vägen upp till byn'), text: text('From Málaga, rental car, transfer or public transport via Nerja each gives the arrival a different rhythm.', 'Mit dem Mietwagen über Nerja hinauf, mit dem Bus mit Umstieg in Nerja. Unten parken, die letzten fünf Minuten zu Fuß.', 'Desde Málaga, el coche de alquiler, el traslado o el transporte público vía Nerja dan un ritmo distinto a la llegada.', 'Vanaf Málaga geven huurauto, transfer of openbaar vervoer via Nerja elk een ander ritme aan de aankomst.', 'Från Málaga ger hyrbil, transfer eller kollektivtrafik via Nerja ankomsten olika rytm.') },
    parking: { label: text('Leave the car and enter the village on foot', 'Parken an der Avenida Carlos Cano', 'Dejar el coche y entrar andando en el pueblo', 'Laat de auto staan en loop het dorp in', 'Lämna bilen och gå in i byn'), text: text('Public parking sits lower down. From there the paving, lanes and final walk mark the change from road to village.', 'Vor elf oder nach fünf ist fast immer Platz. Von dort fünf Minuten bergauf bis zu unserer grünen Haustür.', 'El aparcamiento público queda más abajo. Desde allí, el empedrado, las calles y el último tramo a pie marcan el paso de la carretera al pueblo.', 'Openbare parkeerplaatsen liggen lager. Vanaf daar vormen de keien, straatjes en laatste wandeling de overgang van weg naar dorp.', 'Allmän parkering ligger längre ner. Därifrån markerar stenläggningen, gränderna och den sista promenaden övergången från väg till by.') },
    stairs: { label: text('Find your own place in the village', 'Altstadt, neuer Ort oder Campo', 'Encontrar vuestro lugar en el pueblo', 'Vind jullie eigen plek in het dorp', 'Hitta er egen plats i byn'), text: text('The lower old centre, upper Barribarto, newer village and countryside each give ordinary days a different feeling.', 'Wo ihr wohnt, entscheidet, wie viele Stufen zwischen euch und dem Morgenkaffee liegen. Wir wohnen unten an der Hauptachse.', 'El casco histórico bajo, el Barribarto alto, la zona nueva y el campo dan un carácter distinto a los días cotidianos.', 'De lagere oude kern, het hogere Barribarto, het nieuwere dorp en het buitengebied geven gewone dagen elk een ander gevoel.', 'Den nedre gamla bykärnan, övre Barribarto, den nyare byn och landsbygden ger vardagen olika känsla.') },
    dailyLife: { label: text('Bread, groceries and an ordinary morning', 'Brot bei Manolo, Einkauf bei Silvia', 'Pan, compras y una mañana cualquiera', 'Brood, boodschappen en een gewone ochtend', 'Bröd, inköp och en vanlig morgon'), text: text('The bakery, groceries and useful services are the small places where a holiday starts to feel like village life.', 'Die Bäckerei liegt vier Minuten über die Calle Real, der Supermarkt ein paar Schritte rechts aus der Haustür. Für den Großeinkauf fahrt ihr nach Nerja.', 'La panadería, la compra y los servicios cotidianos son esos pequeños lugares donde las vacaciones empiezan a sentirse como vida de pueblo.', 'De bakker, boodschappen en praktische voorzieningen zijn de kleine plekken waar vakantie langzaam als dorpsleven gaat voelen.', 'Bageriet, matbutiken och vardagens service är de små platser där semestern börjar kännas som byliv.') },
