...
export const tarifaGeographyContent = {
  ...
  hero: {
    ...
    title: l("Where is Tarifa? Europe’s southernmost mainland city", "Wo liegt Tarifa? Die südlichste Stadt des europäischen Festlands", "¿Dónde está Tarifa? La ciudad más meridional de la Europa continental", "Waar ligt Tarifa? De zuidelijkste stad op het Europese vasteland", "Var ligger Tarifa? Europas sydligaste stad på fastlandet"),
