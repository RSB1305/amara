...
export const frigilianaFuenteViejaSeo: AmaraAuthoringSeo = {
  version: '2026-09-13-frigiliana-fuente-vieja-v3',
  pageType: 'B',
...
export const frigilianaFuenteViejaCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: l(
        'The Fuente Vieja stands on its own small plaza beside the Ermita de Ecce Homo, at the lower edge of the old town — only about sixty metres from Casa AMARA, though the cobbled lane drops some ten to fifteen metres in height on the way down. You follow Calle Chorruelo back down and, at the Bar El Alegría del Barrio, turn down to the left; the fountain is a few steps along on your left. The Barribajo around it runs flat and wide. It is a public square, open around the clock and free to visit, its three spouts still running — five minutes is enough for a photo and a look at the 17th-century coat of arms, and the same short, cobbled climb takes you back up toward San Antonio and El Ingenio. Restored in the 1990s, the stone still shows the wear of the centuries it served.',
        'Die Fuente Vieja steht auf ihrem eigenen kleinen Platz neben der Ermita de Ecce Homo, am unteren Rand der Altstadt — nur etwa sechzig Meter von Casa AMARA entfernt, wobei die gepflasterte Gasse auf dem Weg hinab rund zehn bis fünfzehn Höhenmeter verliert. Ihr folgt der Calle Chorruelo wieder hinunter und biegt an der Bar El Alegría del Barrio links hinab ab; ein paar Schritte weiter liegt der Brunnen auf der linken Seite. Das Barribajo ringsum ist flach und breit. Es ist ein öffentlicher Platz, rund um die Uhr und frei zugänglich, seine drei Ausläufe laufen noch — fünf Minuten genügen für ein Foto und einen Blick auf das Grafenwappen aus dem 17. Jahrhundert, und derselbe kurze, gepflasterte Anstieg führt euch wieder hinauf Richtung San Antonio und El Ingenio. In den 1990ern restauriert, zeigt der Stein noch die Spuren der Jahrhunderte, die er diente.',
        'La Fuente Vieja se alza en su propia plazoleta, junto a la Ermita del Ecce Homo, en el borde bajo del casco antiguo, a solo unos sesenta metros de Casa AMARA, aunque la calle empedrada baja unos diez a quince metros de desnivel. Seguís la calle Chorruelo cuesta abajo y, a la altura del Bar El Alegría del Barrio, giráis hacia abajo a la izquierda; unos pasos más allá, la fuente queda a mano izquierda. El Barribajo de alrededor es llano y ancho. Es una plaza pública, abierta a todas horas y de acceso libre, con sus tres caños aún manando: cinco minutos bastan para una foto y para mirar el escudo del siglo XVII, y la misma breve subida empedrada os devuelve hacia San Antonio y El Ingenio. Restaurada en los años 90, la piedra aún muestra el desgaste de los siglos que sirvió.',
        'De Fuente Vieja staat op haar eigen pleintje naast de Ermita de Ecce Homo, aan de lagere rand van de oude kern, op zo’n zestig meter van Casa AMARA, al daalt de gekasseide straat op de weg omlaag zo’n tien tot vijftien hoogtemeter. Je volgt de Calle Chorruelo weer omlaag en slaat bij Bar El Alegría del Barrio linksaf naar beneden; een paar passen verder ligt de bron aan je linkerhand. De Barribajo eromheen is vlak en breed. Het is een openbaar plein, dag en nacht en vrij toegankelijk, met de drie tuiten die nog lopen — vijf minuten volstaan voor een foto en een blik op het 17e-eeuwse wapen, en dezelfde korte, gekasseide klim voert je weer omhoog richting San Antonio en El Ingenio. In de jaren 90 gerestaureerd, toont de steen nog de slijtage van de eeuwen die ze diende.',
        'Fuente Vieja står på sitt eget lilla torg intill Ermita de Ecce Homo, vid gamla stans nedre kant, bara omkring sextio meter från Casa AMARA — även om den kullerstenslagda gränden faller ett tiotal till femton höjdmeter på vägen ner. Ni följer Calle Chorruelo neråt och svänger vid Bar El Alegría del Barrio ner till vänster; några steg längre fram ligger brunnen på vänster sida. Barribajo runt omkring är flackt och brett. Det är ett offentligt torg, öppet dygnet runt och fritt att besöka, med sina tre pipar som alltjämt rinner — fem minuter räcker för ett foto och en blick på 1600-talsvapnet, och samma korta, kullerstenslagda klättring tar er tillbaka upp mot San Antonio och El Ingenio. Restaurerad på 1990-talet visar stenen ännu slitaget av de århundraden den tjänade.'
      )
    }
  ],
  pullQuote: l(
