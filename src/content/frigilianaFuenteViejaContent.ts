...
export const frigilianaFuenteViejaCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: l(
        'The fountain stands on the small plaza that takes its name, off Calle Chorruelo beside the Ermita de Ecce Homo, at the lowest edge of the old town. It is a corner of an open public square, free to reach at any hour, with its three spouts still running. From the Calle Real lanes of the upper town where Casa AMARA sits it is a few minutes down over steep, cobbled streets, past San Antonio and El Ingenio — an easy walk going down and a short climb coming back. Pause at the chapel a step away and give the coat of arms a moment; restored in the 1990s, the stone still shows the wear of the centuries it served.',
        'Der Brunnen steht auf dem kleinen Platz, der seinen Namen trägt, an der Calle Chorruelo neben der Ermita de Ecce Homo, am untersten Rand der Altstadt. Er ist ein Winkel eines offenen öffentlichen Platzes, jederzeit frei zugänglich, und seine drei Ausläufe laufen noch. Von den Gassen um die Calle Real im oberen Ort, wo Casa AMARA liegt, sind es ein paar Minuten hinab über steile, gepflasterte Straßen, vorbei an San Antonio und El Ingenio — hinunter ein leichter Weg, zurück ein kurzer Anstieg. Haltet an der Kapelle nebenan und nehmt euch einen Moment für das Wappen; in den 1990ern restauriert, zeigt der Stein noch die Spuren der Jahrhunderte, die er diente.',
        'La fuente se alza en la pequeña plaza que lleva su nombre, en la calle Chorruelo, junto a la Ermita del Ecce Homo, en el borde más bajo del casco antiguo. Es un rincón de una plaza pública y abierta, de acceso libre a cualquier hora, y sus tres caños siguen manando. Desde las calles de la zona de la calle Real, en la parte alta donde está Casa AMARA, quedan unos minutos cuesta abajo por calles empedradas y empinadas, pasando junto a San Antonio y El Ingenio: bajada fácil y una breve subida a la vuelta. Deteneos en la capilla de al lado y dedicad un momento al escudo; restaurada en los años 90, la piedra aún muestra el desgaste de los siglos que sirvió.',
        'De bron staat op het pleintje dat haar naam draagt, aan de Calle Chorruelo naast de Ermita de Ecce Homo, aan de laagste rand van de oude kern. Het is een hoek van een open, openbaar plein, op elk uur vrij te bereiken, en de drie tuiten lopen nog. Vanuit de straatjes rond de Calle Real in het bovendorp, waar Casa AMARA ligt, is het een paar minuten omlaag over steile, gekasseide straten, langs San Antonio en El Ingenio — omlaag een makkelijke wandeling, terug een korte klim. Sta even stil bij de kapel ernaast en neem de tijd voor het wapen; in de jaren 90 gerestaureerd, toont de steen nog de slijtage van de eeuwen die ze diende.',
        'Brunnen står på det lilla torg som bär dess namn, vid Calle Chorruelo intill Ermita de Ecce Homo, vid gamla stans lägsta kant. Den är en vrå av ett öppet, offentligt torg, fritt att nå när som helst, och dess tre pipar rinner alltjämt. Från gränderna kring Calle Real i övre byn, där Casa AMARA ligger, är det några minuter nedför branta, kullerstenslagda gator, förbi San Antonio och El Ingenio — lätt väg ned och en kort klättring tillbaka. Stanna vid kapellet intill och ge vapenskölden en stund; restaurerad på 1990-talet visar stenen ännu slitaget av de århundraden den tjänade.'
      )
    }
  ],
  pullQuote: l(
