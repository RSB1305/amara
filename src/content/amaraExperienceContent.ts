...
const content = {
  ...
  accessIntro: text(
    "Here you’ll find information about your accommodation, local essentials and our personal recommendations. Enter the first name on the booking and the arrival and departure dates.",
    "Hier findet ihr Informationen zu eurer Unterkunft, Wichtigem vor Ort und unseren persönlichen Empfehlungen. Gebt den Vornamen der Buchung sowie An- und Abreisedatum ein.",
    "Aquí encontraréis información sobre el alojamiento, lo esencial del lugar y nuestras recomendaciones personales. Introducid el nombre de la reserva y las fechas de llegada y salida.",
    "Hier vinden jullie informatie over de accommodatie, praktische zaken ter plaatse en onze persoonlijke aanbevelingen. Vul de voornaam op de boeking en de aankomst- en vertrekdatum in.",
    "Här hittar ni information om boendet, praktiska saker på plats och våra personliga rekommendationer. Ange förnamnet i bokningen samt ankomst- och avresedatum.",
  ),
