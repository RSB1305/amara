...
const content = {
  ...
  accessInstructions: text(
    "All booked guests have access before and during their stay. Simply enter the first name on the booking and the arrival date.",
    "Alle gebuchten Gäste haben vor und während ihres Aufenthalts Zugang. Gebt einfach den Vornamen eurer Buchung und das Anreisedatum ein.",
    "Todos los huéspedes con reserva tienen acceso antes y durante su estancia. Introducid simplemente el nombre que figura en la reserva y la fecha de llegada.",
    "Alle geboekte gasten hebben voor en tijdens hun verblijf toegang. Vul eenvoudig de voornaam op de boeking en de aankomstdatum in.",
    "Alla bokade gäster har tillgång före och under vistelsen. Ange helt enkelt förnamnet i bokningen och ankomstdatumet.",
  ),
  ...
  datePickerTitle: text(
    ...
    "Euer Anreisedatum auswählen",
    "Elegid vuestra fecha de llegada",
    "Kies jullie aankomstdatum",
    "Välj ert ankomstdatum",
  ),
  datePickerHelp: text(
    "Choose the arrival date from your booking confirmation.",
    "Wählt das Anreisedatum aus eurer Buchungsbestätigung.",
    "Elegid la fecha de llegada de vuestra confirmación de reserva.",
    "Kies de aankomstdatum uit jullie boekingsbevestiging.",
    "Välj ankomstdatumet från er bokningsbekräftelse.",
  ),
