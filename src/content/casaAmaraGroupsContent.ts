...
export const casaAmaraGroupsContent = {
  hero: {
    ...
    qualifier: l("Designed for small groups who value privacy and quiet. **It is not a party house or an event venue.**", "Für vier bis acht Gäste, die zusammen reisen und trotzdem ihre Ruhe haben wollen.", "Pensado para grupos pequeños que valoran la privacidad y la tranquilidad. **No es una casa de fiestas ni un espacio para eventos.**", "Voor kleine groepen die privacy en rust waarderen. **Geen feesthuis en geen evenementenlocatie.**", "För små grupper som värdesätter avskildhet och lugn. **Inget partyhus och ingen evenemangslokal.**"),
  ...
  stays: {
    ...
    intro: l("All four stays are at Calle Chorruelo 5 in Frigiliana. Each has its own entrance and private bathroom; the three apartments have full kitchens, while Farah has a compact tea kitchen.", "Alle vier liegen in der Calle Chorruelo 5, hinter derselben grünen Haustür. Jede hat ihren eigenen Eingang und ihr eigenes Bad; Lounis, Zaid und Maha haben eine Küche, Farah eine Teeküche.", "Los cuatro alojamientos están en Calle Chorruelo 5, Frigiliana. Cada uno tiene entrada y baño privados; los tres apartamentos disponen de cocina completa y Farah, de una pequeña zona para té y café.", "Alle vier verblijven liggen aan Calle Chorruelo 5 in Frigiliana. Elk heeft een eigen ingang en privébadkamer; de drie appartementen hebben een volledige keuken en Farah een compacte pantry voor thee en koffie.", "Alla fyra boenden ligger på Calle Chorruelo 5 i Frigiliana. Varje boende har egen ingång och privat badrum; de tre lägenheterna har fullständiga kök och Farah ett kompakt tekök."),
    contexts: {
      farah: l("A compact suite for guests who prefer simple, easy access and do not need a full kitchen.", "Die kompakte Suite: eine Stufe an der Haustür, dann alles auf einer Ebene. Für die, die lieber essen gehen.", "Una suite compacta para quien prefiere sencillez, un acceso fácil y no necesita cocina completa.", "Een compacte suite voor gasten die eenvoud en gemakkelijke toegang waarderen en geen volledige keuken nodig hebben.", "En kompakt svit för gäster som uppskattar enkelhet och lätt tillträde och inte behöver ett fullständigt kök."),
      lounis: l("The largest interior space, with a generous private terrace and a full kitchen.", "Die größte Wohnung im Haus, mit 39 m² Terrasse, Küche und dem alten Brunnen.", "El mayor espacio interior de la casa, con una amplia terraza privada y cocina completa.", "De grootste binnenruimte van het huis, met een ruim privéterras en een volledige keuken.", "Husets största inomhusyta, med en rymlig privat terrass och ett fullständigt kök."),
      zaid: l("A private apartment and terrace that can be connected with Maha for a coordinated group stay.", "Das breiteste Bett im Haus und eine Terrasse, die sich mit Mahas verbinden lässt.", "Apartamento y terraza privados que pueden conectarse con Maha para una estancia de grupo coordinada.", "Een privéappartement met terras dat voor een groepsverblijf rechtstreeks met Maha kan worden verbonden.", "En privat lägenhet med terrass som kan kopplas direkt till Maha för en samordnad gruppvistelse."),
      maha: l("A bright apartment with a 64 m² terrace, outdoor kitchen and the largest place for the group to sit together.", "Ganz oben: 64 m² Terrasse mit Außenküche und Platz für alle acht am Abend.", "Un apartamento luminoso con 64 m² de terraza, cocina exterior y el mayor espacio para reuniros.", "Een licht appartement met 64 m² terras, buitenkeuken en de ruimste plek om samen te zitten.", "En ljus lägenhet med 64 m² terrass, utekök och den största platsen för gruppen att sitta tillsammans.")
    },
  ...
  connection: {
    ...
    title: l("Zaid and Maha can become one connected group zone", "Zaid und Maha: eine Tür, zwei Terrassen", "Zaid y Maha pueden formar una zona de grupo conectada", "Zaid en Maha kunnen één verbonden groepszone worden", "Zaid och Maha kan bli en sammanhängande gruppzon"),
    paragraphs: [
      l("Zaid and Maha are linked by an outdoor staircase with a small lockable door. It normally stays closed. When both apartments are booked for one group, we can open it so the apartments and their terraces connect directly.", "Eine Außentreppe mit einer kleinen Tür verbindet die beiden Terrassen. Sonst bleibt sie zu; wenn ihr beide Wohnungen habt, schließen wir sie auf, und ihr geht abends von einer Terrasse zur anderen.", "Zaid y Maha están unidos por una escalera exterior con una pequeña puerta que se puede cerrar. Normalmente permanece cerrada. Cuando ambos apartamentos se reservan para un mismo grupo, podemos abrirla para conectar directamente apartamentos y terrazas.", "Zaid en Maha zijn verbonden via een buitentrap met een kleine afsluitbare deur. Normaal blijft die dicht. Wanneer één groep beide appartementen boekt, kunnen we de deur openen zodat appartementen en terrassen rechtstreeks met elkaar verbonden zijn.", "Zaid och Maha länkas av en utomhustrappa med en liten låsbar dörr. Den är normalt stängd. När samma grupp bokar båda lägenheterna kan vi öppna den så att lägenheterna och terrasserna ansluter direkt till varandra."),
      l("Maha’s large terrace has seating for up to eight people. It is a place to talk, read and share an evening — but there is no dining table set up for eight and no shared indoor lounge.", "Auf Mahas Terrasse sitzen alle acht. Gegessen wird in kleinen Runden oder im Dorf: Einen Esstisch für acht gibt es im Haus nicht.", "La gran terraza de Maha tiene asientos para ocho personas. Es un lugar para charlar, leer y compartir la tarde, pero no hay una mesa de comedor preparada para ocho ni un salón interior común.", "Op het grote terras van Maha zijn zitplaatsen voor acht personen. Het is een plek om te praten, lezen en samen de avond door te brengen, maar er staat geen eettafel voor acht en er is geen gemeenschappelijke woonkamer binnen.", "På Mahas stora terrass finns sittplatser för åtta personer. Här kan ni prata, läsa och dela kvällen, men det finns inget matbord dukat för åtta och inget gemensamt vardagsrum inomhus.")
    ],
    facts: [
      {
        title: l("Together", "Gemeinsam", "Juntos", "Samen", "Tillsammans"),
        text: l("Same house, same address, connected Zaid–Maha terraces when booked as one group, and seating for eight on Maha’s terrace.", "Eine Haustür, verbundene Terrassen bei Zaid und Maha, Platz für acht bei Maha am Abend.", "La misma casa y dirección, terrazas Zaid–Maha conectadas para el grupo y asientos para ocho en la terraza de Maha.", "Hetzelfde huis en adres, verbonden terrassen van Zaid en Maha bij een groepsboeking en zitplaatsen voor acht op het terras van Maha.", "Samma hus och adress, sammanlänkade Zaid–Maha-terrasser vid gruppbokning och sittplatser för åtta på Mahas terrass.")
      },
      {
        title: l("Still private", "Trotzdem privat", "Con privacidad", "Toch privé", "Ändå privat"),
        text: l("Four separate stays, four private bathrooms, separate sleeping spaces and three full kitchens plus Farah’s tea kitchen.", "Vier Türen, vier Bäder, vier Schlafzimmer, drei Küchen und Farahs Teeküche.", "Cuatro alojamientos independientes, cuatro baños privados, dormitorios separados y tres cocinas completas más la pequeña zona de Farah.", "Vier zelfstandige verblijven, vier privébadkamers, aparte slaapruimtes en drie volledige keukens plus Farahs pantry.", "Fyra fristående boenden, fyra privata badrum, separata sovutrymmen och tre fullständiga kök plus Farahs tekök.")
      },
      {
        title: l("Exclusive at full-house level", "Das Haus für euch", "Exclusividad al reservar todo", "Exclusief bij volledige boeking", "Exklusivt vid full bokning"),
        text: l("When all four stays are reserved together, no other guests stay in Casa AMARA.", "Mit allen vier Wohnungen seid ihr die einzigen Gäste im Haus.", "Cuando se reservan juntos los cuatro alojamientos, no se alojan otros huéspedes en Casa AMARA.", "Wanneer alle vier verblijven samen zijn geboekt, verblijven er geen andere gasten in Casa AMARA.", "När alla fyra boenden bokas tillsammans bor inga andra gäster i Casa AMARA.")
      }
    ],
  },
  fit: {
    ...
    works: [
      ...
      l("Adult families and multigenerational trips", "Familien mit erwachsenen Kindern, auch über drei Generationen", "Familias adultas y viajes multigeneracionales", "Volwassen families en reizen met meerdere generaties", "Vuxna familjer och generationsresor"),
      l("Quiet groups of friends", "Freunde, die abends auf der Terrasse sitzen", "Grupos tranquilos de amigos", "Rustige vriendengroepen", "Lugna kompisgäng"),
      l("Wedding guests sleeping near San Antonio church", "Hochzeitsgäste, 15 Meter von San Antonio", "Invitados de boda cerca de la iglesia de San Antonio", "Bruiloftsgasten vlak bij de San Antonio-kerk", "Bröllopsgäster nära San Antonio-kyrkan")
    ],
    limitsTitle: l("Important to know", "Gut zu wissen", "Importante saberlo", "Goed om te weten", "Viktigt att veta"),
    limits: [
      l("No pool and no shared indoor living room", "Terrassen statt Pool, Mahas Terrasse statt Wohnzimmer für alle", "Sin piscina ni salón interior común", "Geen zwembad en geen gezamenlijke woonkamer binnen", "Ingen pool och inget gemensamt vardagsrum inomhus"),
      l("No dining setup for eight people", "Gegessen wird in kleinen Runden oder im Dorf", "Sin comedor preparado para ocho personas", "Geen eetopstelling voor acht personen", "Ingen gemensam matplats för åtta personer"),
      l("No parties, events or unregistered gatherings", "Ein ruhiges Haus mitten in der Altstadt, gedacht zum Wohnen", "Sin fiestas, eventos ni reuniones con personas no alojadas", "Geen feesten, evenementen of bijeenkomsten met niet-geregistreerde gasten", "Inga fester, evenemang eller sammankomster med oregistrerade gäster"),
      l("Steps and stairs differ by stay", "Eine Stufe an der Haustür; Farah danach eben, die anderen drei mit Stufen", "Los escalones y escaleras varían según el alojamiento", "Treden en trappen verschillen per verblijf", "Trappsteg och trappor skiljer sig mellan boendena")
    ],
    note: l("This is not an eight-person villa behind one front door. It is a small house of four independent stays that can be coordinated for one group.", "Vier Wohnungen in einem Haus, für eine Gruppe zusammengelegt.", "No es una villa para ocho personas tras una sola puerta, sino una pequeña casa con cuatro alojamientos independientes que pueden coordinarse para un grupo.", "Dit is geen villa voor acht personen achter één voordeur. Het is een klein huis met vier zelfstandige verblijven die voor één groep kunnen worden gecoördineerd.", "Det här är inte en villa för åtta personer bakom en gemensam ytterdörr, utan ett litet hus med fyra fristående boenden som kan samordnas för en grupp."),
  },
  location: {
    ...
    links: [
      {
        ...
        text: l("Compare airport, bus, taxi and car options.", "Eine Stunde ab Málaga, mit dem Bus über Nerja.", "Comparad aeropuerto, autobús, taxi y coche.", "Vergelijk luchthaven, bus, taxi en auto.", "Jämför flygplats, buss, taxi och bil.")
      },
      {
        ...
        text: l("Know where to leave the car before arrival.", "Avenida Carlos Cano, vor elf oder nach fünf.", "Sabed dónde dejar el coche antes de llegar.", "Weet vóór aankomst waar de auto kan staan.", "Ta reda på var bilen kan stå före ankomst.")
      },
      {
        ...
        text: l("Understand the terrain and access before choosing rooms.", "Warum unsere Lage unten an der Hauptachse zählt.", "Entended el terreno y los accesos antes de elegir habitaciones.", "Begrijp terrein en toegang voordat jullie kamers kiezen.", "Förstå terräng och tillträde innan ni väljer rum.")
      },
      {
        ...
        text: l("See what the old-town location feels like day to day.", "Brot bei Manolo, Einkauf bei Silvia, abends zu Fuß essen.", "Descubrid cómo es el día a día en el casco antiguo.", "Ontdek hoe de oude-kernlocatie dagelijks aanvoelt.", "Se hur läget i gamla stan fungerar till vardags.")
      }
    ]
  },
  booking: {
    ...
    title: l("One enquiry, coordinated by us", "Eine Nachricht, wir legen zusammen", "Una consulta coordinada por nosotros", "Eén aanvraag, door ons gecoördineerd", "En förfrågan, samordnad av oss"),
    paragraphs: [
      l("Our current booking system cannot place several AMARA stays into one online checkout. Combined stays are therefore arranged directly with us by enquiry.", "Mehrere Wohnungen auf einmal bucht ihr bei uns per Nachricht; der Online-Kalender kann immer nur eine.", "Nuestro sistema actual no permite añadir varios alojamientos AMARA a un único proceso de reserva online. Por eso coordinamos directamente las estancias combinadas mediante consulta.", "Ons huidige boekingssysteem kan meerdere AMARA-verblijven nog niet in één online checkout plaatsen. Daarom regelen we gecombineerde verblijven rechtstreeks via een aanvraag.", "Vårt nuvarande bokningssystem kan ännu inte lägga flera AMARA-boenden i samma onlinekassa. Kombinerade vistelser ordnas därför direkt med oss genom en förfrågan."),
      l("Tell us your dates, total guest count and preferred setup. We will check which stays are available together and reply with the suitable combination and next booking steps.", "Schickt uns eure Daten, wie viele ihr seid und wer mit wem wohnt. Wir antworten mit den freien Wohnungen und wie ihr sie bucht.", "Indicadnos fechas, número total de huéspedes y distribución preferida. Comprobaremos qué alojamientos están disponibles a la vez y responderemos con la combinación adecuada y los pasos para reservar.", "Stuur ons jullie data, het totale aantal gasten en de gewenste indeling. Wij bekijken welke verblijven tegelijk beschikbaar zijn en antwoorden met de passende combinatie en vervolgstappen.", "Ange datum, totalt antal gäster och önskad fördelning. Vi kontrollerar vilka boenden som är lediga samtidigt och svarar med lämplig kombination och nästa bokningssteg.")
    ],
    steps: [
      {
        num: l("01", "01", "01", "01", "01"),
        headline: l("Send your dates", "Reisedaten senden", "Enviad las fechas", "Stuur jullie data", "Skicka era datum"),
        text: l("Include arrival, departure and the number of registered overnight guests.", "Anreise, Abreise und wie viele ihr seid.", "Incluid llegada, salida y número de huéspedes que se alojarán.", "Vermeld aankomst, vertrek en het aantal geregistreerde verblijfsgasten.", "Ange ankomst, avresa och antal registrerade övernattande gäster.")
      },
      {
        num: l("02", "02", "02", "02", "02"),
        headline: l("We check the combination", "Wir schauen in den Kalender", "Comprobamos la combinación", "Wij bekijken de combinatie", "Vi kontrollerar kombinationen"),
        text: l("We match two, three or four available stays to your group.", "Zwei, drei oder vier Wohnungen für dieselben Nächte.", "Ajustamos dos, tres o cuatro alojamientos disponibles a vuestro grupo.", "We stemmen twee, drie of vier beschikbare verblijven af op jullie groep.", "Vi matchar två, tre eller fyra lediga boenden med gruppen.")
      },
      {
        num: l("03", "03", "03", "03", "03"),
        headline: l("Receive a coordinated offer", "Ihr bekommt die Aufteilung", "Recibid una propuesta coordinada", "Ontvang een gecoördineerd voorstel", "Få ett samordnat förslag"),
        text: l("We confirm the setup, availability and how to complete the reservations.", "Wer wo wohnt, was es kostet und wie ihr bucht.", "Confirmamos distribución, disponibilidad y cómo completar las reservas.", "We bevestigen indeling, beschikbaarheid en hoe de reserveringen worden afgerond.", "Vi bekräftar fördelning, tillgänglighet och hur bokningarna slutförs.")
      }
    ],
  ...
  faq: {
    title: l("Questions before you enquire", "Was Gruppen uns fragen", "Preguntas antes de consultar", "Vragen vóór jullie aanvraag", "Frågor före förfrågan"),
    items: [
      {
        ...
        answer: l("Yes. Farah, Lounis, Zaid and Maha each accommodate up to two guests, giving a total capacity of eight registered overnight guests.", "Ja, in vier Wohnungen für je zwei. Acht ist das Maximum im Haus.", "Sí. Farah, Lounis, Zaid y Maha admiten hasta dos huéspedes cada uno: ocho huéspedes alojados en total.", "Ja. Farah, Lounis, Zaid en Maha bieden elk plaats aan maximaal twee gasten: in totaal acht geregistreerde verblijfsgasten.", "Ja. Farah, Lounis, Zaid och Maha rymmer högst två gäster vardera, sammanlagt åtta registrerade övernattande gäster.")
      },
      {
        ...
        answer: l("Yes, if all four stays are reserved together. That combination guarantees exclusive use of Casa AMARA for your group.", "Ja, wenn ihr alle vier Wohnungen nehmt. Dann wohnt außer euch niemand im Haus.", "Sí, si reserváis juntos los cuatro alojamientos. Esa combinación garantiza el uso exclusivo de Casa AMARA para vuestro grupo.", "Ja, wanneer alle vier verblijven samen zijn gereserveerd. Die combinatie garandeert exclusief gebruik van Casa AMARA door jullie groep.", "Ja, om alla fyra boenden bokas tillsammans. Den kombinationen garanterar exklusiv användning av Casa AMARA för er grupp.")
      },
      {
      ...
      },
      {
        ...
        answer: l("There is seating for eight on Maha’s terrace, but no dining table set up for eight and no shared indoor dining room.", "Auf Mahas Terrasse sitzen alle acht zusammen, an einem Tisch für acht nicht. Für das gemeinsame Abendessen liegen die Restaurants der Calle Real vor der Tür.", "Hay asientos para ocho en la terraza de Maha, pero no una mesa de comedor preparada para ocho ni un comedor interior común.", "Op Maha’s terras zijn zitplaatsen voor acht, maar er is geen eettafel voor acht en geen gezamenlijke eetruimte binnen.", "Det finns sittplatser för åtta på Mahas terrass, men inget matbord för åtta och ingen gemensam matsal inomhus.")
      },
      {
        ...
        answer: l("Lounis, Zaid and Maha have full kitchens. Farah has a compact tea kitchen with a refrigerator, not a full kitchen.", "Lounis, Zaid und Maha ja. Farah hat eine Teeküche mit Kühlschrank, Kaffeemaschine und Wasserkocher.", "Lounis, Zaid y Maha tienen cocina completa. Farah dispone de una pequeña zona con frigorífico para té y café, no de una cocina completa.", "Lounis, Zaid en Maha hebben een volledige keuken. Farah heeft een compacte pantry met koelkast voor thee en koffie, geen volledige keuken.", "Lounis, Zaid och Maha har fullständiga kök. Farah har ett kompakt tekök med kylskåp, inte ett fullständigt kök.")
      },
      {
        ...
        answer: l("Not yet. Availability across several stays is checked and coordinated manually, so please send us an enquiry.", "Mehrere Wohnungen auf einmal gehen per Nachricht an uns; der Kalender bucht immer nur eine. Wir antworten meist innerhalb einer Stunde.", "Todavía no. Comprobamos y coordinamos manualmente la disponibilidad de varios alojamientos; enviadnos una consulta.", "Nog niet. De gezamenlijke beschikbaarheid van meerdere verblijven wordt handmatig gecontroleerd en gecoördineerd; stuur ons een aanvraag.", "Inte ännu. Gemensam tillgänglighet för flera boenden kontrolleras och samordnas manuellt, så skicka en förfrågan.")
      },
      {
  ...
  closing: {
    ...
    text: l("Share your dates and group size. We will tell you honestly which combination works — and whether Casa AMARA is the right fit.", "Schickt uns eure Daten und wie viele ihr seid. Wir sagen euch, welche Wohnungen frei sind und wer wo am besten wohnt.", "Compartid fechas y tamaño del grupo. Os diremos con claridad qué combinación funciona y si Casa AMARA encaja con vuestro viaje.", "Deel jullie data en groepsgrootte. We vertellen eerlijk welke combinatie werkt en of Casa AMARA bij jullie reis past.", "Skicka era datum och gruppstorlek. Vi svarar ärligt på vilken kombination som fungerar och om Casa AMARA passar er resa."),
