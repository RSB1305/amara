...
export const nerjaBalconContent = {
  ...
  hero: {
    ...
    note: l("From AMARA Playa it is a five-minute walk.", "Von AMARA Playa sind es fünf Minuten zu Fuß.", "Desde AMARA Playa son cinco minutos a pie.", "Vanaf AMARA Playa is het vijf minuten lopen.", "Från AMARA Playa är det fem minuters promenad."),
