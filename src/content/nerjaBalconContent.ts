...
export const nerjaBalconContent = {
  ...
  hero: {
    ...
    note: l("A guide written by your hosts. Events and street life change; treat this as orientation rather than a programme.", "Von AMARA Playa sind es fünf Minuten zu Fuß.", "Una guía escrita por vuestros anfitriones. Los eventos y la vida en la calle cambian; tomadlo como orientación, no como programa.", "Een gids geschreven door jullie gastheren. Evenementen en straatleven wisselen; zie dit als oriëntatie, niet als programma.", "En guide skriven av era värdar. Evenemang och gatuliv växlar; se detta som orientering, inte som program."),
    updated: l("Last checked in August 2026", "Stand August 2026", "Revisado por última vez en agosto de 2026", "Laatst gecontroleerd in augustus 2026", "Senast kontrollerad i augusti 2026")
  },
  facts: [
    {
