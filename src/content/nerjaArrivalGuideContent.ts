...
export const nerjaArrivalGuideBusRoutes = {
  ...
  de: [{ id: 'walk', title: 'Vom Busbahnhof laufen', meta: 'Ca. 15 Minuten · 1 km', text: 'Mit gut handhabbarem Gepäck eine praktische Möglichkeit. Prüft vor der Abfahrt den aktuellen Fußweg.' }, { id: 'taxi', title: 'Kurze Fahrt mit dem lokalen Taxi', meta: 'Am besten mit mehreren Koffern', text: 'Zeigt die vollständige Adresse Calle Castilla Pérez 60, damit die Fahrt am Apartment-Eingang endet.' }],
