...
const hero = {
  ...
  standfirst: l(
    'If you are staying overnight in Frigiliana, parking is usually straightforward. Most of the pressure comes from day visitors, who arrive from late morning and leave again during the afternoon. Overnight guests use the village at different times: you are often already parked before the busy period or return after it eases. There is a paid car park below Plaza de las Tres Culturas and permitted spaces along the approach roads. Spaces cannot be reserved, so we cannot guarantee one at a particular minute. With a suitable arrival time, however, parking is normally not the problem it may first appear to be.',
    'Wenn ihr in Frigiliana übernachtet, ist das Parken normalerweise unkompliziert. Der größte Andrang entsteht durch Tagesgäste, die am späten Vormittag kommen und am frühen Nachmittag wieder fahren. Als Übernachtungsgäste nutzt ihr das Dorf zu anderen Zeiten: Oft steht euer Auto schon vor dem Andrang oder ihr kommt zurück, wenn es ruhiger wird. Unterhalb der Plaza de las Tres Culturas gibt es einen kostenpflichtigen Parkplatz, dazu erlaubte Stellplätze an den Zufahrtsstraßen. Reservieren lässt sich davon nichts; einen bestimmten Platz zu einer bestimmten Minute können wir deshalb nicht versprechen. Mit einer passenden Ankunftszeit ist Parken aber in der Regel viel einfacher, als es bei der Reiseplanung zunächst scheint.',
    'Si os alojáis en Frigiliana, aparcar suele ser sencillo. La mayor afluencia viene de los visitantes de día, que llegan a última hora de la mañana y se marchan a primera hora de la tarde. Quienes pasan la noche usan el pueblo en otros momentos: a menudo el coche ya está aparcado antes de las horas de más movimiento o volvéis cuando la presión disminuye. Debajo de la Plaza de las Tres Culturas hay un aparcamiento de pago y también plazas permitidas en las vías de acceso. No se pueden reservar, así que no podemos garantizar una plaza en un minuto concreto. Con una hora de llegada adecuada, aparcar suele ser mucho más fácil de lo que parece al planificar el viaje.',
    'Als jullie in Frigiliana overnachten, is parkeren meestal eenvoudig. De grootste drukte komt van dagbezoekers, die laat in de ochtend aankomen en vroeg in de middag weer vertrekken. Overnachtende gasten gebruiken het dorp op andere momenten: vaak staat de auto al vóór de drukte geparkeerd of komen jullie terug wanneer het rustiger wordt. Onder de Plaza de las Tres Culturas ligt een betaalde parkeerplaats en langs de toegangswegen zijn toegestane plekken. Reserveren kan niet, dus we kunnen geen plek op een bepaald tijdstip garanderen. Met een passende aankomsttijd is parkeren doorgaans veel makkelijker dan het tijdens de reisplanning misschien lijkt.',
    'Om ni övernattar i Frigiliana är det oftast enkelt att parkera. Det största trycket kommer från dagsbesökare, som anländer sent på förmiddagen och lämnar igen tidigt på eftermiddagen. Övernattande gäster använder byn vid andra tider: bilen står ofta redan parkerad före rusningen eller så kommer ni tillbaka när det har lugnat sig. Nedanför Plaza de las Tres Culturas finns en avgiftsbelagd parkering och tillåtna platser längs infartsvägarna. Platserna kan inte bokas, så vi kan inte garantera en viss plats vid en viss tidpunkt. Med en lämplig ankomsttid är parkeringen ändå betydligt enklare än den först kan verka när ni planerar resan.'
  ),
  note: l(
