...
const article = { datePublished: '2026-08-20', dateModified: '2026-08-31', authorName: 'Robert Sebastian Böhmer', authorType: 'Person' as const, authorSlug: 'staying-with-us' };
...
const hero = {
  ...
  standfirst: l(
    'When you search for parking in Frigiliana, the subject can look like a bigger problem than it is for overnight guests. Most of the visible pressure comes from day visitors, who arrive from late morning and leave again during the afternoon. If you stay in the village, your car is often already parked before the busy period or you return after it eases. For overnight guests, parking is therefore usually not a problem. There is a paid car park below Plaza de las Tres Culturas and permitted spaces along the approach roads. Spaces cannot be reserved, so we cannot guarantee a particular one at a particular minute, but choosing a suitable arrival time normally makes parking straightforward.',
    'Wenn ihr nach Parken in Frigiliana sucht, wirkt das Thema schnell größer, als es für Übernachtungsgäste ist. Der sichtbare Parkdruck entsteht vor allem durch Tagesgäste, die am späten Vormittag kommen und am frühen Nachmittag wieder fahren. Wenn ihr im Dorf übernachtet, steht euer Auto oft schon vor dem Andrang oder ihr kommt zurück, wenn es ruhiger wird. Für Übernachtungsgäste ist Parken deshalb normalerweise kein Problem. Unterhalb der Plaza de las Tres Culturas gibt es einen kostenpflichtigen Parkplatz, dazu erlaubte Stellplätze an den Zufahrtsstraßen. Reservieren lässt sich davon nichts; einen bestimmten Platz zu einer bestimmten Minute können wir nicht versprechen. Mit einer passenden Ankunftszeit ist das Parken aber in der Regel unkompliziert.',
    'Al buscar dónde aparcar en Frigiliana, el tema puede parecer un problema mayor de lo que realmente es para quienes pasan la noche. La presión visible procede sobre todo de los visitantes de día, que llegan a última hora de la mañana y se marchan a primera hora de la tarde. Si os alojáis en el pueblo, el coche suele estar aparcado antes de las horas de más movimiento o volvéis cuando ya hay menos gente. Para los huéspedes que pernoctan, aparcar normalmente no supone un problema. Debajo de la Plaza de las Tres Culturas hay un aparcamiento de pago y plazas permitidas en las vías de acceso. No se pueden reservar, pero elegir bien la hora de llegada suele hacer que aparcar sea sencillo.',
    'Als jullie zoeken naar parkeren in Frigiliana, lijkt het onderwerp al snel een groter probleem dan het voor overnachtende gasten is. De zichtbare parkeerdruk komt vooral van dagbezoekers, die laat in de ochtend aankomen en vroeg in de middag weer vertrekken. Als jullie in het dorp verblijven, staat de auto vaak al vóór de drukte geparkeerd of komen jullie terug wanneer het rustiger is. Voor overnachtende gasten is parkeren daarom meestal geen probleem. Onder de Plaza de las Tres Culturas ligt een betaalde parkeerplaats en langs de toegangswegen zijn toegestane plekken. Reserveren kan niet, maar met een passende aankomsttijd is parkeren doorgaans eenvoudig.',
    'När ni söker efter parkering i Frigiliana kan ämnet verka som ett större problem än det är för övernattande gäster. Det synliga parkeringstrycket kommer framför allt från dagsbesökare, som anländer sent på förmiddagen och lämnar tidigt på eftermiddagen. Om ni bor i byn står bilen ofta redan parkerad före rusningen eller så kommer ni tillbaka när det har lugnat sig. För övernattande gäster är parkeringen därför oftast inget problem. Nedanför Plaza de las Tres Culturas finns en avgiftsbelagd parkering och tillåtna platser längs infartsvägarna. Platserna kan inte bokas, men med en lämplig ankomsttid är det vanligtvis enkelt att parkera.'
  ),
  note: l(
...
const makeLocale = (lang: AmaraLanguage): ParkingGuideLocale => ({
  ...
  hero: { eyebrow: hero.eyebrow[lang], title: hero.title[lang], subtitle: hero.subtitle[lang], standfirst: hero.standfirst[lang], note: hero.note[lang], updated: hero.updated[lang] },
