...
export const tarifaWeatherWarningsCopy: TarifaWeatherWarningsCopy = {
  ...
  unavailableText: l('We do not replace it with an assumption. Check the warnings directly with AEMET before you go out.', 'Fehlt der Wert, bleibt das Feld leer; die Warnungen stehen direkt bei AEMET.', 'No lo sustituimos por una suposición. Comprobad los avisos directamente en AEMET antes de salir.', 'We vervangen hem niet door een aanname. Controleer de waarschuwingen rechtstreeks bij AEMET voordat jullie het water op gaan.', 'Vi ersätter den inte med ett antagande. Kontrollera varningarna direkt hos AEMET innan ni går ut.'),
