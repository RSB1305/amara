...
> = {
  ...
  sv: {
    ...
    history: {
      eyebrow: '800 år / Alhambra',
      title: 'Sov i ett av byns äldsta hus',
      text:
        'Frigilianas gamla stad räknas som ett av de bäst bevarade morisk-mudéjarpräglade kvarteren i provinsen Málaga, skapat av samma kultur som byggde Alhambra i Granada. Under århundraden växte husen organiskt uppför sluttningen: smala gränder med trappor, rum utan räta vinklar och bostäder som byggdes ut, såldes och förändrades över tid. När vi varsamt restaurerade AMARA Lounis 2022 och blottlade de gamla murarna blev vår arkitekt tydligt imponerad. Han kände igen samma byggmetod som i Alhambra, samma moriska signatur som formade kvarteret för flera hundra år sedan. Att sova i ett hus med sådana rötter känns annorlunda än på vilket kusthotell som helst. Det kan Nerja, trots all sin livlighet, inte erbjuda.'
    },
    comparison: {
