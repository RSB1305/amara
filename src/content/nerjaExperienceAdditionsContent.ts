...
export const nerjaBeachesPageContent: Record<AmaraLanguage, NerjaExperienceAdditionCopy> = {
  ...
  de: {
    ...
    hero: { kicker: 'Nerja · Strände', title: 'Strände in Nerja', subtitle: 'Wählt den Strand passend zum Tag – nicht nach einer Rangliste', paragraphs: ['In Nerja liegen kleine Stadtbuchten, ein voll ausgestatteter Strand und die geschützte Küste Richtung Maro nah beieinander.', 'Entscheidend sind Zugang, Schatten, Ausstattung, Platz und der aktuelle Zustand des Meeres. Dieser Guide vergleicht sie ehrlich, bevor ihr alles die Treppen hinuntertragt.'], imageAlt: 'Palmen und Mittelmeerküste in Nerja' },
  ...
  sv: {
    ...
    hero: { kicker: 'Nerja · Stränder', title: 'Stränder i Nerja', subtitle: 'Välj stranden som passar dagen, inte topplistan', paragraphs: ['Nerja samlar små stadsvikar, en strand med full service och den skyddade kusten mot Maro inom ett kompakt område.', 'Tillgång, skugga, service, utrymme och havets tillstånd avgör. Guiden jämför alternativen ärligt innan ni bär allt nedför trapporna.'], imageAlt: 'Palmer och Medelhavskust i Nerja' },
...
export const nerjaFoodPageContent: Record<AmaraLanguage, NerjaExperienceAdditionCopy> = {
  en: {
    ...
    hero: { kicker: 'Nerja · Food', title: 'Food in Nerja', subtitle: 'Choose the meal before you choose the restaurant', paragraphs: ['Nerja’s range runs from noisy seafood bars and a paella lunch by Burriana to contemporary dining for an evening that deserves a reservation.', 'Our public shortlist distils the much larger AMARA Guest Guide into the choices that help most before a stay: what kind of meal, which part of town and how much planning it needs.'], imageAlt: 'Nerja centre and the Mediterranean coast, home to seafood bars, tapas and special dinners', summary: { eyebrow: 'On this page', body: 'Where to eat in Nerja, from noisy seafood bars and a Burriana paella lunch to a contemporary dinner worth a reservation. A curated pick, not a ranking — check opening days first.', items: [ { id: 'tapas', label: 'Tapas & fish', value: 'Lively bars, fresh seafood' }, { id: 'dinner', label: 'Special dinner', value: 'Modern kitchens, sea-view tables' }, { id: 'burriana', label: 'Burriana', value: 'Paella lunch by the beach' }, { id: 'reviewed', label: 'Reviewed', value: 'August 2026' } ] } },
  ...
  de: {
    ...
    hero: { kicker: 'Nerja · Essen', title: 'Essen in Nerja', subtitle: 'Wählt zuerst das Essen – und danach das Restaurant', paragraphs: ['Nerjas Auswahl reicht von lebhaften Seafood-Bars und Paella-Lunch am Burriana-Strand bis zum modernen Dinner für einen Abend mit Reservierung.', 'Unsere öffentliche Auswahl verdichtet den deutlich größeren AMARA Guest Guide auf die Fragen vor dem Aufenthalt: Welche Art Mahlzeit, welcher Teil Nerjas und wie viel Planung?'], imageAlt: 'Nerjas Zentrum und Mittelmeerküste mit Seafood-Bars, Tapas und besonderen Restaurants', summary: { eyebrow: 'Auf dieser Seite', body: 'Wo man in Nerja gut isst — von lebhaften Seafood-Bars und Paella-Lunch am Burriana-Strand bis zum modernen Dinner mit Reservierung. Kuratierte Auswahl, keine Rangliste; Öffnungszeiten vorab prüfen.', items: [ { id: 'tapas', label: 'Tapas & Fisch', value: 'Lebhafte Bars, frischer Fisch' }, { id: 'dinner', label: 'Besonderes Dinner', value: 'Moderne Küche, Tische mit Meerblick' }, { id: 'burriana', label: 'Burriana', value: 'Paella mittags am Strand' }, { id: 'reviewed', label: 'Stand', value: 'August 2026' } ] } },
  ...
  es: {
    ...
    hero: { kicker: 'Nerja · Gastronomía', title: 'Comer en Nerja', subtitle: 'Elegid primero la comida y después el restaurante', paragraphs: ['La oferta de Nerja va desde bares animados de pescado y una paella a mediodía en Burriana hasta cocina contemporánea para una noche que merece reserva.', 'Nuestra selección pública resume la guía de huéspedes de AMARA, mucho más amplia, en las decisiones útiles antes del viaje: tipo de comida, zona y planificación.'], imageAlt: 'Centro de Nerja y costa mediterránea con bares de pescado, tapas y restaurantes especiales', summary: { eyebrow: 'En esta página', body: 'Dónde comer en Nerja, desde bares de pescado animados y una paella a mediodía en Burriana hasta una cena contemporánea que merece reserva. Una selección, no un ranking; confirmad los horarios.', items: [ { id: 'tapas', label: 'Tapas y pescado', value: 'Bares animados, pescado fresco' }, { id: 'dinner', label: 'Cena especial', value: 'Cocina moderna, mesas con vistas al mar' }, { id: 'burriana', label: 'Burriana', value: 'Paella a mediodía en la playa' }, { id: 'reviewed', label: 'Revisado', value: 'Agosto 2026' } ] } },
  ...
  nl: {
    ...
    hero: { kicker: 'Nerja · Eten', title: 'Eten in Nerja', subtitle: 'Kies eerst de maaltijd en daarna het restaurant', paragraphs: ['Nerja loopt uiteen van levendige visbars en paellalunch bij Burriana tot eigentijds dineren voor een avond die een reservering verdient.', 'Onze openbare selectie brengt de veel uitgebreidere AMARA Guest Guide terug tot de nuttigste keuzes vóór een verblijf: soort maaltijd, wijk en benodigde planning.'], imageAlt: 'Het centrum en de Middellandse Zeekust van Nerja met visbars, tapas en bijzondere restaurants', summary: { eyebrow: 'Op deze pagina', body: 'Waar je in Nerja eet, van levendige visbars en een paellalunch bij Burriana tot een eigentijds diner dat een reservering verdient. Een selectie, geen ranglijst; controleer openingstijden vooraf.', items: [ { id: 'tapas', label: 'Tapas & vis', value: 'Levendige bars, verse vis' }, { id: 'dinner', label: 'Bijzonder diner', value: 'Moderne keukens, tafels met zeezicht' }, { id: 'burriana', label: 'Burriana', value: 'Paellalunch aan het strand' }, { id: 'reviewed', label: 'Bijgewerkt', value: 'Augustus 2026' } ] } },
