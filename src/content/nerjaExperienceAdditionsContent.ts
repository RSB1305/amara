...
export const nerjaFoodPageContent: Record<AmaraLanguage, NerjaExperienceAdditionCopy> = {
  ...
  es: {
    ...
    hero: { kicker: 'Nerja · Gastronomía', title: 'Elegid primero la comida y después el restaurante', paragraphs: ['La oferta de Nerja va desde bares animados de pescado y una paella a mediodía en Burriana hasta cocina contemporánea para una noche que merece reserva.', 'Nuestra selección pública resume la guía de huéspedes de AMARA, mucho más amplia, en las decisiones útiles antes del viaje: tipo de comida, zona y planificación.'], imageAlt: 'Centro de Nerja y costa mediterránea con bares de pescado, tapas y restaurantes especiales', summary: { eyebrow: 'En esta página', body: 'Dónde comer en Nerja, desde bares de pescado animados y una paella a mediodía en Burriana hasta una cena contemporánea que merece reserva. Una selección, no un ranking; confirmad los horarios.', items: [ { label: 'Tapas y pescado', value: 'Bares animados, pescado fresco' }, { label: 'Cena especial', value: 'Cocina moderna, mesas con vistas al mar' }, { label: 'Burriana', value: 'Paella a mediodía en la playa' }, { label: 'Revisado', value: 'Agosto 2026' } ] } },
