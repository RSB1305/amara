...
export const nerjaBeachesPageContent: Record<AmaraLanguage, NerjaExperienceAdditionCopy> = {
  en: {
    ...
    closing: { title: 'Stay close enough to let the sea decide the morning.', lead: 'AMARA Playa is 100 metres from Torrecilla beach, with the rest of Nerja’s coast ready for a different kind of day.', propertyLabel: 'View AMARA Playa', hubLabel: 'All Nerja experiences' }
  },
  de: {
    ...
    closing: { title: 'Wohnt nah genug, damit das Meer den Morgen bestimmen darf.', lead: 'AMARA Playa liegt 100 Meter vom Torrecilla-Strand entfernt; für einen anderen Strandtag bleibt Nerjas übrige Küste offen.', propertyLabel: 'AMARA Playa ansehen', hubLabel: 'Alle Nerja-Erlebnisse' }
  },
  es: {
    ...
    closing: { title: 'Alojaos lo bastante cerca para que el mar decida la mañana.', lead: 'AMARA Playa está a 100 metros de Torrecilla y el resto de la costa de Nerja ofrece un día de playa diferente.', propertyLabel: 'Ver AMARA Playa', hubLabel: 'Todas las experiencias de Nerja' }
  },
  nl: {
    ...
    closing: { title: 'Verblijf dichtbij genoeg om de zee de ochtend te laten bepalen.', lead: 'AMARA Playa ligt 100 meter van het Torrecilla-strand; de rest van Nerja’s kust biedt telkens een ander soort dag.', propertyLabel: 'Bekijk AMARA Playa', hubLabel: 'Alle ervaringen in Nerja' }
  },
  sv: {
    ...
    closing: { title: 'Bo nära nog för att låta havet bestämma morgonen.', lead: 'AMARA Playa ligger 100 meter från Torrecilla-stranden och resten av Nerjas kust väntar när ni vill ha en annan dag.', propertyLabel: 'Se AMARA Playa', hubLabel: 'Alla upplevelser i Nerja' }
  }
};
