...
export const lastMinuteStaysCopy = {
  ...
  destinations: [
    ...
    },
    {
      ...
      body: l('Family & Surf: 75 m² over two floors, a west-facing balcony over the Atlantic, underground garage and the beach on foot. When the wind is up, you see it from the balcony.', 'Family & Surf: 75 m² auf zwei Etagen, Balkon nach Westen über den Atlantik, Tiefgarage und der Strand zu Fuß. Wenn der Wind steht, seht ihr es vom Balkon.', 'Family & Surf: 75 m² en dos plantas, balcón al oeste sobre el Atlántico, garaje subterráneo y la playa a pie. Cuando hay viento, lo veis desde el balcón.', 'Family & Surf: 75 m² over twee verdiepingen, balkon op het westen boven de Atlantische Oceaan, ondergrondse garage en het strand te voet. Als de wind staat, zien jullie het vanaf het balkon.', 'Family & Surf: 75 m² på två plan, balkong mot väster över Atlanten, garage under huset och stranden till fots. När vinden ligger på ser ni det från balkongen.'),
