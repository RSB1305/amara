  ...
  stayOptions: {
    ...
    items: [
      ...
      },
      {
        ...
        text: l('AMARA Family & Surf spreads 75 m² over two floors, with two bathrooms and a private Atlantic-facing balcony. It is generous for two and also has a shared pool and reserved underground parking.', 'AMARA Family & Surf verteilt 75 m² auf zwei Etagen, mit zwei Bädern und einem privaten Balkon zum Atlantik. Zu zweit wohnt ihr hier sehr großzügig; dazu kommen Gemeinschaftspool und reservierter Tiefgaragenplatz.', 'AMARA Family & Surf reparte 75 m² en dos plantas, con dos baños y balcón privado orientado al Atlántico. Para dos es muy amplio y además cuenta con piscina comunitaria y plaza reservada en el garaje.', 'AMARA Family & Surf heeft 75 m² verdeeld over twee verdiepingen, met twee badkamers en een privébalkon aan de Atlantische Oceaan. Voor twee is het bijzonder ruim; er zijn ook een gedeeld zwembad en een gereserveerde garageplaats.', 'AMARA Family & Surf har 75 m² i två plan, med två badrum och en privat balkong mot Atlanten. För två är det mycket rymligt, och dessutom finns gemensam pool och reserverad garageplats.'),
