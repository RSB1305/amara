...
export const staySearchCopy = {
  ...
  partialError: localized({ en: 'We could not check every stay right now. The available results shown are up to date.', de: 'Wir konnten gerade nicht alle Unterkünfte prüfen. Die angezeigten verfügbaren Ergebnisse sind aktuell.', es: 'Ahora mismo no hemos podido comprobar todos los alojamientos. Los resultados disponibles que se muestran están actualizados.', nl: 'We konden niet alle verblijven controleren. De getoonde beschikbare resultaten zijn actueel.', sv: 'Vi kunde inte kontrollera alla boenden just nu. De tillgängliga resultaten som visas är aktuella.' }),
