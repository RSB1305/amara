...
export const staySearchCopy = {
  ...
  destinationStaysTitle: localized({ en: 'AMARA hideaways in {destination}', de: 'AMARA Hideaways in {destination}', es: 'Alojamientos AMARA en {destination}', nl: 'AMARA-hideaways in {destination}', sv: 'AMARA-boenden i {destination}' }),
  destinationStaysPrompt: localized({ en: 'Choose arrival and departure to check which stays are available for your dates.', de: 'Wählt Anreise und Abreise, um zu prüfen, welche Unterkünfte für eure Reisedaten verfügbar sind.', es: 'Elegid llegada y salida para comprobar qué alojamientos están disponibles en vuestras fechas.', nl: 'Kies aankomst en vertrek om te bekijken welke verblijven op jullie datums beschikbaar zijn.', sv: 'Välj ankomst och avresa för att se vilka boenden som är tillgängliga för era datum.' }),
