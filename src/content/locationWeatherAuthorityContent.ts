...
const shared: Record<AmaraLanguage, SharedLocale> = {
  en: {
    ...
    practicalEyebrow: 'Day planning & packing', practicalTitle: 'Turn the climate pattern into a workable day', practicalIntro: 'The yearly pattern is enough for packing. For a particular day you need the forecast.', packTitle: 'What to bring', packItems: [],
  ...
  de: {
    ...
    practicalEyebrow: 'Tagesplanung & Gepäck', practicalTitle: 'Aus dem Klimamuster einen guten Tag machen', practicalIntro: 'Für den Koffer reicht das Jahresmuster. Für den einzelnen Tag braucht ihr die Vorhersage.', packTitle: 'Was mit muss', packItems: [],
  ...
  es: {
    ...
    practicalEyebrow: 'Plan diario y equipaje', practicalTitle: 'Convertir el patrón climático en un buen día', practicalIntro: 'Para la maleta basta el patrón del año. Para un día concreto necesitáis la previsión.', packTitle: 'Qué llevar', packItems: [],
  ...
  nl: {
    ...
    practicalEyebrow: 'Dagplanning en bagage', practicalTitle: 'Maak van het klimaatpatroon een werkbare dag', practicalIntro: 'Voor de koffer volstaat het jaarpatroon. Voor een bepaalde dag hebben jullie de verwachting nodig.', packTitle: 'Wat mee moet', packItems: [],
  ...
  sv: {
    ...
    practicalEyebrow: 'Dagsplanering och packning', practicalTitle: 'Gör klimatmönstret till en fungerande dag', practicalIntro: 'För packningen räcker årsmönstret. För en enskild dag behöver ni prognosen.', packTitle: 'Vad som ska med', packItems: [],
...
const profiles: Profiles = {
  frigiliana: {
    en: {
      ...
      practical: 'In summer you are out in the morning and the evening and not much at midday — that settles itself once you are here. On luggage, just one thing: those 30 steps up to our door are a different exercise with a big hard-shell case than with a soft bag. Everything else you pack the way you always do.'
    },
    de: {
      ...
      practical: 'Im Sommer seid ihr morgens und abends draußen und mittags eher nicht — das ergibt sich hier von selbst. Zum Gepäck nur eine Sache: Die rund 30 Stufen bis zu unserer Tür sind mit einem großen Hartschalenkoffer eine andere Übung als mit einer weichen Tasche. Alles andere packt ihr so ein, wie ihr es immer tut.'
    },
    es: {
      ...
      practical: 'En verano se sale por la mañana y al caer la tarde, y al mediodía poco — eso sale solo una vez estáis aquí. Del equipaje, una sola cosa: los 30 escalones hasta nuestra puerta son otro ejercicio con una maleta rígida grande que con una bolsa blanda. Lo demás lo hacéis como siempre.'
    },
    nl: {
      ...
      practical: 'In de zomer ben je ’s ochtends en ’s avonds buiten en tussen de middag weinig — dat gaat vanzelf zodra je er bent. Over bagage één ding: die dertig treden naar onze voordeur zijn met een grote harde koffer een andere oefening dan met een zachte tas. De rest pak je zoals je altijd doet.'
    },
    sv: {
      ...
      practical: 'På sommaren är ni ute på morgonen och kvällen och sällan mitt på dagen — det ordnar sig av sig självt när ni väl är här. Om packningen bara en sak: de trettio trappstegen upp till vår port är en annan övning med en stor hårdskalsväska än med en mjuk bag. Resten packar ni som ni brukar.'
    }
  },
  nerja: {
    en: {
    ...
    nl: {
      ...
      practical: 'Op de heetste dagen kan de zee hier verrassend koud zijn. Dat is de terral: die duwt het warme oppervlaktewater naar buiten en van onderen komt koeler water omhoog. Het gaat voorbij en het is geen slecht teken. Verder maakt Nerja het je makkelijk — anders dan de klim in Frigiliana ligt AMARA Playa in het vlakke deel van het dorp, een paar minuten van Torrecilla.'
    },
    sv: {
  ...
  tarifa: {
    ...
    es: {
      ...
      practical: 'En Tarifa manda el viento, no la temperatura: por eso vienen los kitesurfistas. Qué playa funciona cada día depende de la dirección; lo que en el Atlántico abierto es demasiado puede ser perfecto en una cala resguardada. Y el día que no os apetezca salir, el supermercado está justo enfrente.'
    },
    nl: {
      ...
      practical: 'In Tarifa beslist de wind, niet de temperatuur — daarom komen de kitesurfers. Welk strand op een dag werkt, hangt van de richting af: wat op de open Atlantische Oceaan te veel is, kan in een beschutte baai precies goed zijn. En op de dag dat je helemaal niet naar buiten wilt, ligt de supermarkt recht tegenover.'
    },
    sv: {
      ...
      practical: 'I Tarifa är det vinden som avgör, inte temperaturen — det är därför kitesurfarna kommer. Vilken strand som fungerar en viss dag hänger på riktningen: det som är för mycket vid öppna Atlanten kan vara precis rätt i en skyddad vik. Och den dag ni inte vill ut alls ligger mataffären mitt emot.'
    }
  }
};
