...
const profiles: Profiles = {
  frigiliana: {
    ...
    de: {
      ...
      closingBody: '**Bei 35 °C und mehr zählt jede Stufe doppelt.** Frigiliana ist an den Hang gebaut: Zwischen zwei Adressen im Dorf liegen schnell dreißig Höhenmeter, und im Juli merkt ihr die. Wo ihr wohnt, entscheidet deshalb spürbar über euren Alltag im Dorf.',
