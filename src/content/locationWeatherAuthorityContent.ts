...
const smhiStockholmSummerNormalsUrl = 'https://www.smhi.se/kunskapsbanken/meteorologi/arstider/semestervader---vad-sager-statistiken';
...
const profiles: Profiles = {
  frigiliana: {
    ...
    de: {
      ...
      intentNotes: ['Im Sommer habt ihr Strandtage im Überfluss, und Torrecilla in Nerja liegt eine kurze Fahrt entfernt. Zurück im Dorf wartet die Außendusche auf der eigenen Terrasse — welche Bucht wann am angenehmsten ist, steht im Strand-Guide. Strandtücher liegen in jedem Apartment bereit.', 'Frühling und Herbst sind die schönste Zeit für einen langen Tag zu zweit in den Bergen. Auf der Cruz de Pinto und beim Aufstieg zum El Fuerte — 963 Meter, gut vier Stunden — gibt es kaum Schatten, deshalb gehen wir im Sommer früh los und sind mittags zurück. Danach wartet die Terrasse. Auch für eine Rundreise nach Sevilla oder Córdoba sind Frühjahr und Herbst angenehm: Im Hochsommer wird es im Binnenland deutlich heißer als hier am Hang. Der Higuerón führt durchs Flussbett: Von Oktober bis Dezember kann es hier ordentlich regnen, danach ist das eine andere Route. Schaut vorher aufs Wetter oder fragt uns kurz.', 'Im Januar bleiben die Tagesgäste aus. Dann gehört euch das Dorf fast allein — Altstadt, Cafés und Aussichtspunkte in Ruhe.', 'Im Januar liegt das durchschnittliche Tageshoch hier bei rund 12 Grad, in Berlin bei rund 3 Grad. Diese neun Grad Unterschied spürt ihr bei einer Runde durchs ruhige Dorf, beim Kaffee draußen und auf der Terrasse. Am Abend wird es kühl — dann zählt, was euch drinnen erwartet.'],
    ...
    es: {
      ...
      intentNotes: ['En julio, la máxima media ronda los 27 grados aquí y los 32 en Madrid. Esa diferencia se nota al bajar a Torrecilla, sentarse junto al mar y volver después a la ducha exterior de vuestra propia terraza. La guía de playas os ayuda a elegir cala, y las toallas de playa están en todos los apartamentos.', 'Primavera y otoño son la mejor época para un día largo en la sierra en pareja. En la Cruz de Pinto y en la subida a El Fuerte — 963 metros, cuatro horas largas — hay poca sombra, así que en verano salimos temprano y volvemos al mediodía. Después espera la terraza. Para una ruta por Sevilla o Córdoba, estas dos estaciones también ofrecen días más agradables que el pleno verano del interior. El Higuerón va por el cauce: de octubre a diciembre puede llover de verdad, y después es otra ruta. Mirad el tiempo antes o preguntadnos.', 'En enero no suben los visitantes de día. Entonces el pueblo es casi vuestro: el casco antiguo, los cafés y los miradores con calma.', 'En invierno los cuatro alojamientos tienen calefacción y suelo radiante en el baño; Lounis, Zaid y Maha también tienen estufa de pellets. Así podéis aprovechar las horas suaves fuera y volver a una casa cálida al caer la tarde.'],
    ...
    sv: {
      ...
      intentNotes: ['I juli ligger det genomsnittliga dagshögsta på cirka 27 grader här och 24 i Stockholm. Den skillnaden märks när ni åker ner till Torrecilla, slår er ner vid havet och sedan återvänder till utduschen på er egen terrass. Strandguiden hjälper er att välja vik, och badhanddukar finns i varje lägenhet.', 'Vår och höst är den finaste tiden för en lång dag tillsammans i bergen. På Cruz de Pinto och uppstigningen till El Fuerte — 963 meter, drygt fyra timmar — finns lite skugga, så på sommaren ger vi oss iväg tidigt och är tillbaka vid lunch. Sedan väntar terrassen. För en rundresa via Sevilla eller Córdoba ger samma årstider också behagligare dagar än högsommaren i inlandet. Higuerón går genom flodbädden: från oktober till december kan det regna ordentligt här, och efteråt är det en annan rutt. Titta på vädret i förväg, eller fråga oss.', 'I januari uteblir dagsbesökarna. Då är byn nästan er egen — gamla stan, kaféerna och utsiktsplatserna i lugn och ro.', 'På vintern har alla fyra boendena värme och golvvärme i badrummet; Lounis, Zaid och Maha har även pelletskamin. Då kan ni använda de milda timmarna ute och komma hem till värmen när kvällen blir sval.'],
...
export function getWeatherAuthorityContent(destination: WeatherDestination, lang: AmaraLanguage): WeatherAuthorityContent {
  ...
  if (destination === 'frigiliana') {
    const homeCitySource: Record<AmaraLanguage, { label: string; text: string; href: string }> = {
      ...
      sv: { label: 'SMHI · Stockholm', text: 'Officiell sommarstatistik 1991–2020 för dagens genomsnittliga högsta temperatur.', href: smhiStockholmSummerNormalsUrl }
    };
