...
const shared: Record<AmaraLanguage, SharedLocale> = {
  ...
  nl: {
    ...
    table: {
      ...
      sourceTitle: 'Zo lees je de gegevens', sourceText: 'De puntmodelwaarden van Climate-Data.org blijven zichtbaar als planningsbasis. De aanbieder geeft Nerja en Frigiliana momenteel dezelfde waarden; daarom gebruiken we ze niet voor een gemeten lokaal verschil.'
    },
    ...
    bestEyebrow: 'Beste reistijd per bedoeling', bestTitle: 'Er is niet één perfecte maand', bestIntro: 'Kies data voor het verblijf dat je wilt en gebruik daarna de verwachting voor de dagen zelf.', intentTitles: ['Strand en lange avonden', 'Wandelen en ontdekken', 'Een rustiger ritme', 'Een langer winterverblijf'],
