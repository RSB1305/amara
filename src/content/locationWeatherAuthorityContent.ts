...
const shared: Record<AmaraLanguage, SharedLocale> = {
  en: {
    ...
    table: {
      ...
      labels: { month: 'Month', high: 'Avg. high', max: 'Record high', low: 'Avg. minimum', rain: 'Rainfall', sunHours: 'Sun / day', temperature: 'Average maximum / minimum', rainfall: 'Monthly rainfall', details: 'Monthly values in detail' },
  ...
  de: {
    ...
    table: {
      ...
      labels: { month: 'Monat', high: 'Ø-Hoch', max: 'Rekord', low: 'Mittl. Minimum', rain: 'Niederschlag', sunHours: 'Sonne / Tag', temperature: 'Mittleres Maximum / Minimum', rainfall: 'Monatsniederschlag', details: 'Monatswerte im Detail' },
  ...
  es: {
    ...
    table: {
      ...
      labels: { month: 'Mes', high: 'Máx. media', max: 'Récord', low: 'Mínima media', rain: 'Lluvia', sunHours: 'Sol / día', temperature: 'Máxima / mínima media', rainfall: 'Lluvia mensual', details: 'Valores mensuales en detalle' },
  ...
  nl: {
    ...
    table: {
      ...
      labels: { month: 'Maand', high: 'Gem. hoog', max: 'Record', low: 'Gem. minimum', rain: 'Neerslag', sunHours: 'Zon / dag', temperature: 'Gemiddeld maximum / minimum', rainfall: 'Maandneerslag', details: 'Maandwaarden in detail' },
  ...
  sv: {
    ...
    table: {
      ...
      labels: { month: 'Månad', high: 'Snitt-hög', max: 'Rekord', low: 'Medelminimum', rain: 'Nederbörd', sunHours: 'Sol / dag', temperature: 'Medelmaximum / minimum', rainfall: 'Månadsnederbörd', details: 'Månadsvärden i detalj' },
