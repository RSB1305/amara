...
const profiles: Profiles = {
  frigiliana: {
    ...
    de: {
      ...
      summary: 'Der Sommer ist trocken und heiß, der Winter mild mit kühlen Abenden, und der meiste Regen fällt im Herbst. Im Dorf entscheidet aber nicht nur der Monat, sondern oft die Uhrzeit: Dieselbe Gasse liegt morgens im Schatten und nachmittags in voller Sonne. Zwischen etwa drei und sieben schließen kleine Läden und viele Küchen; gegessen wird später.\n\nFür lange Wege in die Berge sind Frühling und Herbst am angenehmsten. Im Sommer geht ihr früh los und seid mittags zurück. Die heißen Stunden gehören dem Schatten — in Lounis, Zaid und Maha auch der eigenen Terrasse. Für eure konkreten Tage zählt die AEMET-Vorhersage, nicht der Monatsschnitt.',
      ...
      factorsTitle: 'Warum die Uhrzeit hier zählt', factors: ['Frigiliana liegt am Hang, rund sechs Kilometer von Nerja entfernt. Ob es oben gerade kühler ist als an der Küste, lässt sich nicht in eine feste Zahl packen — dafür fehlt eine belastbare Messreihe. Was ihr sofort merkt, sind Sonne, Schatten und Steigung.', 'An sehr heißen Terral-Tagen kann das Meer plötzlich erstaunlich kalt sein. Der trockene Wind aus dem Landesinneren drückt warmes Oberflächenwasser hinaus, kühleres Wasser steigt nach. Im August 2026 sank die Wassertemperatur vor Málaga so innerhalb einer Woche um fast 13 Grad, während es landeinwärts auf 40 Grad zuging. Ihr müsst euch nur merken: Glühend heiß an Land heißt nicht automatisch warmes Badewasser.'],
      factorItems: [{ title: 'Schatten macht den Unterschied', text: 'Dieselbe Gasse liegt vormittags im Schatten und nachmittags in voller Sonne.' }, { title: 'Nach Sonnenuntergang', text: 'Auch nach einem heißen Tag kann es am Abend spürbar abkühlen.' }, { title: 'Dorf und Küste', text: 'Zum Strand nach Nerja sind es sechs Kilometer bergab. Unten ist es voller, oben ruhiger — und wenn das Meer an so einem Tag nicht einlädt, wartet oben die eigene Terrasse.' }],
