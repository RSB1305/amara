...
const shared: Record<AmaraLanguage, SharedLocale> = {
  ...
  de: {
    ...
    sourcesEyebrow: 'Quellen', sourcesTitle: 'Woher diese Zahlen stammen', sourcesIntro: 'Die Monatswerte kommen von Climate-Data.org, die Tagesvorhersage von AEMET.', sourcesChecked: 'Stand August 2026', modelSourceText: 'Monatliche Basiswerte für Temperatur, Niederschlag und Sonne.', forecastSourceText: 'Amtliche Gemeindeprognose und Referenz für Wetterwarnungen.',
  ...
  es: {
    ...
    sourcesEyebrow: 'Fuentes', sourcesTitle: 'De dónde salen estas cifras', sourcesIntro: 'Los valores mensuales vienen de Climate-Data.org y la previsión diaria de AEMET.', sourcesChecked: 'Actualizado en agosto de 2026', modelSourceText: 'Base mensual de temperatura, lluvia y sol.', forecastSourceText: 'Predicción municipal oficial y referencia para avisos meteorológicos.',
  ...
  nl: {
    ...
    sourcesEyebrow: 'Bronnen', sourcesTitle: 'Waar deze cijfers vandaan komen', sourcesIntro: 'De maandwaarden komen van Climate-Data.org, de dagverwachting van AEMET.', sourcesChecked: 'Stand augustus 2026', modelSourceText: 'Maandelijkse basis voor temperatuur, neerslag en zon.', forecastSourceText: 'Officiële gemeentelijke verwachting en referentie voor weerwaarschuwingen.',
