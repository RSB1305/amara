...
const shared: Record<AmaraLanguage, SharedLocale> = {
  en: {
    ...
    table: {
      ...
      intro: 'Averages over many years. A single day can look quite different.',
  ...
  de: {
    ...
    table: {
      ...
      intro: 'Durchschnittswerte aus vielen Jahren. Der einzelne Tag kann anders aussehen.',
  ...
  es: {
    ...
    table: {
      ...
      intro: 'Medias de muchos años. Un día concreto puede ser muy distinto.',
  ...
  nl: {
    ...
    table: {
      ...
      intro: 'Gemiddelden over vele jaren. Een afzonderlijke dag kan er heel anders uitzien.',
  ...
  sv: {
    ...
    table: {
      ...
      intro: 'Medelvärden över många år. En enskild dag kan se helt annorlunda ut.',
...
const profiles: Profiles = {
  frigiliana: {
    en: {
      ...
      summary: 'The summer months are sunny and warm to hot — exactly what you expect of Andalusia. The terraces of Lounis, Zaid and Maha each come with an outdoor shower, a hammock and two loungers; on Maha’s roof terrace the sun arrives about 45 minutes earlier than below, and from all three we have often watched the sunset — and the night sky after it. Autumn brings the rain back, which the vegetation needs and which is welcome after the summer. Spring and autumn are then the loveliest time to walk up into the mountains above the village together. And because Frigiliana lies on a slope, summer is decided less by the month than by the hour.',
      ...
      factorsTitle: 'Why the hour matters here', factors: ['Frigiliana sits above the coast on sloping terrain. Elevation, exposure and shade provide useful planning context, but they do not prove an exact temperature difference from Nerja.', 'The durable pattern is Mediterranean: the warmest part of the year is markedly drier, while rain is more likely in the cooler half.'],
    ...
    de: {
      ...
      summary: 'Die Sommermonate sind sonnig und warm bis heiß — so, wie man Andalusien erwartet. Auf den Terrassen von Lounis, Zaid und Maha gehören Außendusche, Hängematte und zwei Liegen dazu; auf Mahas Dachterrasse steht die Sonne rund 45 Minuten früher als unten, abends haben wir von allen dreien schon oft den Sonnenuntergang gesehen — und danach den Sternenhimmel. Im Herbst kommt der Regen zurück — gut für die Vegetation und angenehm nach dem Sommer. Frühling und Herbst sind dann die schönste Zeit, um zu zweit in die Berge über dem Dorf zu gehen. Und weil Frigiliana am Hang liegt, entscheidet im Sommer weniger der Monat als die Uhrzeit.',
      ...
      factorsTitle: 'Warum die Uhrzeit hier zählt', factors: ['Frigiliana liegt rund sechs Kilometer oberhalb von Nerja am Hang. Wie viel kühler es hier ist als unten an der Küste, können wir euch nicht in Zahlen sagen — dafür gibt es keine belastbare Messreihe.', 'Was die Tabelle zeigt, stimmt aber: Der Sommer ist trocken, die kühlere Jahreshälfte bringt den Regen.'],
      factorItems: [{ title: 'Steigung und Exposition', text: 'Dieselbe Gasse liegt vormittags im Schatten und nachmittags in voller Sonne.' }, { title: 'Tag und Abend', text: 'Nach Sonnenuntergang kühlt es spürbar ab — auch nach einem heißen Tag.' }, { title: 'Dorf und Küste', text: 'Zum Strand nach Nerja sind es sechs Kilometer bergab. Unten ist es voller, oben ruhiger.' }],
    ...
    es: {
      ...
      summary: 'Los meses de verano son soleados y de cálidos a calurosos, justo lo que se espera de Andalucía. Las terrazas de Lounis, Zaid y Maha tienen ducha exterior, hamaca y dos tumbonas; en la azotea de Maha el sol llega unos 45 minutos antes que abajo, y desde las tres hemos visto muchas veces la puesta de sol, y después el cielo estrellado. En otoño vuelve la lluvia, que la vegetación agradece y que sienta bien tras el verano. Primavera y otoño son entonces la mejor época para subir juntos a la sierra sobre el pueblo. Y como Frigiliana está en una ladera, en verano decide menos el mes que la hora.',
    ...
    nl: {
      ...
      summary: 'De zomermaanden zijn zonnig en warm tot heet — precies wat je van Andalusië verwacht. Bij de terrassen van Lounis, Zaid en Maha horen een buitendouche, een hangmat en twee ligbedden; op het dakterras van Maha staat de zon zo’n 45 minuten eerder dan beneden, en vanaf alle drie hebben we vaak de zonsondergang gezien — en daarna de sterrenhemel. In de herfst komt de regen terug, goed voor de vegetatie en aangenaam na de zomer. Lente en herfst zijn dan de mooiste tijd om samen de bergen boven het dorp in te gaan. En omdat Frigiliana tegen een helling ligt, beslist in de zomer minder de maand dan het uur.',
    ...
    sv: {
      ...
      summary: 'Sommarmånaderna är soliga och varma till heta — precis som man väntar sig av Andalusien. Till terrasserna hos Lounis, Zaid och Maha hör utedusch, hängmatta och två solsängar; på Mahas takterrass står solen ungefär 45 minuter tidigare än nedanför, och från alla tre har vi ofta sett solnedgången — och stjärnhimlen efter den. På hösten kommer regnet tillbaka, bra för växtligheten och skönt efter sommaren. Vår och höst är då den finaste tiden för en lång dag tillsammans i bergen ovanför byn. Och eftersom Frigiliana ligger i en sluttning avgörs sommaren mindre av månaden än av timmen.',
