...
export const weatherDestinationNames: Record<WeatherDestination, string> = {
...
const shared: Record<AmaraLanguage, SharedLocale> = {
  en: {
    ...
    table: {
      ...
      labels: { month: 'Month', high: 'Avg. daily high', max: 'Record high', low: 'Avg. minimum', rain: 'Rainfall', sunHours: 'Sun / day', temperature: 'Average maximum / minimum', rainfall: 'Monthly rainfall', details: 'Monthly values in detail' },
  ...
  de: {
    ...
    table: {
      ...
      labels: { month: 'Monat', high: 'Ø-Tageshoch', max: 'Rekord', low: 'Mittl. Minimum', rain: 'Niederschlag', sunHours: 'Sonne / Tag', temperature: 'Mittleres Maximum / Minimum', rainfall: 'Monatsniederschlag', details: 'Monatswerte im Detail' },
    ...
    sourcesEyebrow: 'Mehr erfahren', sourcesTitle: 'Weiterführende Links', sourcesIntro: 'Die Monatswerte kommen von Climate-Data.org, die Tagesvorhersage von AEMET.', sourcesChecked: 'Stand August 2026', modelSourceText: 'Monatliche Basiswerte für Temperatur, Niederschlag und Sonne.', forecastSourceText: 'Amtliche Gemeindeprognose und Referenz für Wetterwarnungen.',
  ...
  es: {
    ...
    table: {
      ...
      labels: { month: 'Mes', high: 'Máxima media', max: 'Récord', low: 'Mínima media', rain: 'Lluvia', sunHours: 'Sol / día', temperature: 'Máxima / mínima media', rainfall: 'Lluvia mensual', details: 'Valores mensuales en detalle' },
    ...
    sourcesEyebrow: 'Explorar más', sourcesTitle: 'Enlaces para saber más', sourcesIntro: 'Los valores mensuales vienen de Climate-Data.org y la previsión diaria de AEMET.', sourcesChecked: 'Actualizado en agosto de 2026', modelSourceText: 'Base mensual de temperatura, lluvia y sol.', forecastSourceText: 'Predicción municipal oficial y referencia para avisos meteorológicos.',
  ...
  nl: {
    ...
    table: {
      ...
      labels: { month: 'Maand', high: 'Gem. dagmaximum', max: 'Record', low: 'Gem. minimum', rain: 'Neerslag', sunHours: 'Zon / dag', temperature: 'Gemiddeld maximum / minimum', rainfall: 'Maandneerslag', details: 'Maandwaarden in detail' },
    ...
    sourcesEyebrow: 'Meer ontdekken', sourcesTitle: 'Links om zelf verder te kijken', sourcesIntro: 'De maandwaarden komen van Climate-Data.org, de dagverwachting van AEMET.', sourcesChecked: 'Stand augustus 2026', modelSourceText: 'Maandelijkse basis voor temperatuur, neerslag en zon.', forecastSourceText: 'Officiële gemeentelijke verwachting en referentie voor weerwaarschuwingen.',
  ...
  sv: {
    ...
    table: {
      ...
      labels: { month: 'Månad', high: 'Medelmax', max: 'Rekord', low: 'Medelminimum', rain: 'Nederbörd', sunHours: 'Sol / dag', temperature: 'Medelmaximum / minimum', rainfall: 'Månadsnederbörd', details: 'Månadsvärden i detalj' },
    ...
    sourcesEyebrow: 'Utforska mer', sourcesTitle: 'Länkar för att läsa vidare', sourcesIntro: 'Månadsvärdena kommer från Climate-Data.org, dygnsprognosen från AEMET.', sourcesChecked: 'Uppdaterad augusti 2026', modelSourceText: 'Månatliga basvärden för temperatur, nederbörd och sol.', forecastSourceText: 'Officiell kommunprognos och referens för vädervarningar.',
...
const profiles: Profiles = {
  frigiliana: {
    en: {
      ...
      closingBody: '**At 30 °C and more, every step counts double.** Frigiliana is built into the slope: two addresses in the village can sit thirty vertical metres apart, and in July you feel every one of them. Which is why where you stay is not a detail here.',
    ...
    de: {
      ...
      closingBody: '**Bei 30 °C und mehr zählt jede Stufe doppelt.** Frigiliana ist an den Hang gebaut: Zwischen zwei Adressen im Dorf liegen schnell dreißig Höhenmeter, und im Juli merkt ihr die. Wo ihr wohnt, entscheidet deshalb spürbar über euren Alltag im Dorf.',
    ...
    es: {
      ...
      closingBody: '**A 30 °C y más, cada escalón cuenta doble.** Frigiliana está construida en la ladera: entre dos direcciones del pueblo puede haber treinta metros de desnivel, y en julio se notan todos. Por eso aquí dónde os alojáis no es un detalle menor.',
    ...
    nl: {
      ...
      closingBody: '**Bij 30 °C en meer telt elke trede dubbel.** Frigiliana is tegen de helling gebouwd: tussen twee adressen in het dorp zit al snel dertig meter hoogteverschil, en in juli voel je die allemaal. Daarom is de vraag waar je slaapt hier geen bijzaak.',
    ...
    sv: {
      ...
      closingBody: '**Vid 30 °C och mer räknas varje trappsteg dubbelt.** Frigiliana är byggt in i sluttningen: mellan två adresser i byn kan det skilja trettio höjdmeter, och i juli känner ni varenda en. Därför är frågan om var ni bor ingen bisak här.',
...
export function getWeatherAuthorityContent(destination: WeatherDestination, lang: AmaraLanguage): WeatherAuthorityContent {
  ...
  const place = weatherDestinationNames[destination];
  ...
  // Tarifa keeps its own modelled series, so the honesty note is different: these
  // are a long-term read of the Strait, and the day-to-day story here is the wind
  // the table cannot show — the wording mirrors the destination's own sourceText.
  const tarifaTableIntros: Record<AmaraLanguage, string> = {
    en: 'These monthly figures give a long-term read of temperature, rain and sun at the Strait. What the table does not show is the wind — and here it is the wind that decides a day more than the thermometer does.',
    de: 'Diese Monatswerte geben eine langfristige Orientierung zu Temperatur, Regen und Sonne an der Meerenge. Was die Tabelle nicht abbildet, ist der Wind — und der entscheidet hier einen Tag mehr als das Thermometer.',
    es: 'Estos valores mensuales ofrecen una orientación a largo plazo de temperatura, lluvia y sol en el Estrecho. Lo que la tabla no muestra es el viento, y aquí el viento decide un día más que el termómetro.',
    nl: 'Deze maandwaarden geven een langjarig beeld van temperatuur, regen en zon aan de Straat. Wat de tabel niet laat zien is de wind — en die bepaalt hier een dag meer dan de thermometer.',
    sv: 'De här månadsvärdena ger en långsiktig bild av temperatur, regn och sol vid sundet. Det tabellen inte visar är vinden — och här avgör vinden en dag mer än termometern.'
  };
  ...
  return {
    ...
    table: { ...common.table, intro: destination === 'frigiliana' ? frigilianaTableIntros[lang] : destination === 'nerja' ? nerjaTableIntros[lang] : destination === 'tarifa' ? tarifaTableIntros[lang] : common.table.intro, sourceText: profile.sourceText },
