...
const shared: Record<AmaraLanguage, SharedLocale> = {
  en: {
    ...
    table: {
      ...
      sourceTitle: 'What these numbers are, and are not', sourceText: 'Climate-Data.org point-model values give a transparent planning baseline. The provider currently returns identical values for Nerja and Frigiliana, so read them as one regional picture rather than two separate local climates.'
    },
    ...
    bestEyebrow: 'Best time by intention', bestTitle: 'Choose the season that suits your stay', bestIntro: 'Each season has its own good days. Below is which of them suits which kind of stay.', intentTitles: ['Beach & long evenings', 'Walking & exploring', 'Quieter town rhythm', 'Longer winter stay'],
    ...
    closingEyebrow: 'Plan the whole stay', closingTitle: 'Weather is only half the decision', closingBody: 'Where you sleep decides the rest: whether you walk to dinner, how far the beach is, and how easily a rainy day turns into something else.', primaryLabel: 'Explore the location guide', secondaryLabel: 'Where in town you sleep'
  },
  de: {
    ...
    table: {
      ...
      sourceTitle: 'Was diese Zahlen sind — und was nicht', sourceText: 'Die Punktmodellwerte von Climate-Data.org sind eine transparente Planungsbasis. Für Nerja und Frigiliana liefert der Anbieter derzeit identische Werte – lest sie deshalb als ein regionales Bild und nicht als zwei getrennte Lokalklimata.'
    },
    ...
    bestEyebrow: 'Beste Reisezeit nach Absicht', bestTitle: 'Die passende Reisezeit für euren Aufenthalt', bestIntro: 'Jede Jahreszeit hat ihre eigenen guten Tage. Hier steht, welche davon zu welchem Aufenthalt passen.', intentTitles: ['Strand & lange Abende', 'Wandern & Erkunden', 'Ruhigerer Ortsrhythmus', 'Längerer Winteraufenthalt'],
    ...
    closingEyebrow: 'Den ganzen Aufenthalt planen', closingTitle: 'Wetter ist nur die halbe Entscheidung', closingBody: 'Wo ihr wohnt, entscheidet den Rest: ob ihr abends zu Fuß essen geht, wie weit es zum Strand ist und wie leicht sich ein verregneter Tag umplanen lässt.', primaryLabel: 'Lage-Guide entdecken', secondaryLabel: 'Wo im Ort ihr wohnt'
  },
  es: {
    ...
    table: {
      ...
      sourceTitle: 'Qué son estas cifras y qué no', sourceText: 'Los valores del modelo puntual de Climate-Data.org sirven como base de planificación transparente. El proveedor da ahora valores idénticos para Nerja y Frigiliana, así que leedlos como una imagen regional y no como dos climas locales distintos.'
    },
    ...
    bestEyebrow: 'Mejor época según el plan', bestTitle: 'La época que mejor encaja con vuestro viaje', bestIntro: 'Cada estación tiene sus buenos días. Aquí veréis cuáles encajan con cada tipo de estancia.', intentTitles: ['Playa y tardes largas', 'Caminar y explorar', 'Un ritmo más tranquilo', 'Una estancia larga en invierno'],
    ...
    closingEyebrow: 'Planificar toda la estancia', closingTitle: 'El tiempo es solo la mitad de la decisión', closingBody: 'Dónde dormís decide el resto: si vais andando a cenar, a qué distancia queda la playa y con qué facilidad se reorganiza un día de lluvia.', primaryLabel: 'Descubrir la guía de ubicación', secondaryLabel: 'En qué parte del pueblo dormís'
  },
  nl: {
    ...
    table: {
      ...
      sourceTitle: 'Wat deze cijfers wel en niet zijn', sourceText: 'De puntmodelwaarden van Climate-Data.org vormen een transparante planningsbasis. De aanbieder geeft Nerja en Frigiliana momenteel dezelfde waarden, dus lees ze als één regionaal beeld en niet als twee aparte lokale klimaten.'
    },
    ...
    bestEyebrow: 'Beste reistijd per bedoeling', bestTitle: 'De reistijd die bij jullie verblijf past', bestIntro: 'Elk seizoen heeft zijn eigen goede dagen. Hieronder staat welke bij welk verblijf passen.', intentTitles: ['Strand en lange avonden', 'Wandelen en ontdekken', 'Een rustiger ritme', 'Een langer winterverblijf'],
    ...
    closingEyebrow: 'Plan het hele verblijf', closingTitle: 'Het weer is maar de helft van de keuze', closingBody: 'Waar je slaapt bepaalt de rest: of je lopend gaat eten, hoe ver het strand is en hoe makkelijk een regendag iets anders wordt.', primaryLabel: 'Ontdek de locatiegids', secondaryLabel: 'Waar in de plaats je slaapt'
  },
  sv: {
    ...
    table: {
      ...
      sourceTitle: 'Vad siffrorna är – och inte är', sourceText: 'Punktmodellvärden från Climate-Data.org är en tydlig planeringsgrund. Leverantören ger just nu samma värden för Nerja och Frigiliana, så läs dem som en regional bild och inte som två skilda lokalklimat.'
    },
    ...
    bestEyebrow: 'Bästa restid efter avsikt', bestTitle: 'Restiden som passar er vistelse', bestIntro: 'Varje årstid har sina egna bra dagar. Här står vilka som passar vilken sorts vistelse.', intentTitles: ['Strand och långa kvällar', 'Promenader och upptäckter', 'Lugnare rytm', 'Längre vintervistelse'],
    ...
    closingEyebrow: 'Planera hela vistelsen', closingTitle: 'Vädret är bara halva beslutet', closingBody: 'Var ni bor avgör resten: om ni går till middagen, hur långt det är till stranden och hur lätt en regnig dag blir något annat.', primaryLabel: 'Upptäck platsguiden', secondaryLabel: 'Var i orten ni bor'
  }
};
...
const profiles: Profiles = {
  frigiliana: {
    en: {
      ...
      intentNotes: ['The long, dry summer pattern can suit beach-centred dates, but monthly air averages do not decide whether a particular day suits swimming. Check current heat, wind and sea conditions first; the beach guide then helps you choose access, setting and services.', 'Spring and autumn often bring less heat than summer for longer walks. On exposed routes such as Cruz de Pinto, El Fuerte or GR 249, the current forecast still determines the start time; for the Higuerón, recent rain and riverbed conditions also determine whether the route fits the day.', 'In January, the quieter village rhythm carries through the day. There is time for the old town, cafés and viewpoints at an unhurried pace.', 'A longer winter stay gives you time to settle into Frigiliana, enjoy its everyday rhythm and make the accommodation part of the experience.'],
    ...
    de: {
      ...
      intentNotes: ['Das lange, trockene Sommermuster kann gut zu Reisedaten mit viel Strand passen. Monatsmittel der Lufttemperatur entscheiden aber nicht, ob ein bestimmter Tag zum Baden passt. Prüft zuerst aktuelle Hitze, Wind und Meereszustand; der Strand-Guide hilft anschließend bei Zugang, Atmosphäre und Services.', 'Frühling und Herbst bringen häufig weniger Hitze als der Sommer und erleichtern damit längere Wege. Bei offenen Routen wie Cruz de Pinto, El Fuerte oder GR 249 bestimmt trotzdem die aktuelle Vorhersage die Startzeit; beim Higuerón entscheiden zusätzlich der jüngste Regen und die Bedingungen im Flussbett.', 'Im Januar trägt der ruhigere Dorfrhythmus durch den ganzen Tag. So bleibt viel Zeit für Altstadt, Cafés und Aussichtspunkte in einem entspannten Tempo.', 'Ein längerer Winteraufenthalt schenkt euch Zeit, in Frigiliana anzukommen, den örtlichen Alltag zu genießen und die Unterkunft zum Teil des Erlebnisses zu machen.'],
    ...
    es: {
      ...
      intentNotes: ['El patrón largo y seco del verano puede encajar con unas fechas centradas en la playa, pero las medias mensuales del aire no deciden si un día concreto es adecuado para bañarse. Comprobad primero el calor, el viento y el estado actual del mar; la guía de playas ayuda después a elegir acceso, ambiente y servicios.', 'Primavera y otoño suelen traer menos calor que el verano para recorridos largos. En rutas expuestas como Cruz de Pinto, El Fuerte o GR 249, la previsión actual sigue determinando la hora de salida; para el Higuerón también cuentan la lluvia reciente y las condiciones del cauce.', 'En enero, el ritmo más tranquilo del pueblo acompaña todo el día. Hay tiempo para disfrutar del casco antiguo, los cafés y los miradores sin prisas.', 'Una estancia larga en invierno permite instalarse con calma en Frigiliana, disfrutar de su vida cotidiana y convertir el alojamiento en parte de la experiencia.'],
    ...
    nl: {
      ...
      intentNotes: ['Het lange, droge zomerpatroon kan passen bij reisdata met veel strandtijd, maar maandgemiddelden van de lucht bepalen niet of een bepaalde dag geschikt is om te zwemmen. Controleer eerst actuele hitte, wind en zeecondities; de strandgids helpt daarna bij toegang, sfeer en voorzieningen.', 'Lente en herfst brengen vaak minder hitte dan de zomer voor langere wandelingen. Op open routes zoals Cruz de Pinto, El Fuerte of GR 249 bepaalt de actuele verwachting nog steeds de starttijd; voor de Higuerón tellen ook recente regen en de toestand van de rivierbedding.', 'In januari draagt het rustigere dorpsritme de hele dag. Er is alle tijd voor de oude stad, cafés en uitzichtpunten in een ontspannen tempo.', 'Een langer winterverblijf geeft jullie tijd om echt in Frigiliana aan te komen, van het dagelijkse ritme te genieten en de accommodatie deel van de ervaring te maken.'],
    ...
    sv: {
      ...
      intentNotes: ['Det långa, torra sommarmönstret kan passa resdatum med mycket strandtid, men månadsmedel för luften avgör inte om en viss dag lämpar sig för bad. Kontrollera först aktuell hetta, vind och havsläge; strandguiden hjälper sedan med tillträde, miljö och service.', 'Vår och höst ger ofta mindre hetta än sommaren för längre vandringar. På öppna leder som Cruz de Pinto, El Fuerte eller GR 249 avgör den aktuella prognosen fortfarande starttiden; för Higuerón spelar även nyligt regn och förhållandena i flodbädden in.', 'I januari bär byns lugnare rytm genom hela dagen. Det finns gott om tid för gamla stan, kaféer och utsiktsplatser i ett avslappnat tempo.', 'En längre vintervistelse ger er tid att landa i Frigiliana, njuta av vardagsrytmen och låta boendet bli en del av upplevelsen.'],
