...
const profiles: Profiles = {
  frigiliana: {
    en: {
      ...
      intentNotes: ['In summer you have beach days in abundance, and Torrecilla in Nerja is a short drive away. Back in the village the outdoor shower on your own terrace is waiting — which cove is nicest when is in the beach guide. Beach towels you do not need to bring — they are in every apartment.', 'Spring and autumn are the loveliest time for a long day in the mountains together. On the Cruz de Pinto and the climb to El Fuerte — 963 metres, a good four hours — there is little shade, so in summer we set off early and are back by midday. Then the terrace is waiting. The Higuerón runs through the riverbed: from October to December it can rain properly here, and afterwards it is a different route. Check the weather beforehand, or just ask us.', 'In January the day visitors stay away. Then the village is almost yours — the old town, the cafés and the viewpoints in peace.', 'In winter all four places have heating and three of them a pellet stove. The days outside are brighter than most people expect, the evenings cool — and from early evening on you barely meet anyone in the lanes.'],
    ...
    de: {
      ...
      summary: 'Der Sommer ist trocken und heiß, der Winter mild mit kühlen Abenden, und der Regen fällt vor allem im Herbst. Wichtiger als der Monat ist hier aber die Uhrzeit: Frigiliana liegt am Hang, und dieselbe Gasse liegt morgens im Schatten und nachmittags in voller Sonne. Dazu kommt der spanische Takt — zwischen drei und sieben macht das Dorf Siesta, gegessen wird ab etwa acht.\n\nFür lange Wege in die Berge sind Frühling und Herbst am besten; im Sommer geht ihr früh los und seid mittags zurück. Die Stunden dazwischen gehören dem Schatten, in Lounis, Zaid und Maha der eigenen Terrasse. Für eure tatsächlichen Tage zählt die AEMET-Vorhersage, nicht der Monatsschnitt.',
      ...
      intentNotes: ['Im Sommer habt ihr Strandtage im Überfluss, und Torrecilla in Nerja liegt eine kurze Fahrt entfernt. Zurück im Dorf wartet die Außendusche auf der eigenen Terrasse — welche Bucht wann am angenehmsten ist, steht im Strand-Guide. Strandtücher müsst ihr nicht mitschleppen — die liegen in jedem Apartment bereit.', 'Frühling und Herbst sind die schönste Zeit für einen langen Tag zu zweit in den Bergen. Auf der Cruz de Pinto und beim Aufstieg zum El Fuerte — 963 Meter, gut vier Stunden — gibt es kaum Schatten, deshalb gehen wir im Sommer früh los und sind mittags zurück. Danach wartet die Terrasse. Der Higuerón führt durchs Flussbett: Von Oktober bis Dezember kann es hier ordentlich regnen, danach ist das eine andere Route. Schaut vorher aufs Wetter oder fragt uns kurz.', 'Im Januar bleiben die Tagesgäste aus. Dann gehört euch das Dorf fast allein — Altstadt, Cafés und Aussichtspunkte in Ruhe.', 'Im Winter haben alle vier Unterkünfte Heizung, drei davon einen Pelletofen. Die Tage draußen sind heller, als die meisten erwarten, die Abende kühl — und ab dem frühen Abend trefft ihr in den Gassen kaum noch jemanden.'],
      practical: ['Zwischen etwa drei und sieben Uhr nachmittags macht das Dorf Siesta. Kleine Läden schließen, viele Küchen auch — abends wird ab etwa halb acht wieder gekocht. Das ist eine Hitzeregel: Es sind die Stunden, in denen die Sonne am stärksten brennt und die Temperatur ihren Höhepunkt erreicht. Deshalb rutscht in Spanien alles nach hinten — gearbeitet und gegessen wird in den kühleren Abendstunden.', 'Am Anreisetag trifft euch das zuerst: Wer nachmittags heraufkommt, landet mitten in der Siesta — die Läden im Dorf haben dann zu. Entweder ihr kauft auf dem Weg herauf noch in Nerja ein, oder ihr lasst es und geht abends los, wenn wieder alles offen ist. In Lounis, Zaid und Maha gehören die vier Stunden dazwischen ohnehin der eigenen Terrasse.'],
      closingTitle: 'Wo im Dorf ihr wohnt, macht den Unterschied',
      closingBody: 'Bei 27 Grad zählt jede Stufe doppelt 🙂 Frigiliana ist an den Hang gebaut: Zwischen zwei Adressen im Dorf liegen schnell dreißig Höhenmeter, und im Juli merkt ihr die. Deshalb ist die Frage, wo ihr wohnt, hier keine Nebensache.',
    ...
    sv: {
      ...
      intentNotes: ['På sommaren har ni stranddagar i överflöd, och Torrecilla i Nerja ligger en kort bilfärd bort. Tillbaka i byn väntar utduschen på er egen terrass — vilken vik som är skönast när står i strandguiden. Badhanddukar behöver ni inte släpa med — de finns i varje lägenhet.', 'Vår och höst är den finaste tiden för en lång dag tillsammans i bergen. På Cruz de Pinto och uppstigningen till El Fuerte — 963 meter, drygt fyra timmar — finns lite skugga, så på sommaren ger vi oss iväg tidigt och är tillbaka vid lunch. Sedan väntar terrassen. Higuerón går genom flodbädden: från oktober till december kan det regna ordentligt här, och efteråt är det en annan rutt. Titta på vädret i förväg, eller fråga oss.', 'I januari uteblir dagsbesökarna. Då är byn nästan er egen — gamla stan, kaféerna och utsiktsplatserna i lugn och ro.', 'På vintern har alla fyra boendena värme och tre av dem pelletskamin. Dagarna ute är ljusare än de flesta väntar sig, kvällarna svala — och från tidig kväll möter ni knappt någon i gränderna.'],
...
export function getWeatherAuthorityContent(destination: WeatherDestination, lang: AmaraLanguage): WeatherAuthorityContent {
  ...
  const relatedItems: Record<WeatherDestination, Record<AmaraLanguage, Array<{ label: string; text: string }>>> = {
    frigiliana: {
      en: [{ label: 'How the village sits on the slope', text: 'Six kilometres above the coast and built into the hillside — that is where the steps, the views and the drive down to the beach come from.' }, { label: 'Winter stays in Frigiliana', text: 'The days stay mild and the evenings turn cool, and then what heats the place matters. All four stays have heating and underfloor heating in the bathroom; Lounis, Zaid and Maha also have a pellet stove.' }],
      de: [{ label: 'Wie das Dorf am Hang liegt', text: 'Sechs Kilometer über der Küste, an den Hang gebaut — daher die Stufen, die Aussicht und die Fahrt hinunter zum Strand.' }, { label: 'Winteraufenthalte in Frigiliana', text: 'Die Tage bleiben mild, die Abende werden kühl — dann zählt, womit geheizt wird. Alle vier Unterkünfte haben Heizung und Fußbodenheizung im Bad, Lounis, Zaid und Maha zusätzlich einen Pelletofen.' }],
      es: [{ label: 'Cómo se asienta el pueblo en la ladera', text: 'Seis kilómetros por encima de la costa y construido en la ladera: de ahí vienen los escalones, las vistas y el trayecto en coche hasta la playa.' }, { label: 'Estancias de invierno en Frigiliana', text: 'Los días siguen suaves y las tardes refrescan, y entonces importa con qué se calienta. Los cuatro alojamientos tienen calefacción y suelo radiante en el baño; Lounis, Zaid y Maha, además, estufa de pellets.' }],
      nl: [{ label: 'Hoe het dorp tegen de helling ligt', text: 'Zes kilometer boven de kust en tegen de helling gebouwd — daar komen de treden, het uitzicht en de rit naar het strand vandaan.' }, { label: 'Winterverblijven in Frigiliana', text: 'De dagen blijven mild en de avonden worden koel, en dan telt waarmee er verwarmd wordt. Alle vier de verblijven hebben verwarming en vloerverwarming in de badkamer; Lounis, Zaid en Maha bovendien een pelletkachel.' }],
      sv: [{ label: 'Hur byn ligger i sluttningen', text: 'Sex kilometer ovanför kusten och byggd in i sluttningen — därifrån kommer trappstegen, utsikten och bilfärden ner till stranden.' }, { label: 'Vintervistelser i Frigiliana', text: 'Dagarna förblir milda och kvällarna blir svala, och då spelar det roll hur det värms. Alla fyra boendena har värme och golvvärme i badrummet; Lounis, Zaid och Maha dessutom pelletskamin.' }],
    },
    nerja: {
