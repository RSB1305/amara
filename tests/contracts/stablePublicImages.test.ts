...
test('the manifest holds exactly 150 unique paths', () => {
  expect(STABLE_PUBLIC_IMAGE_PATHS).toHaveLength(150);
  expect(new Set(STABLE_PUBLIC_IMAGE_PATHS).size).toBe(150);
});
