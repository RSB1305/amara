...
The canonical header availability action uses the shared calendar-check icon at every viewport and keeps a native localized accessible label in EN, DE, ES, NL and SV; the mobile menu retains the visible localized label.
