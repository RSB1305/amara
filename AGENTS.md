...
- Decorative horizontal rules are prohibited at outer page-section boundaries, inside prose, pull quotes, bylines and provenance blocks, and along the top or bottom edge of editorial boxes, display bands and CTA panels. Separate public content through spacing, typography and intentional surface changes. `AmaraSection` exposes no divider option. Structural borders remain permitted only where lists, tables, controls or media frames require them for comprehension or interaction.
